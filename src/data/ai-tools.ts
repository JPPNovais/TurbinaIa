...
export const AI_TOOLS: AITool[] = [
  // Texto & Redação
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (uso limitado de GPT-3.5); ChatGPT Plus a US$ 20/mês (acesso a GPT-4o, navegação web, análise de dados e DALL-E 3); ChatGPT Team a US$ 25/usuário/mês (mínimo de 2 usuários, faturamento anual); ChatGPT Enterprise sob consulta. API GPT-4o a US$ 2.50/M tokens entrada e US$ 10.00/M tokens saída.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (com Claude 3 Haiku, uso limitado); Claude Pro a US$ 20/mês (acesso a Claude 3 Opus, maior uso); Planos de API (pay-per-token): Claude 3 Haiku a US$ 1.00/M tokens entrada e US$ 5.00/M tokens saída; Claude 3 Sonnet a US$ 3.00/M tokens entrada e US$ 15.00/M tokens saída; Claude 3 Opus a US$ 5.00/M tokens entrada e US$ 25.00/M tokens saída (para versões 4.5 e 4.6).',
    url: 'https://claude.ai',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (acesso a Gemini 1.5 Flash, uso limitado); Google One AI Premium a US$ 19,99/mês (acesso a Gemini 1.5 Pro, 2 TB de armazenamento, recursos de IA no Gmail, Docs, etc.); Planos de API (pay-per-token): Gemini 1.5 Flash a US$ 0.35/M tokens entrada e US$ 1.05/M tokens saída; Gemini 1.5 Pro a US$ 3.50/M tokens entrada e US$ 10.50/M tokens saída.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (Copilot Chat com modelos básicos); Copilot Pro a US$ 20/mês (acesso a modelos mais avançados, criação de imagens acelerada, integração com Office); Copilot para Microsoft 365 a US$ 30/usuário/mês (faturamento anual, mínimo 300 usuários); Copilot Business para SMB a US$ 18/usuário/mês (faturamento anual).',
  ...
  // Código & Dev
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis para estudantes e mantenedores de projetos open source; Individual a US$ 10/mês ou US$ 100/ano; Business a US$ 19/usuário/mês.',
  ...
  // Vídeo
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Atualmente em acesso limitado. Preços futuros estimados: Incluso no ChatGPT Plus (US$ 20/mês, acesso a recursos básicos de geração de vídeo); ChatGPT Pro (US$ 200/mês, com mais créditos e recursos). API (preços futuros estimados: Sora (Standard) a US$ 0.10/segundo (720p); Sora Pro a US$ 0.30/segundo (720p) ou US$ 0.50/segundo (1024p)).',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Atualmente em acesso limitado (private preview). Preços futuros estimados: Disponível através de Google One AI Premium (US$ 19,99/mês, acesso a Veo); Planos de API do Google AI Studio/Vertex AI (preços futuros estimados: Veo a US$ 0.40/segundo; Veo Fast a US$ 0.15/segundo).',
