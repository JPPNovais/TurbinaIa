...
export const aiModels: AIModel[] = [
  {
    ...
    cons: [
      ...
      'O rollout inicial do GPT-6 Astra gerou confusão: por semanas, assinantes Plus (US$ 20/mês) só tiveram acesso ao modelo dentro do ChatGPT Work e do Codex, não na interface padrão de Chat, mesmo com o anúncio inicial da OpenAI mencionando "todos os usuários Plus". Isso só foi corrigido em 14 de setembro de 2026, quando o Astra passou a ser o modelo padrão também no Chat comum para Plus, junto com Pro, Business e Enterprise.'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
  ...
  },
  {
    ...
    pros: [
      ...
      'Gemini 3.8 Flash (lançado em 2 de setembro de 2026) sucede o 3.7 Flash como o novo modelo "workhorse" do Google, com ganhos expressivos em engenharia de software de longo horizonte (73,7% no DeepSWE v1.1, ante 65,3% do 3.7 Flash) e liderança em tarefas agênticas de terminal (89,4% no Terminal-Bench 2.1, à frente do Claude Opus 5 e do GPT-5.6 Sol), mantendo o mesmo preço de US$ 0.75/US$ 3.75 por milhão de tokens até 31 de dezembro de 2026.',
