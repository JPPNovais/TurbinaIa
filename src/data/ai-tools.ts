...
export const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    description:
      'Grok é o assistente de IA da SpaceXAI (antiga xAI, empresa de Elon Musk), integrado ao X (Twitter) com acesso a informações em tempo real da rede social. Destaca-se por respostas diretas, raciocínio avançado e acesso a tendências do momento. Em 12 de agosto de 2026, a SpaceXAI lançou o Grok 4.6, modelo voltado a agentes de longa duração e codificação, com janela de contexto de 500 mil tokens, empatando com o GPT-5.6 Sol no índice de inteligência da Artificial Analysis.',
    useCases: [
