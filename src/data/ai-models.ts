...
export const aiModels: AIModel[] = [
  {
    id: 'chatgpt-plus',
    name: 'ChatGPT Plus (GPT-5, GPT-5 Instant, GPT-5 Pro)',
    developer: 'OpenAI',
    category: 'Texto & Código',
    pricing: 'Plano gratuito disponível (acesso limitado a GPT-5.3 Instant para funções básicas; inclui anúncios nos EUA). ChatGPT Go: US$ 8/mês (acesso a GPT-5.3 Instant, com anúncios nos EUA, Austrália, Nova Zelândia e Canadá). ChatGPT Plus: US$ 20/mês (acesso total a GPT-5.4 Thinking, GPT-5.3 Instant como padrão; inclui Deep Research - 10 execuções/mês, Sora 2, Codex com Computer Use no Windows, Agent Mode, Advanced Voice Mode, Custom GPTs, DALL-E 4; limite de 160 mensagens/3 horas para GPT-5.4 Thinking e 80 uploads de arquivos/3 horas). ChatGPT Pro $100: US$ 100/mês (acesso a GPT-5.4 Thinking, GPT-5.4 Pro e o1 Pro mode; 5x o uso do Plus, 50 execuções de Deep Research/mês). ChatGPT Pro $200: US$ 200/mês (acesso a GPT-5.4 Thinking, GPT-5.4 Pro e o1 Pro mode; 20x o uso do Plus, Deep Research ilimitado, janela de contexto de 1 milhão de tokens, Sora 2 com gerações ilimitadas lentas e 500 vídeos prioritários 1080p). ChatGPT Business: US$ 20/usuário/mês (cobrança anual, mínimo de 2 usuários) ou US$ 25-30/usuário/mês (cobrança mensal); inclui acesso ilimitado a GPT-5.4 Thinking e GPT-5.4 Pro, workspaces compartilhados. ChatGPT Enterprise: Preço personalizado (contato com vendas). API para GPT-5: US$ 1.25/milhão de tokens de entrada e US$ 10.00/milhão de tokens de saída. API para GPT-4o: US$ 2.50/milhão de tokens de entrada e US$ 10.00/milhão de tokens de saída. API para GPT-4o mini: US$ 0.15/milhão de tokens de entrada e US$ 0.60/milhão de tokens de saída. API para GPT-4.1 Nano: US$ 0.10/milhão de tokens de entrada e US$ 0.40/milhão de tokens de saída. API para Sora 2 (vídeo): Preços por segundo variam (ex: 1080p a US$ 0.70/segundo).',
    pros: [
      'GPT-5.4 Thinking é o modelo mais inteligente e intuitivo da OpenAI para usuários Plus e superiores, destacando-se em raciocínio complexo, codificação, uso de computador e pesquisa científica.',
      'GPT-5.3 Instant é o modelo padrão do ChatGPT para todos os usuários, oferecendo respostas mais rápidas, precisas e com menos alucinações.',
      'Acesso a recursos avançados como Deep Research, Sora 2 (geração de vídeo), Codex (agente de codificação com Computer Use no Windows), Agent Mode, Advanced Voice Mode e Custom GPTs.',
    ...
    cons: [
      'Modelos mais antigos como GPT-4, GPT-3.5 Turbo foram descontinuados ou é recomendado migrar.',
      ...
      'O custo da API para modelos de fronteira pode ser significativamente mais alto do que modelos mais eficientes em custo, como GPT-4.1 Nano.',
      'Sora 2 (geração de vídeo) é restrito a planos pagos, com funcionalidades avançadas apenas no Pro $200.'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
    ...
    description: 'ChatGPT Plus, agora impulsionado pelos modelos GPT-5 (incluindo GPT-5.4 Thinking e GPT-5.3 Instant), representa o ápice da inteligência artificial generativa da OpenAI. O GPT-5.4 Thinking é o modelo mais capaz da empresa, otimizado para tarefas complexas de codificação, pesquisa e análise de dados, e com fortes capacidades agenticas. O GPT-5.3 Instant é o modelo padrão do ChatGPT para todos os usuários, focado em velocidade, precisão e redução significativa de alucinações. A plataforma oferece acesso a recursos como Deep Research, Sora 2 (geração de vídeo), Codex (com Computer Use no Windows), Advanced Voice Mode e Custom GPTs, além do novo modelo de imagem DALL-E 4. Com novos planos como ChatGPT Go e os tiers Pro ($100 e $200), a OpenAI busca atender a uma gama mais ampla de usuários, desde casuais até grandes empresas, enquanto continua a evoluir sua oferta de modelos de IA.'
  },
  {
