...
export const aiModels: AIModel[] = [
  {
    ...
    pricing: 'Plano gratuito disponível (acesso limitado a GPT-5.5 Instant para funções básicas; inclui anúncios nos EUA). ChatGPT Go: US$ 8/mês (acesso a GPT-5.5 Instant, com anúncios nos EUA, Austrália, Nova Zelândia e Canadá). ChatGPT Plus: US$ 20/mês (acesso total a GPT-5.5 Thinking, GPT-5.5 Instant como padrão; inclui Deep Research - 10 execuções/mês, Codex com Computer Use no Windows, Agent Mode, Advanced Voice Mode, Custom GPTs, DALL-E 4; limite de 160 mensagens/3 horas para GPT-5.5 Thinking e 80 uploads de arquivos/3 horas). ChatGPT Pro: US$ 200/mês (acesso ilimitado a GPT-5.5 Thinking, GPT-5.5 Pro e o1 Pro mode; 50 execuções de Deep Research/mês, Deep Think para raciocínio ilimitado, janela de contexto de 1 milhão de tokens, acesso prioritário a novos recursos, uso máximo de todos os recursos). ChatGPT Business: US$ 20/usuário/mês (anual, mínimo de 2 usuários) ou US$ 25-30/usuário/mês (mensal, mínimo de 2 usuários); inclui acesso ilimitado a GPT-5.5 Thinking e GPT-5.5 Pro, workspaces compartilhados. ChatGPT Enterprise: Preço personalizado (contato com vendas), mínimo de 150 usuários. API para GPT-5.5 Pro: US$ 30.00/milhão de tokens de entrada e US$ 180.00/milhão de tokens de saída. API para GPT-5.5 mini: US$ 0.25/milhão de tokens de entrada e US$ 2.00/milhão de tokens de saída. API para GPT-4o: US$ 2.50/milhão de tokens de entrada e US$ 10.00/milhão de tokens de saída. API para GPT-4o mini: US$ 0.15/milhão de tokens de entrada e US$ 0.60/milhão de tokens de saída. API para gpt-image-2 (DALL-E 4): Preços da API são baseados em tokens (ex: input US$ 8.00/milhão, output US$ 30.00/milhão), com custo estimado por imagem variando, por exemplo, US$ 0.053 (1024x1024, medium quality).',
    pros: [
      ...
      'GPT-5.5 Instant (lançado em 5 de maio de 2026) é o modelo padrão do ChatGPT para todos os usuários, oferecendo respostas mais rápidas, precisas e com menos alucinações, com 52.5% de redução em afirmações alucinadas em prompts de alto risco.',
      ...
      'Melhorias significativas na memória do ChatGPT, com a introdução de um "memory summary" e o processo de "dreaming" para sintetizar informações de múltiplas conversas, disponível para usuários Plus e Pro a partir de junho de 2026.'
    ],
    cons: [
      'Modelos mais antigos como GPT-4o foram aposentados do ChatGPT em agosto de 2025 (mas reintroduzido para assinantes pagos após reclamações). DALL-E 2 foi aposentado em 12 de maio de 2026. OpenAI o3 e GPT-4.5 serão descontinuados em agosto e junho de 2026, respectivamente.',
      'A API do Sora será descontinuada em setembro de 2026, com o aplicativo Sora sendo desativado em abril de 2026.',
      ...
      'O recurso "canvas" não está mais disponível no GPT-5.5 Instant ou GPT-5.5 Thinking, com funcionalidades de escrita e codificação agora suportadas diretamente em blocos de chat.'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
  ...
  },
  {
    ...
    cons: [
      ...
      'Modelos como Claude Sonnet 4 e Claude Opus 4 serão descontinuados em 15 de junho de 2026, e Claude Opus 4.1 em 5 de junho de 2026.',
    ...
    description: 'Claude Opus 4.8 (lançado em 28 de maio de 2026) é o modelo mais avançado da Anthropic, oferecendo desempenho robusto em raciocínio, codificação e compreensão multimodal, incluindo capacidades de visão e função de chamada. Ele mostra melhorias em honestidade e confiabilidade, e suporta "dynamic workflows" (prévia de pesquisa) e "Effort Control". Supera o GPT-5.5 em diversas avaliações de codificação e raciocínio agentico, sendo um dos líderes no Artificial Analysis Intelligence Index. Ele oferece uma janela de contexto de 1 milhão de tokens via API e em Claude Code, mas 500K para uso conversacional direto. Claude Sonnet 4.6 (lançado em 17 de fevereiro de 2026) oferece um desempenho de nível Opus 4.5 a um preço de Sonnet, tornando-o uma opção eficiente e capaz. Claude Haiku 4.5 (lançado em 15 de outubro de 2025) é o modelo mais rápido e econômico da família. A Anthropic continua a focar em segurança e alinhamento em seus modelos e introduziu recursos como "computer use" em beta público, persistent memory para todos os usuários, o agente de desktop Claude Cowork (com disponibilidade geral em abril de 2026) e "Projects" para workspaces persistentes. No entanto, a partir de 15 de junho de 2026, a cobrança para o uso programático de agentes muda, podendo impactar custos para usuários intensivos. Relatos de interrupções e problemas de qualidade no Claude Code também foram observados no início de junho de 2026.'
  },
  {
    id: 'gemini-models',
    ...
    pros: [
      ...
      'Gemini 3.1 Ultra e Pro são modelos poderosos e versáteis com uma vasta janela de contexto de 1 milhão de tokens via API para Gemini 3.1 Pro, e agora 2 milhões de tokens via API, destacando-se em raciocínio complexo e compreensão multimodal.',
      ...
      'Gemini 3 Flash-Lite (lançado em 7 de maio de 2026) é um modelo altamente eficiente em custo para tarefas de alto volume.',
    ...
    cons: [
      ...
      'Embora o Gemini 3.5 Flash seja mais econômico que o Gemini 3.1 Pro em muitas cargas de trabalho, o preço por token é maior que o de modelos Flash mais antigos.',
    ...
    description: 'Gemini 3.5 Flash (lançado em 19 de maio de 2026) é o novo modelo padrão do Google, otimizado para velocidade e desempenho em tarefas agenticas e de codificação, superando o Gemini 3.1 Pro em benchmarks e sendo mais econômico. A família Gemini Omni, com o Gemini Omni Flash (lançado em 19 de maio de 2026 e com API em breve), introduz um "modelo de mundo" multimodal com capacidades de simulação e geração de vídeo de alta qualidade a partir de diversas entradas. Os modelos Gemini 3.1 Ultra e Pro são os modelos de linguagem multimodal mais avançados do Google, oferecendo vasta janela de contexto de até 1 milhão de tokens para 3.1 Pro (com opção de 2 milhões de tokens via API) para análise de grandes volumes de informações em texto, imagem, áudio e vídeo (principalmente via API). O Gemini 3.1 Ultra e Pro são projetados para raciocínio complexo e desempenho superior, enquanto o Gemini 3.5 Flash é otimizado para velocidade e custo-benefício em tarefas de alto volume. Ambos se destacam na análise multimodal e estão profundamente integrados ao ecossistema Google, disponíveis via assinatura Google AI Plus/Pro/Ultra e API. O novo Gemini Spark, impulsionado por 3.5 Flash, atua como um parceiro ativo que executa tarefas em nome do usuário. O sistema de cobrança por uso de computação e o fallback automático para modelos mais leves também visam melhorar a experiência do usuário e a previsibilidade de custos.'
  },
  {
    id: 'llama-models',
    ...
    cons: [
      ...
      'A licença para variantes multimodais do Llama 4 explicitamente exclui indivíduos e empresas domiciliados na UE de usar os pesos diretamente devido à ambiguidade da Lei de IA.',
      'As janelas de contexto para modelos Llama 3.1 (16K para 8B e 131K para 70B) são menores que a do Llama 4 Scout (10M) e alguns concorrentes (Gemini 3.1 Pro com 2M).',
      ...
      'A API do Muse Spark está em prévia privada para usuários selecionados e não está geralmente disponível.',
  ...
  },
  {
    ...
    pricing: 'Incluso no ChatGPT Plus (US$ 20/mês, com acesso a GPT-5.5 Thinking e limites de uso; Plus users podem gerar até 50 imagens a cada 3 horas). API para gpt-image-2 (DALL-E 4, modelo gpt-image-2-2026-04-21): Preços da API são baseados em tokens (ex: input US$ 8.00/milhão, output US$ 30.00/milhão), com custo estimado por imagem variando, por exemplo, US$ 0.053 (1024x1024, medium quality). O modo instantâneo de geração de imagem é gratuito para todos os usuários do ChatGPT, com limites dinâmicos.',
    pros: [
      'DALL-E 4 (agora baseado em gpt-image-2, integrado no ChatGPT Plus e superiores, impulsionado por GPT-5.5) é o modelo de geração de imagens de última geração da OpenAI, oferecendo uma arquitetura unificada para melhor compreensão e interação.',
    ...
    cons: [
      ...
      'DALL-E 2 e DALL-E 3 foram aposentados em 12 de maio de 2026. Outros modelos como gpt-image-1-mini e gpt-image-1.5 (e chatgpt-image-latest) serão descontinuados em 1º de dezembro de 2026, com migração forçada para gpt-image-2, o que pode causar múltiplas migrações para desenvolvedores.',
      ...
      'Usuários da API têm enfrentado problemas com limites de taxa (TPM e IPM), incluindo um bug reportado em 5 de junho de 2026, onde o `gpt-image-2-codex` estava esgotando o limite global de RPM, bloqueando a maioria das solicitações de imagem para algumas contas.'
    ],
    score: {
      reasoning: 4.9,
    ...
    affiliateUrl: 'https://chatgpt.com',
    description: 'DALL-E 4, da OpenAI (integrado ao ChatGPT Plus e agora baseado no modelo `gpt-image-2`, impulsionado por GPT-5.5), é a mais recente geração de modelos de geração de imagens da empresa. Ele se destaca por sua arquitetura unificada que permite interpretar prompts complexos e conversacionais para criar imagens de alta qualidade com renderização aprimorada de texto, suporte multilíngue e uma forte correspondência com a descrição. O modo instantâneo de geração de imagem é gratuito para todos os usuários do ChatGPT, enquanto o acesso aos recursos avançados é para Plus e superiores. Modelos anteriores como DALL-E 2 e DALL-E 3 foram aposentados, e outros modelos de imagem da API serão descontinuados em dezembro de 2026, consolidando a oferta da OpenAI no `gpt-image-2`. Com gerações ultrarrápidas, o DALL-E 4 é uma ferramenta poderosa para designers e criadores de conteúdo, apesar dos desafios com os limites de taxa da API e o custo para uso em larga escala.'
  },
  {
    id: 'midjourney-v8-1',
    ...
    pros: [
      'Midjourney V8.1 (lançado em 30 de abril de 2026) aprimora a qualidade de imagem excepcional, alta resolução (HD 2K nativo, agora padrão), estética marcante e maior precisão na compreensão de prompts. É 4-5x mais rápido para jobs padrão, e o modo HD é 3x mais rápido e 3x mais barato, tornando-o o padrão para V8.1.',
      ...
      'Disponibiliza um Editor Web completo (previsto para junho de 2026, com desenvolvimento ativo em edição, inpaint, outpaint, pan, zoom e capacidade de multi-referência), eliminando a dependência do Discord.',
  ...
  },
  {
    ...
    description: 'A Stability AI oferece uma gama de modelos "open-weight" para IA visual e de áudio. Isso inclui o Stable Diffusion 4 Ultra (lançado em março de 2026), que apresenta uma arquitetura inovadora e fotorrealismo de ponta com renderização aprimorada de texto e anatomia. A família Stable Diffusion 3.5 (Medium, Large, Turbo, lançados em outubro/dezembro de 2024) e Stable Diffusion XL (SDXL, incluindo Turbo) continuam a ser pilares para geração de imagens de alta qualidade. Para áudio, o Stable Audio 3.0 (lançado em maio de 2026) permite gerar e editar música e efeitos sonoros de alta qualidade de até 6 minutos e 20 segundos. Os modelos são "open-weight", permitindo uso local gratuito (com limites de receita para uso comercial) e personalização profunda via fine-tuning. A API do Stable Video Diffusion foi descontinuada em julho de 2025. Embora exija investimento em aprendizado e hardware potente para as versões maiores, sua flexibilidade e o custo-benefício o tornam ideal para profissionais que buscam personalização, eficiência e controle.'
  },
  {
