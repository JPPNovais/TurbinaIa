...
export const AI_MODELS: CalculatorModel[] = [
  ...
  },
  {
    ...
    contextWindow: '1M tokens',
    description: 'O modelo de produção recomendado da OpenAI (lançado no início de 2026), com forte raciocínio, seguimento de instruções e 1M de contexto.',
  },
  {
    name: 'GPT-4.1 Mini',
    provider: 'OpenAI',
    ...
    contextWindow: '1M tokens',
    description: 'Um modelo mais acessível da OpenAI (lançado no início de 2026), otimizado para tarefas de alta demanda e baixo custo, com 1M de contexto.',
  },
  {
    name: 'GPT-4o',
    provider: 'OpenAI',
