...
export const AI_MODELS: CalculatorModel[] = [
  ...
  },
  {
    ...
    contextWindow: '1.05M tokens',
    description: 'O modelo GPT-5.6 Terra da OpenAI, que equilibra inteligência e custo. Preços e janela de contexto atualizados a partir de Agosto de 2026, para contextos menores que o limite de longo contexto. Para contextos longos, os preços são $4.00/M de entrada e $18.00/M de saída.',
  },
  {
    name: 'GPT-5.6 Luna',
    provider: 'OpenAI',
  ...
  // Anthropic
  {
    ...
    contextWindow: '1M tokens',
    description: 'O modelo mais inteligente da família Claude da Anthropic (Claude Fable 5), construído para raciocínio exigente e trabalho agêntico de longo prazo, com 1M de contexto. Preços atualizados a partir de Junho de 2026.',
  },
  {
    ...
    contextWindow: '1M tokens',
    description: 'O modelo intermediário da família Claude da Anthropic (Claude Sonnet 4.6), um equilíbrio entre inteligência e velocidade para cargas de trabalho empresariais, com 1M de contexto. Preços atualizados a partir de Agosto de 2026.',
  },
  {
    ...
    contextWindow: '1M tokens',
    description: 'O modelo mais rápido e econômico da família Claude da Anthropic (Claude Haiku 4.5), ideal para tarefas de alto desempenho e baixo custo, com até 1M de contexto. Preços atualizados a partir de Agosto de 2026.',
  },
  // DeepSeek
  {
  ...
  // Mistral AI
  {
    ...
    description: 'O modelo flagship da Mistral AI (Mistral Large 3), com raciocínio avançado e capacidades multimodais, suportando 262K de contexto. Preços e janela de contexto atualizados a partir de Agosto de 2026.',
  },
  {
    ...
    description: 'O modelo otimizado da Mistral AI (Mistral Small 4), que oferece um bom equilíbrio entre desempenho e custo para uma ampla gama de tarefas, com 256K de contexto. Preços e janela de contexto atualizados a partir de Agosto de 2026.',
  },
  {
    ...
    contextWindow: '262K tokens',
    description: 'O modelo intermediário da Mistral AI (Mistral Medium 3.5), oferecendo um equilíbrio entre inteligência e custo, com 262K de contexto. Preços e janela de contexto atualizados a partir de Agosto de 2026.',
  },
  // Cohere
  {
    name: 'Command A',
