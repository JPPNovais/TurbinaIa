...
export const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Não possui plano gratuito. Acesso via planos Claude API (pay-per-token: Haiku a US$ 0.25/M entrada / US$ 1.25/M saída; Sonnet a US$ 3/M entrada / US$ 15/M saída; Opus a US$ 5/M entrada / US$ 25/M saída) ou via planos de equipe: Team Standard a US$ 30/usuário/mês (mínimo de 5 usuários), Team Premium a US$ 100/usuário/mês (inclui Opus), Enterprise sob consulta.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (25 créditos generativos/mês). Firefly Standard a US$ 9.99/mês (2.000 créditos). Firefly Pro a US$ 19.99/mês (7.000 créditos). Planos Creative Cloud Pro (a partir de US$ 69.99/mês) incluem créditos e uso ilimitado de geração padrão. API Firefly sob consulta, a partir de ~$1.000/mês com custo por imagem de US$ 0.02-0.10.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (1 minuto de vídeo, 720p, marca d\'água, 1 crédito). Creator a US$ 29/mês (US$ 24/mês anual, 10 minutos de vídeo/mês, 1080p, sem marca d\'água, 1 custom avatar, 1 voice clone). Business a US$ 89/mês (US$ 72/mês anual, 30 minutos de vídeo/mês, 4K, 5 custom avatars, 5 voice clones, 40+ idiomas para lip-sync, API, 3 team seats). Enterprise sob consulta.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (10 min de vídeo/mês, 9 avatares AI, marca d\'água). Starter a US$ 29/mês (US$ 22/mês anual, 10 min de vídeo/mês, 125+ avatares, 3 personal avatars). Creator a US$ 89/mês (US$ 67/mês anual, 30 min de vídeo/mês, 180+ avatares, 5 personal avatars, API access). Enterprise sob consulta (minutos ilimitados, 240+ avatares, SAML/SSO, SCORM export).',
