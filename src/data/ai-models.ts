...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'Novas "scheduled tasks" (lançadas em 17 de junho de 2026, em rollout) permitem agendar lembretes e tarefas recorrentes a partir de uma página dedicada na barra lateral, com notificações mais rápidas e confiáveis.',
    ...
    cons: [
      ...
      'GPT-5 (Instant e Thinking) foi aposentado em 13 de fevereiro de 2026.',
      'GPT-4.5 será retirado do ChatGPT em 27 de junho de 2026. Isso marca o fim dos modelos GPT-4 na interface do ChatGPT.',
      ...
      'Os limites das tarefas agendadas variam por plano e não são suportadas em chats de voz ou GPTs.',
