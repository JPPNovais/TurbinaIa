...
export const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Plano Grátis (Standard): 100 notebooks, 50 fontes por notebook, 50 chats diários, 3 gerações de áudio/dia, fonte de até 500.000 palavras; Plano Plus: (bundlado com Google AI Plus a US$ 7.99/mês) dobra os limites do gratuito; Plano Pro: (bundlado com Google AI Pro a US$ 19.99/mês) 500 notebooks, 300 fontes, 500 chats diários, 20 Audio Overviews, 20 Video Overviews, 100 relatórios/day, 20 Deep Research reports/day; Plano Ultra: (bundlado com Google AI Ultra a US$ 99.99/mês (20TB) ou US$ 200/mês (30TB)). Google Workspace Business Standard a US$ 14/usuário/mês inclui NotebookLM Plus. Plano Enterprise: US$ 9/licença/mês (com descontos anuais).',
