...
export const AI_TOOLS: AITool[] = [
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Plano Grátis: Copilot Chat com modelos básicos, integrado ao Windows e Bing; Plano Copilot Pro standalone descontinuado para novos assinantes em 1º de outubro de 2025, substituído pelo Microsoft 365 Premium: US$ 19.99/mês ou US$ 199.99/ano (acesso ao GPT-5.6 no Office, criação de imagens, acesso prioritário); Microsoft 365 Copilot Business (add-on): US$ 18/usuário/mês (faturamento anual, promoção de jul-set/2026) ou US$ 21/usuário/mês (faturamento anual, preço padrão) ou US$ 25.20/usuário/mês (faturamento mensal); Microsoft 365 Copilot Enterprise (add-on): US$ 30/usuário/mês (faturamento anual). Requer plano Microsoft 365 Business Standard/Premium ou E3/E5.',
