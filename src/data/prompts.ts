...
Formate sua resposta de forma clara, com seções dedicadas à "Avaliação de Risco de Crédito", "Principais Fatores de Impacto", "Recomendações Estratégicas e Táticas", "Tipos de Financiamento Sugeridos" e "Métricas de Acompanhamento".`,
  ...
  {
    id: 'ia-design-agente-conteudo-multimodal',
    title: 'Design de Agente Co-Criador de Conteúdo Multimodal',
    category: 'IA & Automação',
    description: 'Crie um prompt para um agente IA focado em co-criação de conteúdo multimodal para campanhas digitais, adaptando-se ao feedback.',
    template: 'Aja como um designer de prompts para IA e especialista em agentes autônomos. Eu preciso de um prompt detalhado e um framework para criar um "Agente Co-Criador de Conteúdo Multimodal". Este agente deve ser capaz de: 1. Compreender o objetivo da campanha, público-alvo e voz da marca. 2. Gerar propostas de conteúdo textual, visual (descrições) e áudio (roteiros) de forma integrada. 3. Adaptar-se ao meu feedback e manter a coerência entre formatos. 4. Sugerir otimizações para diferentes canais. \n\nCom base nas minhas especificações abaixo, me forneça: \n1. O "System Prompt" completo e robusto para o "Agente Co-Criador de Conteúdo Multimodal". \n2. Uma lista de "Instruções de Usuário" que eu devo dar ao agente para iniciar uma sessão de criação. \n3. Um "Fluxo de Iteração Sugerido" para refinar o conteúdo. \n\n**Minhas Especificações:** \n- Objetivo principal do Agente: [Ex: Auxiliar na criação ágil e coerente de campanhas de marketing digital com conteúdo multimodal] \n- Papel que o Agente deve assumir: [Ex: Um estrategista de conteúdo criativo e especialista em marketing digital] \n- Habilidades essenciais do Agente: [Ex: Geração de texto persuasivo, design thinking visual, roteirização, adaptação de tom e estilo, otimização para canais] \n- Linguagem de saída preferida: [Português do Brasil] \n- Formatos de conteúdo que o Agente deve gerar: [Ex: Copys para redes sociais, roteiros para vídeos curtos, descrições de imagem, ideias de áudio, headlines de e-mail] \n\nCrie o System Prompt, as instruções do usuário e o fluxo de iteração.',
    tags: ['Agente IA', 'Multimodal', 'Criação de Conteúdo', 'Automação'],
  },
  {
    id: 'finance-analise-sentimento-mercado-ia',
    title: 'Análise de Sentimento do Mercado para Decisões de Investimento',
    category: 'Finanças',
    description: 'Gere uma análise de sentimento do mercado sobre um ativo específico, considerando notícias, redes sociais e tendências para auxiliar em decisões de investimento.',
    template: 'Atue como um analista de mercado financeiro especializado em IA. Realize uma análise de sentimento detalhada para o ativo/empresa que eu especificar, com o objetivo de identificar tendências e potenciais impactos em decisões de investimento. \n\nSua análise deve abranger: \n1. **Sentimento Geral:** Positivo, negativo ou neutro, com justificativa. \n2. **Principais Tópicos:** Os assuntos mais discutidos e relevantes que afetam o sentimento. \n3. **Fontes Consideradas:** Mencione os tipos de fontes (ex: notícias financeiras, redes sociais relevantes, relatórios de analistas, fóruns de investidores). \n4. **Tendência:** Se o sentimento está melhorando, piorando ou estável nos últimos [período de análise]. \n5. **Recomendação Acionável:** Com base na análise, apresente insights e uma recomendação de ação para investimento (compra, venda, manter, aguardar) e seu racional. \n\n**Informações do Ativo/Empresa:** \n- Nome da Empresa/Ticker do Ativo: [Ex: PETR4, Tesla, Bitcoin] \n- Período de Análise: [Ex: Últimos 30 dias, última semana, desde o último relatório de resultados] \n- Quaisquer eventos recentes que devo considerar: [Ex: Lançamento de produto, mudança de CEO, resultados financeiros, nova legislação]',
    tags: ['Investimento', 'Análise de Dados', 'Mercado Financeiro', 'IA Preditiva'],
  },
  {
    id: 'dev-gerador-design-patterns-ia',
    title: 'Gerador de Design Patterns com IA',
    category: 'Desenvolvimento',
    description: 'Obtenha sugestões de design patterns e exemplos de implementação para um problema de desenvolvimento de software específico, otimizando a arquitetura.',
    template: 'Aja como um arquiteto de software sênior e especialista em design patterns. Eu apresentarei um problema de desenvolvimento e preciso que você sugira os design patterns mais adequados para resolvê-lo, explicando cada um e fornecendo um exemplo de implementação. \n\nPara cada design pattern sugerido, inclua: \n1. **Nome do Design Pattern:** (Ex: Singleton, Strategy, Observer) \n2. **Descrição Breve:** O que ele resolve e seus princípios. \n3. **Contexto de Aplicação:** Por que ele é relevante para o meu problema. \n4. **Exemplo de Código:** Um snippet simplificado na linguagem especificada, demonstrando sua implementação. \n5. **Vantagens e Desvantagens:** Os prós e contras de aplicar este pattern no meu contexto. \n\n**Detalhes do Problema de Desenvolvimento:** \n- Descrição do Problema: [Ex: Preciso de um sistema para gerenciar diferentes estratégias de cálculo de impostos, que podem mudar frequentemente e ser aplicadas a diversos tipos de produtos, sem modificar o código base principal.] \n- Linguagem/Framework de Preferência: [Ex: Python, Java com Spring Boot, JavaScript com Node.js] \n- Contexto da Aplicação: [Ex: Backend de e-commerce de alto volume, aplicativo mobile, sistema de processamento de dados em tempo real] \n- Requisitos/Restrições Adicionais: [Ex: Alta performance, fácil manutenibilidade, escalabilidade, acoplamento baixo, testabilidade]',
    tags: ['Design Patterns', 'Arquitetura Software', 'Otimização Código', 'Desenvolvimento IA'],
  },
  {
    id: 'negocios-validacao-modelo-negocio-ia',
    title: 'Validação Abrangente de Modelo de Negócios com Agente IA',
    category: 'Negócios',
    description: 'Utilize um agente IA para validar um modelo de negócios completo, analisando mercado, concorrência, viabilidade financeira e plano de escalabilidade.',
    template: 'Aja como um consultor de negócios experiente e especialista em validação de modelos de negócios e estratégias de mercado, utilizando ferramentas de IA. Meu objetivo é validar o modelo de negócios que estou desenvolvendo. \n\nRealize uma análise multifacetada, abrangendo os seguintes pontos: \n1. **Análise de Mercado:** Tamanho, tendências, segmentação e oportunidades para o meu modelo. \n2. **Análise de Concorrência:** Principais concorrentes, seus modelos, diferenciais e minha proposta de valor em comparação. \n3. **Viabilidade Financeira Preliminar:** Potenciais fluxos de receita, estrutura de custos e projeção de lucratividade inicial. \n4. **Avaliação de Riscos:** Identificação de riscos inerentes ao modelo (mercado, operacional, financeiro, legal) e mitigação. \n5. **Potencial de Escalabilidade:** Como o modelo pode crescer e se adaptar. \n6. **Feedback e Recomendações:** Pontos fortes, pontos fracos, oportunidades e ameaças (análise SWOT), além de sugestões concretas para otimizar e fortalecer o modelo. \n\n**Detalhes do Meu Modelo de Negócios:** \n- Nome do Negócio (opcional): [Ex: Soluções Inovadoras Ltda.] \n- Descrição do Modelo de Negócios: [Ex: Uma plataforma SaaS baseada em assinatura para pequenas e médias empresas gerenciarem o engajamento de clientes usando IA, oferecendo planos escaláveis com funcionalidades premium.] \n- Público-alvo Primário: [Ex: PMEs dos setores de varejo e serviços, com 10-50 funcionários, que buscam automatizar o atendimento ao cliente e a personalização de ofertas.] \n- Proposta de Valor Única: [Ex: Automatização inteligente do engajamento do cliente que realmente impulsiona vendas, com relatórios preditivos e integração fácil com sistemas existentes.] \n- Principais Canais de Distribuição/Aquisição: [Ex: Marketing digital (SEO, SEM), parcerias estratégicas, indicações, vendas diretas.] \n- Estrutura de Receitas: [Ex: Assinatura mensal/anual, tiered pricing, add-ons para funcionalidades avançadas.] \n- Estrutura de Custos Chave: [Ex: Desenvolvimento de software, marketing, suporte ao cliente, infraestrutura de nuvem.] \n- Localização Geográfica do Foco (se aplicável): [Ex: Brasil, inicialmente regiões Sudeste e Sul.]',
    tags: ['Validação Negócios', 'Empreendedorismo', 'Estratégia', 'Agente IA'],
  },
  {
    id: 'ia-avaliacao-desempenho-agente',
    title: 'Avaliador de Desempenho de Agente IA',
    category: 'IA & Automação',
    description: 'Avalia o desempenho de um agente de IA em uma tarefa específica, identificando pontos fortes, fracos e sugestões de otimização para aprimoramento contínuo.',
    template: 'Você é um especialista em avaliação e otimização de Agentes de IA. Sua tarefa é analisar o desempenho de um Agente de IA e fornecer um relatório detalhado.\n\nAgente de IA em Análise: [Nome do Agente ou Função]\nObjetivo do Agente: [Descrição clara do que o agente deve realizar]\nMétricas de Sucesso Esperadas: [Lista de métricas (ex: taxa de sucesso, tempo de resposta, precisão, custo)]\nResultados Observados: [Dados concretos e observações sobre o desempenho do agente (ex: 80% de taxa de sucesso, média de 5s de resposta, 10% de erros em casos complexos, etc.)]\nContexto Adicional: [Qualquer informação relevante sobre o ambiente, os dados de treinamento ou limitações do agente]\n\nCom base nas informações fornecidas, gere um relatório de avaliação contendo os seguintes itens:\n\n1.  **Resumo Executivo:** Uma breve visão geral do desempenho do agente.\n2.  **Análise de Pontos Fortes:** Quais aspectos o agente performou bem e por quê.\n3.  **Análise de Pontos Fracos:** Onde o agente falhou ou teve desempenho abaixo do esperado e por quê.\n4.  **Áreas de Otimização:** Sugestões específicas para melhoria do agente, incluindo possíveis ajustes no prompt, dados de treinamento, arquitetura ou lógica de decisão.\n5.  **Recomendações Práticas:** Próximos passos acionáveis para aprimorar o agente, visando as métricas de sucesso.\n6.  **Potenciais Riscos/Vieses:** Identifique quaisquer vieses ou riscos não intencionais que o desempenho atual possa indicar.\n\nFormato da Saída: Relatório estruturado, claro e objetivo.',
    tags: ['Agentes IA', 'Otimização', 'Avaliação', 'Performance'],
  },
  {
    id: 'negocios-analise-reputacao-marca-ia',
    title: 'Analisador de Reputação de Marca Multicanal',
    category: 'Negócios',
    description: 'Analisa a reputação de uma marca a partir de diversas fontes digitais e multimodais, identificando sentimentos, temas recorrentes, oportunidades e riscos para a imagem corporativa.',
    template: 'Você é um especialista em inteligência de mercado e análise de reputação de marca com IA. Sua tarefa é analisar a percepção pública de uma marca a partir de dados coletados de múltiplas fontes.\n\nNome da Marca: [Nome da Marca a ser analisada]\nSetor de Atuação: [Ex: Varejo, Tecnologia, Alimentício, Serviços Financeiros]\nPeríodo de Análise: [Ex: Últimos 6 meses, Ano de 2025]\nFontes de Dados (Listar o tipo de dado):\n- [Mídias Sociais - Ex: Twitter (textos, imagens), Instagram (imagens, vídeos, comentários), LinkedIn (postagens)]\n- [Avaliações Online - Ex: Google Reviews, Reclame Aqui (textos)]\n- [Notícias e Artigos - Ex: Grandes portais de notícias, blogs do setor (textos)]\n- [Vídeos - Ex: YouTube (transcrições de vídeos, comentários)]\n- [Pesquisas de Satisfação - Ex: Resultados de NPS, feedback de clientes (textos, notas)]\n\nObjetivo da Análise: [Ex: Entender a percepção geral da marca, identificar crises, encontrar oportunidades de engajamento, comparar com concorrentes]\n\nCom base nas informações fornecidas (e simulando uma análise multimodal de conteúdo se você tiver a capacidade), gere um relatório detalhado contendo:\n\n1.  **Panorama Geral da Reputação:** Qual é o sentimento predominante (positivo, negativo, neutro) e a intensidade geral.\n2.  **Temas e Assuntos Recorrentes:** Quais são os principais tópicos associados à marca nas diferentes plataformas.\n3.  **Análise por Canal/Fonte:** Como a reputação varia entre as mídias sociais, notícias, avaliações, etc.\n4.  **Identificação de Pontos Fortes:** Aspectos da marca que são consistentemente elogiados ou bem percebidos.\n5.  **Identificação de Pontos Fracos/Críticas:** Áreas onde a marca recebe feedback negativo ou enfrenta desafios de imagem.\n6.  **Análise de Riscos Potenciais:** Identifique sinais de potenciais crises de imagem ou problemas emergentes.\n7.  **Oportunidades de Melhoria e Engajamento:** Sugestões acionáveis para fortalecer a reputação e engajar com o público.\n8.  **Recomendações Estratégicas:** Quais ações a marca deve considerar para gerenciar e aprimorar sua imagem.\n\nFormato da Saída: Relatório estruturado com títulos, bullet points e exemplos concisos (onde aplicável).',
    tags: ['Marca', 'Reputação', 'Mídias Sociais', 'Análise Sentimento'],
  },
  {
    id: 'produtividade-sintese-pesquisa-decisao',
    title: 'Sintetizador de Pesquisa para Decisão Estratégica',
    category: 'Produtividade',
    description: 'Sintetiza de forma abrangente informações de múltiplos documentos e fontes não estruturadas para auxiliar na tomada de decisões complexas, apresentando um resumo analítico com prós, contras e recomendações claras.',
    template: 'Você é um especialista em síntese de informações e suporte à tomada de decisão. Sua tarefa é consolidar dados de diversas fontes para fornecer uma análise estruturada para uma decisão crítica.\n\nDecisão a Ser Tomada: [Descreva a decisão complexa, ex: \'Investir em uma nova tecnologia X\', \'Expandir para o mercado Y\', \'Mudar o modelo de negócios para Z\']\nContexto da Decisão: [Informações de fundo, objetivos e desafios relacionados à decisão]\nFontes de Informação Disponíveis: (Liste e, se possível, forneça os conteúdos ou trechos mais relevantes para cada item)\n- [Documento 1: \'Relatório de Mercado da Tecnologia X\']\n- [Documento 2: \'Análise Financeira do Projeto Y\']\n- [Documento 3: \'Feedback de Clientes sobre o Produto Z\']\n- [Artigo 1: \'Tendências da Indústria A para 2026\']\n- [Dados Internos: \'Performance Atual da Equipe B\']\n- [Outras informações relevantes que você possa fornecer]\n\nRequisitos Específicos para a Análise: [Ex: Focar no impacto financeiro, considerar riscos tecnológicos, avaliar aceitação do cliente, etc.]\n\nCom base nessas informações, gere uma síntese analítica detalhada para a tomada de decisão, incluindo:\n\n1.  **Resumo Executivo da Decisão:** Uma visão geral do que a decisão envolve e o escopo da análise.\n2.  **Opções Consideradas (se aplicável):** Apresente as principais alternativas para a decisão.\n3.  **Análise Detalhada (para a decisão principal ou cada opção):**\n    *   **Prós:** Pontos positivos e benefícios, com base nas fontes.\n    *   **Contras:** Pontos negativos, riscos e desafios, com base nas fontes.\n    *   **Impactos (Financeiro, Operacional, Estratégico, etc.):** Avalie as consequências em diferentes áreas.\n4.  **Pontos Críticos e Incertezas:** Quais são os maiores desafios e as áreas com falta de informação clara.\n5.  **Recomendação Estratégica:** Uma recomendação clara e justificada, com base na análise.\n6.  **Próximos Passos Sugeridos:** Ações imediatas ou futuras para implementar a decisão ou mitigar riscos.\n\nFormato da Saída: Documento estruturado, claro, com tópicos e linguagem de negócios.',
    tags: ['Análise Dados', 'Tomada Decisão', 'Pesquisa', 'Conhecimento'],
  },
  {
    id: 'dev-documentacao-openapi-ia',
    title: 'Gerador de Documentação OpenAPI (Swagger) Automatizado',
    category: 'Desenvolvimento',
    description: 'Gera documentação completa e padronizada no formato OpenAPI (Swagger) para uma API RESTful, com base em descrições de endpoints, modelos de dados, autenticação e exemplos de requisições/respostas, permitindo integração com ferramentas de desenvolvimento.',
    template: 'Você é um engenheiro de software especialista em documentação de APIs e padrões OpenAPI/Swagger. Sua tarefa é gerar uma documentação técnica completa para uma API RESTful.\n\nInformações da API:\n-   **Nome da API:** [Nome da API, ex: \'API de Gestão de Usuários\']\n-   **Versão da API:** [Ex: \'1.0.0\']\n-   **Base URL:** [Ex: \'https://api.meudominio.com/v1\']\n-   **Descrição Geral:** [Breve descrição da finalidade da API]\n-   **Autenticação (se houver):** [Ex: \'Bearer Token (JWT)\', \'API Key\', \'OAuth 2.0 - [Detalhes]\']\n\nEndpoints:\nPara cada endpoint, forneça os seguintes detalhes:\n-   **Caminho (Path):** [Ex: \'/users\', \'/products/{id}\']\n-   **Método HTTP:** [Ex: \'GET\', \'POST\', \'PUT\', \'DELETE\']\n-   **Descrição do Endpoint:** [O que este endpoint faz]\n-   **Parâmetros (se houver):**\n    -   [Nome do Parâmetro]: [Tipo (path, query, header, body)], [Tipo de Dado (string, integer)], [Obrigatório (sim/não)], [Descrição], [Exemplo]\n-   **Corpo da Requisição (para POST/PUT, se houver):**\n    -   [Modelo de Dados ou Objeto JSON esperado, ex: \'{ "name": "string", "email": "string" }\']\n    -   [Exemplo de Requisição]\n-   **Respostas (para cada código de status relevante):**\n    -   [Código de Status HTTP]: [Descrição da Resposta (ex: \'Sucesso\', \'Recurso não encontrado\')]\n    -   [Corpo da Resposta (se houver): Modelo de Dados ou Objeto JSON esperado]\n    -   [Exemplo de Resposta]\n\nModelos de Dados (Schemas - Opcional, se você quiser definir objetos reutilizáveis):\n-   [Nome do Modelo]: [Estrutura JSON do modelo, ex: \'User\': \'{ "id": "integer", "name": "string", "email": "string" }\']\n\nCom base nas informações acima, gere uma documentação no formato OpenAPI 3.x (YAML ou JSON, sua escolha, mas seja consistente), que inclua:\n\n1.  **Informações da API (info, servers).**\n2.  **Componentes de Segurança (securitySchemes), se aplicável.**\n3.  **Tags para agrupar endpoints.**\n4.  **Definição completa de cada Endpoint (paths), incluindo métodos, parâmetros, corpos de requisição e respostas.**\n5.  **Definição dos Modelos de Dados (components/schemas), se fornecidos.**\n6.  **Exemplos de requisições e respostas para cada operação.**\n\nFormato da Saída: O conteúdo do arquivo YAML (ou JSON) completo para OpenAPI 3.x.',
    tags: ['API REST', 'Documentação', 'OpenAPI', 'Desenvolvimento'],
  },
  {
    id: 'negocios-agente-gestao-stakeholders-projeto',
    title: 'Agente IA para Gestão Ativa de Stakeholders em Projetos Complexos',
    category: 'Negócios',
    description: 'Crie um plano dinâmico de gestão de stakeholders, identificando riscos, oportunidades e estratégias de comunicação e engajamento adaptativas para um projeto complexo.',
    template: 'Aja como um Agente de Gestão de Stakeholders. Para o projeto "[Nome do Projeto]", cujo objetivo principal é "[Objetivo do Projeto]", e que se encontra na fase "[Fase Atual do Projeto]", você deve: \n\n1.  **Identificar e Mapear Stakeholders:** Com base na descrição do projeto e nas seguintes informações iniciais: [Liste os stakeholders iniciais conhecidos e suas possíveis áreas de interesse], identifique stakeholders adicionais relevantes (internos e externos) e classifique-os por poder, interesse e influência. \n2.  **Análise de Impacto e Riscos:** Para cada stakeholder, detalhe o potencial impacto no projeto (positivo e negativo) e os riscos ou desafios que eles podem apresentar, considerando cenários como [Ex: Resistência a mudanças, falta de recursos, desalinhamento de expectativas]. \n3.  **Estratégias de Engajamento Personalizadas:** Proponha estratégias de comunicação e engajamento específicas para cada grupo de stakeholders. Inclua a frequência de comunicação, o formato (Ex: Reuniões quinzenais, relatórios mensais, workshops), e a mensagem chave a ser transmitida para manter o alinhamento e a colaboração. \n4.  **Plano de Mitigação e Oportunidades:** Crie um plano de mitigação para os riscos identificados e sugestões para alavancar as oportunidades apresentadas por cada stakeholder. \n5.  **Métricas de Sucesso:** Defina indicadores chave de performance (KPIs) para medir a eficácia da gestão de stakeholders ao longo do projeto. \n\nConsidere que a cultura organizacional é [Descreva brevemente a cultura, Ex: Aberta a colaboração, hierárquica, orientada a resultados].',
    tags: ['agente IA', 'gestão de projetos', 'stakeholders', 'planejamento estratégico'],
  },
  {
    id: 'social-media-agente-tendencias-engajamento-preditivo',
    title: 'Agente Preditivo de Tendências de Engajamento para Redes Sociais',
    category: 'Redes Sociais',
    description: 'Utilize IA para analisar dados históricos e atuais de redes sociais, prevendo futuras tendências de engajamento e recomendando ajustes estratégicos para o conteúdo.',
    template: 'Aja como um Agente de Análise Preditiva de Engajamento para Redes Sociais. Minha marca, "[Nome da Marca]", atua no setor de "[Setor de Atuação]". Meu público-alvo principal é [Descreva o público-alvo, Ex: Jovens profissionais entre 25-35 anos, interessados em sustentabilidade]. \n\nCom base nos dados históricos que indicam [Principais insights dos seus dados passados, Ex: Vídeos curtos tiveram 20% mais engajamento que posts estáticos nos últimos 3 meses] e nas plataformas principais que utilizamos ([Lista de plataformas, Ex: Instagram, TikTok, LinkedIn]), você deve: \n\n1.  **Analisar Padrões Atuais:** Identifique os tipos de conteúdo, formatos e horários de publicação que geram maior e menor engajamento para a minha marca e meus concorrentes principais ([Ex: Concorrente A, Concorrente B]) nas últimas [Período, Ex: 6 meses]. \n2.  **Prever Tendências de Engajamento:** Com base em sua análise e em tendências gerais do mercado para "[Setor de Atuação]", preveja as 3-5 principais tendências de conteúdo e engajamento que dominarão as redes sociais nos próximos [Período, Ex: 6-12 meses] para o meu público-alvo. \n3.  **Recomendar Otimizações Estratégicas:** Sugira ações concretas para otimizar minha estratégia de conteúdo, incluindo novos formatos, temas, estilos de comunicação e horários de publicação, a fim de capitalizar nas tendências previstas e aumentar meu [Métrica de objetivo, Ex: Alcance, Engajamento, Geração de Leads]. \n4.  **Identificar Riscos e Oportunidades:** Aponte potenciais riscos (Ex: Saturação de formato, mudanças de algoritmo) e novas oportunidades (Ex: Colaborações, formatos emergentes) que devo considerar. \n\nMeus objetivos são [Ex: Aumentar o reconhecimento da marca em 30%, gerar 10% mais leads qualificados pelas redes sociais].',
    tags: ['engajamento', 'tendências', 'análise preditiva', 'estratégia social'],
  },
  {
    id: 'dev-agente-design-arquitetura-eventos',
    title: 'Agente IA para Design de Arquitetura Orientada a Eventos (EDA)',
    category: 'Desenvolvimento',
    description: 'Ajude a projetar uma arquitetura de software orientada a eventos para um sistema, definindo eventos, produtores, consumidores e a infraestrutura necessária.',
    template: 'Aja como um Arquiteto de Software especialista em Arquiteturas Orientadas a Eventos (EDA). Para o sistema "[Nome do Sistema]", cujo objetivo principal é "[Objetivo do Sistema]", e que atualmente possui [Ex: Uma arquitetura monolítica, um conjunto de microsserviços acoplados] com os seguintes módulos/funcionalidades principais: [Liste as principais funcionalidades ou módulos], você deve: \n\n1.  **Identificar Eventos Chave:** Analise as funcionalidades e determine os eventos de domínio mais relevantes que podem ser publicados e consumidos para desacoplar e otimizar o sistema. Para cada evento, defina seu nome, payload (dados que carrega) e o contexto em que ocorre. \n2.  **Definir Produtores e Consumidores:** Para cada evento identificado, especifique quais componentes ou serviços seriam os produtores (quem gera o evento) e quais seriam os consumidores (quem reage ao evento), descrevendo brevemente suas responsabilidades. \n3.  **Escolher Tecnologias de Mensageria:** Recomende as tecnologias de mensageria mais adequadas para implementar esta EDA, considerando [Ex: Escalabilidade, durabilidade, baixa latência, custo, familiaridade da equipe]. Sugira opções como [Ex: Kafka, RabbitMQ, AWS SQS/SNS, Azure Service Bus] e justifique sua escolha. \n4.  **Desenhar um Diagrama Conceitual:** Descreva um diagrama conceitual da arquitetura, mostrando os eventos, produtores, consumidores e a infraestrutura de mensageria. Use pseudocódigo ou notação UML simplificada para a descrição. \n5.  **Considerações de Resiliência e Monitoramento:** Proponha estratégias para garantir a resiliência da arquitetura (Ex: Retries, dead-letter queues, idempotent consumers) e como monitorar a saúde e o fluxo de eventos na arquitetura. \n\nO principal desafio que queremos resolver com esta mudança é [Ex: Escalabilidade, integração de sistemas legados, processamento em tempo real].',
    tags: ['arquitetura de software', 'EDA', 'microsserviços', 'engenharia de software'],
  },
  {
    id: 'career-plano-carreira-multimodal-ia',
    title: 'Plano de Carreira Multimodal Acelerado por IA',
    category: 'Carreira',
    description: 'Crie um plano de carreira detalhado e adaptativo, utilizando IA para identificar as habilidades necessárias, sugerir recursos de aprendizagem multimodais e simular cenários de desenvolvimento profissional.',
    template: 'Aja como um Coach de Carreira com IA, especializado em desenvolvimento profissional acelerado. Meu objetivo é transicionar da minha posição atual de "[Cargo Atual]" para "[Cargo Desejado ou Objetivo de Carreira]" na área de "[Setor de Atuação]". Eu tenho [Anos de experiência] de experiência e minhas principais habilidades atuais são: [Liste suas habilidades chave]. \n\nCom base nisso, você deve: \n\n1.  **Análise de Lacunas de Habilidades (Skill Gap Analysis):** Compare meu perfil atual com os requisitos para o cargo desejado ou o objetivo de carreira, identificando as 5-7 habilidades técnicas e soft skills mais críticas que preciso desenvolver. \n2.  **Roteiro de Aprendizagem Multimodal:** Para cada habilidade identificada, proponha um roteiro de aprendizagem com recursos multimodais (Ex: Cursos online, livros, podcasts, artigos, projetos práticos, workshops, mentoria). Priorize recursos que possam ser concluídos em um prazo de [Tempo total desejado, Ex: 6 meses, 1 ano]. \n3.  **Simulação de Cenários de Desenvolvimento:** Apresente 2-3 cenários de como a aquisição dessas habilidades pode impactar minha progressão de carreira, incluindo possíveis desafios e como superá-los. \n4.  **Estratégias de Networking e Visibilidade:** Recomende estratégias de networking e ações para aumentar minha visibilidade profissional no setor de "[Setor de Atuação]", focando em plataformas como [Ex: LinkedIn, conferências, comunidades online]. \n5.  **Plano de Ação e Métricas:** Crie um plano de ação semanal/mensal com marcos claros e métricas para acompanhar meu progresso. \n\nMeus formatos de aprendizagem preferidos são [Ex: Aprendizagem prática, vídeos curtos, leitura aprofundada].',
    tags: ['carreira', 'desenvolvimento profissional', 'habilidades', 'aprendizagem multimodal'],
  },
  {
    id: 'ia-otimizacao-atendimento-cliente-ia-conversacional',
    title: 'Agente IA para Otimização de Atendimento ao Cliente com IA Conversacional',
    category: 'IA & Automação',
    description: 'Projete uma estratégia de otimização de atendimento ao cliente, incorporando IA conversacional e agentes inteligentes para melhorar a eficiência e a satisfação do cliente.',
    template: 'Aja como um Arquiteto de Soluções de IA para Atendimento ao Cliente. Minha empresa, "[Nome da Empresa]", no setor de "[Setor de Atuação]", enfrenta os seguintes desafios no atendimento ao cliente: [Liste 3-5 desafios, Ex: Alto volume de chamadas, tempo de espera elevado, inconsistência nas respostas, baixa satisfação]. Atualmente, nosso atendimento é realizado via [Canais atuais, Ex: Telefone, E-mail, Chat no site]. \n\nMeu objetivo é [Ex: Reduzir o tempo médio de atendimento em 25%, aumentar a satisfação do cliente em 15%, diminuir custos operacionais em 20%]. Com base nisso, você deve: \n\n1.  **Mapear o Fluxo Atual e Pontos de Dor:** Descreva o fluxo de atendimento ao cliente atual, identificando os principais gargalos e pontos de dor para clientes e agentes. \n2.  **Propor Soluções com IA Conversacional:** Sugira onde a IA conversacional (chatbots, voicebots) pode ser aplicada no fluxo para resolver os desafios identificados. Detalhe quais tipos de interações podem ser automatizadas e como. \n3.  **Desenho da Interação Agente-Humano-IA:** Crie um modelo de interação onde agentes humanos e a IA conversacional colaborem. Descreva os critérios para escalonamento para um humano e como a IA pode apoiar o agente humano (Ex: Sugerir respostas, resumir histórico). \n4.  **Recomendar Tecnologias e Implementação:** Sugira plataformas e ferramentas de IA conversacional (Ex: Google Dialogflow, IBM Watson Assistant, Zendesk Answer Bot) e um plano de implementação gradual. \n5.  **Métricas de Sucesso e Monitoramento:** Defina KPIs para medir o sucesso da implementação (Ex: FCR - First Contact Resolution, Tempo Médio de Atendimento, CSAT - Customer Satisfaction Score) e como monitorar a performance da IA. \n\nO volume médio de interações diárias é de [Número de interações].',
    tags: ['atendimento ao cliente', 'IA conversacional', 'automação', 'otimização de processos'],
  },
  {
    id: 'escrita-adaptacao-conteudo-multicanal-ia',
    title: 'Agente de Adaptação de Conteúdo Multicanal',
    category: 'Escrita',
    description: 'Transforma um conteúdo central em múltiplos formatos otimizados para diferentes canais de comunicação, mantendo a coerência e o objetivo.',
    template: 'Você é um Agente de Adaptação de Conteúdo Multicanal. Sua tarefa é pegar o [conteúdo original] e adaptá-lo para os seguintes [canais de comunicação] com seus respectivos [formatos desejados]. O [objetivo principal do conteúdo] é [explicar objetivo]. O [público-alvo] é [descrever público]. Para cada canal/formato, inclua: 1. Uma breve descrição da adaptação e por que ela é eficaz para o canal. 2. O conteúdo adaptado. O conteúdo original é: \'[conteúdo original texto]\'. Canais/Formatos desejados: [ex: Blog post, Tweet thread, Script de vídeo curto para Instagram, Email de newsletter]. Objetivo principal: [ex: Gerar leads, Engajar audiência, Informar].',
    tags: ['Conteúdo Multicanal', 'Adaptação de IA', 'Estratégia de Conteúdo', 'Produtividade'],
  },
  {
    id: 'dev-design-seguranca-api-ia',
    title: 'Agente de Design de Segurança de APIs',
    category: 'Desenvolvimento',
    description: 'Ajuda a projetar estratégias de segurança robustas para APIs RESTful ou microsserviços, cobrindo autenticação, autorização e proteção.',
    template: 'Você é um Agente de Design de Segurança de APIs. Preciso de ajuda para projetar a estratégia de segurança para uma API [RESTful/GraphQL/Microsserviço] com as seguintes características: [descrever características da API, ex: pública/interna, dados sensíveis, tipo de usuários]. O [ambiente de deployment] é [ex: nuvem AWS/GCP/Azure, on-premise]. O [requisito de conformidade] é [ex: LGPD, GDPR, HIPAA]. Com base nestas informações, forneça recomendações detalhadas para: 1. **Autenticação**: Métodos e fluxos (ex: OAuth 2.0, JWT, API Keys). 2. **Autorização**: Estratégias (ex: RBAC, ABAC) e como implementá-las. 3. **Proteção contra Ameaças Comuns**: Recomendações para prevenção de ataques (ex: injeção SQL, XSS, DDoS, rate limiting). 4. **Logging e Monitoramento**: Quais informações registrar e como monitorar atividades de segurança. 5. **Melhores Práticas**: Outras dicas de segurança relevantes para este cenário. A API que estamos desenhando é para [breve descrição da funcionalidade da API].',
    tags: ['Segurança API', 'Microsserviços', 'Desenvolvimento Seguro', 'Arquitetura de Software'],
  },
  {
    id: 'finance-coach-estrategico-freelancer-ia',
    title: 'Coach Financeiro Estratégico para Freelancers',
    category: 'Finanças',
    description: 'Oferece orientação financeira estratégica para freelancers e autônomos, abordando fluxo de caixa irregular, impostos e investimentos.',
    template: 'Você é um Coach Financeiro Estratégico especializado em freelancers e autônomos. Minha situação atual é a seguinte: - **Renda Mensal Média**: [Valor médio da renda, ex: R$ 5.000,00] com [grau de irregularidade, ex: alta variabilidade / moderada]. - **Despesas Fixas Mensais**: [Valor total das despesas fixas, ex: R$ 2.500,00]. - **Objetivos Financeiros**: [Ex: Poupar R$ X para entrada de imóvel, ter 6 meses de reserva de emergência, investir para aposentadoria, planejar férias]. - **Conhecimento Fiscal**: [Ex: Pouco conhecimento sobre impostos de PJ/autônomo / Já pago DAS/IR mas quero otimizar]. - **Conhecimento em Investimentos**: [Ex: Iniciante / Moderado / Experiente em renda fixa]. - **Desafios Atuais**: [Ex: Dificuldade em controlar fluxo de caixa, medo de impostos, não sei como investir com renda variável]. Com base nisso, forneça um plano de ação estratégico que inclua: 1. **Gestão de Fluxo de Caixa Irregular**: Estratégias para lidar com a variabilidade da renda. 2. **Otimização Fiscal**: Dicas e considerações para reduzir legalmente a carga tributária (Simples Nacional, MEI, Lucro Presumido, etc.). 3. **Estratégias de Investimento**: Recomendações personalizadas para meus objetivos e tolerância a risco. 4. **Formação de Reserva de Emergência**: Plano para construir e manter uma reserva robusta. 5. **Dicas de Escalabilidade Financeira**: Como pensar no crescimento da minha carreira como freelancer. Minha principal área de atuação é [ex: marketing digital, desenvolvimento de software, design gráfico].',
    tags: ['Finanças Pessoais', 'Freelancer', 'Planejamento Fiscal', 'Investimento'],
  },
  {
    id: 'education-curriculo-habilidades-emergentes-ia-avancado',
    title: 'Agente de Design de Currículo para Habilidades Emergentes',
    category: 'Educação',
    description: 'Ajuda a criar um currículo de aprendizado detalhado para dominar uma nova habilidade ou tecnologia emergente, com foco em aplicação prática.',
    template: 'Você é um Agente de Design de Currículo especializado em habilidades emergentes. Meu objetivo é aprender e me tornar proficiente em [habilidade/tecnologia emergente, ex: Engenharia de Prompts para LLMs, Desenvolvimento de Agentes de IA, Data Science com Python e PySpark, Web3 Development com Solidity]. - **Nível Atual**: [Ex: Iniciante total / Conhecimento básico / Conhecimento intermediário em áreas relacionadas]. - **Tempo Disponível por Semana**: [Ex: 10 horas / 20 horas / 40 horas]. - **Estilo de Aprendizagem Preferido**: [Ex: Leitura e prática / Vídeos e projetos / Mentoria e workshops]. - **Recursos Preferidos**: [Ex: Cursos online pagos (Coursera, Udacity), documentação oficial, livros, bootcamps, comunidades]. - **Objetivo de Carreira**: [Ex: Transição para a área de IA / Melhorar minhas habilidades atuais para promoções / Empreender com esta tecnologia]. Crie um currículo de aprendizado estruturado em [X, ex: 3-6] módulos, incluindo para cada módulo: 1. **Nome do Módulo e Tópicos Chave**: Detalhes do que será abordado. 2. **Recursos de Aprendizado Sugeridos**: Links ou nomes de cursos, livros, tutoriais, documentações. 3. **Projetos Práticos Recomendados**: Ideias de projetos para aplicar o conhecimento. 4. **Avaliação/Verificação de Conhecimento**: Como saber que o aprendizado foi consolidado. 5. **Tempo Estimado**: Sugestão de tempo para completar o módulo. No final, inclua uma seção de **Próximos Passos e Dicas de Carreira** para a habilidade/tecnologia escolhida. A habilidade/tecnologia que quero aprender é [reafirmar habilidade/tecnologia].',
    tags: ['Desenvolvimento de Habilidades', 'Aprendizagem Adaptativa', 'Carreira em Tech', 'Currículo Personalizado'],
  },
  {
    id: 'social-media-otimizacao-conteudo-curto-ia',
    title: 'Agente de Otimização de Conteúdo para TikTok/Shorts',
    category: 'Redes Sociais',
    description: 'Otimiza roteiros de vídeos curtos para TikTok, Reels e Shorts, maximizando engajamento e visibilidade, com foco em tendências e viralidade.',
    template: 'Você é um Agente de Otimização de Conteúdo de Vídeo Curto, especialista em TikTok, Instagram Reels e YouTube Shorts. Meu objetivo é [descrever objetivo, ex: aumentar o engajamento, gerar leads, criar reconhecimento de marca] para [minha marca/meu perfil pessoal] no nicho de [nicho, ex: finanças pessoais, culinária vegana, produtividade para devs]. Tenho um rascunho de roteiro de vídeo curto, e preciso que você o otimize para as plataformas mencionadas, com foco em viralidade, retenção e engajamento. **Rascunho do Roteiro:** [Cole aqui o roteiro completo ou a ideia central do seu vídeo. Ex: \'Começo com uma pergunta sobre dinheiro. Mostro uma dica rápida. Termino com CTA para seguir.\'] **Informações Adicionais:** - **Duração Desejada**: [Ex: 15-30 segundos]. - **Público-Alvo**: [Descrever demografia e interesses]. - **Call to Action (CTA) Desejado**: [Ex: \'Siga para mais dicas\', \'Deixe seu comentário\', \'Link na bio\']. - **Estilo/Tom**: [Ex: Engraçado, informativo, inspirador, direto]. - **Tópicos/Palavras-chave Relevantes**: [Lista de palavras-chave, ex: #finançaspessoais #investimento #rendaextra]. **Sua otimização deve incluir:** 1. **Hook (Gancho) Aprimorado**: Sugestões para os primeiros 3 segundos cruciais. 2. **Estrutura Otimizada**: Reorganização ou adição de elementos para máxima retenção. 3. **Sugestões Visuais/Sonoras**: Ideias para transições, legendas, músicas ou efeitos de áudio populares. 4. **CTA Claro e Atraente**: Refinamento do Call to Action. 5. **Sugestões de Hashtags e Texto da Legenda**: Para aumentar a descoberta. 6. **Análise de Tendências**: Como o vídeo pode se alinhar a tendências atuais das plataformas. O vídeo é sobre [breve resumo do tema do vídeo].',
    tags: ['Marketing Digital', 'Vídeos Curtos', 'TikTok', 'Engajamento', 'Viralidade'],
  },
  {
    id: 'career-otimizacao-perfil-freelancer-ia',
    title: 'Otimizador de Perfil para Plataformas Freelancer com IA',
    category: 'Carreira',
    description: 'Otimiza seu perfil de freelancer para plataformas específicas, destacando habilidades e experiência para atrair mais clientes e projetos.',
    template: 'Como um especialista em otimização de perfis de freelancer e IA, analise meu perfil e me forneça sugestões detalhadas para otimizá-lo na plataforma [Nome da Plataforma Freelancer, ex: Upwork, 99Freelas].\nMeus dados atuais do perfil são:\n- Título/Cargo: [Seu título atual]\n- Resumo/Bio: [Sua descrição atual]\n- Habilidades Principais: [Lista de 3-5 habilidades principais]\n- Experiência (breve): [1-2 frases sobre sua experiência mais relevante]\n- Tipo de Serviço que busco: [Ex: Desenvolvimento Web, Design Gráfico, Escrita de Conteúdo, Consultoria de Marketing]\n- Preço/Hora ou Faixa de Preço (se aplicável): [Ex: R$50/hora, Projetos a partir de R$500]\nBaseado nessas informações e nas melhores práticas da plataforma [Nome da Plataforma Freelancer], gere:\n1.  Um Título de Perfil Otimizado (máx. 80 caracteres)\n2.  Uma Biografia/Resumo Otimizado (máx. 500 caracteres), incluindo palavras-chave relevantes e um call-to-action sutil.\n3.  Sugestões de 5-7 Habilidades Adicionais (além das que já listei) que são populares e relevantes para meu nicho na plataforma.\n4.  Três exemplos de Frases de Abertura (cover letter/proposal intro) que posso usar para me candidatar a projetos, adaptadas ao meu perfil e tipo de serviço.\n5.  Duas dicas específicas para se destacar na plataforma [Nome da Plataforma Freelancer], considerando as tendências atuais de sucesso.\nPriorize clareza, concisão e apelo para potenciais clientes.',
    tags: ['Freelancer', 'Otimização', 'Carreira', 'IA'],
  },
  {
    id: 'negocios-analise-viabilidade-produto-ia',
    title: 'Análise de Viabilidade de Produto/Serviço Impulsionada por IA',
    category: 'Negócios',
    description: 'Avalia a viabilidade de um novo produto ou serviço no mercado, fornecendo insights sobre demanda, concorrência, precificação e riscos potenciais.',
    template: 'Como um agente de inteligência de mercado e negócios, realize uma análise de viabilidade detalhada para o seguinte produto/serviço:\n- Nome do Produto/Serviço: [Nome do Produto/Serviço]\n- Descrição Breve: [Descrição de 2-3 frases do produto/serviço e seu principal benefício]\n- Público-Alvo Primário: [Ex: Pequenas empresas, jovens adultos, profissionais de marketing]\n- Problema que Resolve: [Qual problema este produto/serviço soluciona?]\n- Principais Características/Funcionalidades: [Lista de 3-5 características chave]\n- Mercado Alvo (Geografia/Nicho): [Ex: Brasil, mercado de SaaS para PMEs, setor de bem-estar]\nCom base nessas informações, forneça uma análise estruturada contendo:\n1.  **Análise de Demanda de Mercado**: Avalie o tamanho potencial do mercado e o interesse do público-alvo. Cite evidências de demanda, se possível (ex: tendências, buscas).\n2.  **Análise de Concorrência**: Identifique 2-3 concorrentes diretos e indiretos. Descreva seus pontos fortes e fracos em relação ao meu produto/serviço.\n3.  **Proposta de Valor Única (UVP)**: Formule uma UVP clara que diferencie meu produto/serviço no mercado.\n4.  **Sugestão de Modelo de Precificação**: Proponha um modelo de precificação (ex: assinatura, freemium, one-time purchase) e uma faixa de preço justificada.\n5.  **Principais Riscos e Desafios**: Identifique 3-5 riscos potenciais (ex: saturação de mercado, desenvolvimento tecnológico, custo de aquisição de cliente) e sugestões de mitigação.\n6.  **Recomendação Final**: Com base na análise, uma recomendação clara sobre a viabilidade geral do produto/serviço, com próximos passos sugeridos.\nApresente a análise de forma concisa e com bullet points para facilitar a leitura.',
    tags: ['Negócios', 'Viabilidade', 'Produto', 'Mercado', 'Estratégia'],
  },
  {
    id: 'produtividade-rotina-bem-estar-personalizada-ia',
    title: 'IA para Criação de Rotina Personalizada de Bem-Estar e Foco',
    category: 'Produtividade',
    description: 'Desenha uma rotina diária ou semanal otimizada para aumentar o bem-estar e a capacidade de foco, considerando seus hábitos e preferências.',
    template: 'Como um coach de produtividade e bem-estar impulsionado por IA, crie uma rotina personalizada focada em otimizar meu bem-estar e capacidade de foco. Considere as seguintes informações:\n- Período da Rotina: [Ex: Rotina Diária de Segunda a Sexta, Rotina Semanal Completa]\n- Horário de Início do Dia: [Ex: 7h00]\n- Horário de Término do Dia: [Ex: 18h00]\n- Tipo de Trabalho: [Ex: Trabalho remoto focado em projetos, Trabalho em escritório com reuniões frequentes, Estudo intensivo]\n- Principais Desafios de Foco/Bem-Estar: [Ex: Dificuldade em iniciar tarefas, Procrastinação, Fadiga mental, Falta de tempo para exercícios, Estresse]\n- Preferências de Atividades de Bem-Estar: [Ex: Meditação (10min), Exercício leve (30min), Leitura (15min), Caminhada, Alongamento]\n- Prioridades do Dia/Semana: [Ex: Entregas de projetos, Aprendizado de nova habilidade, Cuidado pessoal, Tempo com família]\n- Ferramentas/Aplicativos já utilizados: [Ex: Calendário Google, Trello, Pomodoro Timer]\nCom base nisso, gere uma rotina detalhada que inclua:\n1.  **Ritual Matinal Otimizado**: Sugestões de atividades para começar o dia com energia e foco (duração total: [20-45min]).\n2.  **Blocos de Trabalho Focado**: Propostas de como organizar os períodos de trabalho/estudo, incluindo técnicas (ex: Pomodoro, Deep Work) e pausas estratégicas.\n3.  **Pausas Ativas e de Relaxamento**: Ideias para pausas curtas (5-10min) e uma pausa mais longa (30-60min) para almoço/exercício.\n4.  **Ritual de Encerramento do Dia**: Atividades para descomprimir, revisar o dia e preparar-se para o dia seguinte.\n5.  **Sugestões para o Fim de Semana (se for rotina semanal)**: Ideias para recarga e lazer.\n6.  **Dicas de Integração de Tecnologia**: Como usar ferramentas para auxiliar na rotina.\nA rotina deve ser flexível, realista e incluir lembretes para beber água e evitar distrações digitais. Apresente em formato de agenda com horários e atividades.',
    tags: ['Bem-estar', 'Foco', 'Rotina', 'Produtividade', 'IA Coach'],
  },
  {
    id: 'ai-design-agente-suporte-cliente-multicanal',
    title: 'Design de Agente IA para Suporte ao Cliente Multicanal',
    category: 'IA & Automação',
    description: 'Projeta a arquitetura e as funcionalidades de um agente de IA para oferecer suporte ao cliente integrado em múltiplos canais de comunicação.',
    template: 'Como um especialista em design de IA e automação de processos, desenvolva um plano de design para um agente de IA focado em suporte ao cliente, capaz de operar em múltiplos canais. O objetivo é otimizar a experiência do cliente e a eficiência operacional.\nAs seguintes informações são para o design:\n- Empresa/Setor: [Ex: E-commerce de moda, Software B2B, Serviços financeiros]\n- Principais Canais de Suporte Atuais: [Ex: Chat online, E-mail, Telefone, WhatsApp, Redes Sociais]\n- Volume de Atendimento Estimado (mensal): [Ex: 5.000 interações]\n- Tipos Comuns de Demandas: [Ex: Status de pedido, Alteração de dados, Dúvidas sobre produtos, Suporte técnico básico, Reclamações]\n- Linguagens de Atendimento: [Ex: Português, Inglês, Espanhol]\n- Sistemas Atuais (CRM, base de conhecimento): [Ex: Salesforce, Zendesk, Base de Conhecimento interna]\nCom base nestas informações, gere um design detalhado do agente de IA, incluindo:\n1.  **Arquitetura do Agente**: Descreva os componentes chave (ex: NLU/NLG, Gerenciamento de Diálogo, Integrações, Módulo de Escalada) e como eles se interligam para um atendimento multicanal.\n2.  **Fluxos de Atendimento Prioritários**: Proponha 3-4 fluxos de atendimento automatizados para as demandas mais comuns, especificando como o agente lidaria com cada um em diferentes canais.\n3.  **Estratégia de Integração Multicanal**: Como o agente garantirá uma experiência consistente e transferências fluidas entre canais (ex: retomar conversa de onde parou).\n4.  **Critérios e Mecanismos de Escalada**: Defina quando e como o agente deve escalar para um atendente humano, e quais informações devem ser transferidas.\n5.  **Estratégias de Treinamento e Otimização Contínua**: Como o agente aprenderá e melhorará ao longo do tempo (ex: feedback humano, análise de conversas).\n6.  **Métricas de Sucesso**: Quais métricas chave (ex: taxa de resolução de primeira chamada, satisfação do cliente, tempo médio de atendimento) usar para avaliar o desempenho do agente.\nO design deve ser escalável, modular e focar na redução de atrito para o cliente e para a equipe de suporte.',
    tags: ['IA', 'Automação', 'Suporte ao Cliente', 'Multicanal', 'Design de Agente'],
  },
  {
    id: 'escrita-agente-narrativa-multimodal',
    title: 'Agente de Narrativa Multimodal',
    category: 'Escrita',
    description: 'Gera uma narrativa coesa e adaptável para diferentes formatos de mídia (texto, vídeo, áudio, interativo), focando na história central.',
    template: 'Você é um especialista em storytelling e design de narrativas multimodais. Seu objetivo é criar o esqueleto de uma narrativa envolvente que possa ser adaptada a múltiplos canais de comunicação. Considere o seguinte:\n\n1.  **Público-alvo:** [Público-alvo (ex: jovens empreendedores, pais de primeira viagem, entusiastas de tecnologia)]\n2.  **Tema Central:** [Tema Central (ex: superação de desafios, inovação sustentável, o futuro do trabalho)]\n3.  **Objetivo da Narrativa:** [Objetivo da Narrativa (ex: entreter, educar, persuadir a uma ação específica, inspirar mudança)]\n4.  **Personagens Principais:** [Descrição breve dos personagens principais, seus arcos e motivações. Se não houver, indique "Não aplicável"]\n5.  **Principais Pontos da Trama/Mensagem:** [Liste 3-5 eventos-chave, momentos de virada ou ideias centrais que a narrativa deve abordar]\n6.  **Tom e Estilo:** [Ex: inspirador e otimista, divertido e leve, dramático e reflexivo, informativo e didático]\n7.  **Formatos de Saída Desejados:** [Liste os formatos específicos em que esta narrativa deve ser adaptada, ex: roteiro de vídeo curto para TikTok/Reels, post de blog detalhado, script de podcast, infográfico interativo, e-mail marketing]\n\nCom base nessas informações, crie:\n\nA.  **Sinopse da Narrativa:** Uma breve descrição da história ou mensagem central (aprox. 100-150 palavras).\nB.  **Arcos de Personagens/Mensagens Chave:** Detalhe os arcos de desenvolvimento dos personagens ou a evolução das ideias centrais.\nC.  **Ganchos e Pontos de Clímax:** Identifique os momentos mais impactantes ou de maior engajamento.\nD.  **Sugestões de Adaptação por Formato:** Para cada um dos [Formatos de Saída Desejados], descreva como a narrativa pode ser especificamente adaptada, destacando elementos visuais, sonoros ou interativos para cada um. Por exemplo, para um roteiro de vídeo, sugira cenas e diálogos; para um post de blog, a estrutura e os subtítulos; para um podcast, os segmentos e os efeitos sonoros.',
    tags: ['Narrativa', 'Conteúdo Multimodal', 'Storytelling', 'Criação de Conteúdo'],
  },
  {
    id: 'social-media-agente-gestao-comunidade-ia',
    title: 'Agente IA para Gestão Ativa de Comunidade',
    category: 'Redes Sociais',
    description: 'Cria uma estratégia detalhada para um agente de IA gerenciar e engajar uma comunidade online, identificando oportunidades de interação e conteúdo.',
    template: 'Você é um especialista em gestão de comunidades online e design de agentes de IA para mídias sociais. O objetivo é desenvolver um plano para um agente de IA que possa gerenciar e engajar ativamente uma comunidade, promovendo a interação e entregando valor aos membros. Considere os seguintes parâmetros:\n\n1.  **Plataforma da Comunidade:** [Plataforma da Comunidade (ex: Grupo privado do Facebook, Discord, LinkedIn Groups, Fórum no website)]\n2.  **Público-alvo da Comunidade:** [Público-alvo detalhado (ex: desenvolvedores Python iniciantes, empreendedores de e-commerce, fãs de RPG de mesa)]\n3.  **Objetivo Principal da Comunidade:** [Objetivo principal (ex: networking, suporte técnico, troca de conhecimentos, entretenimento, fidelização de clientes)]\n4.  **Tópicos de Conteúdo Recorrentes:** [Principais temas e assuntos discutidos na comunidade]\n5.  **Tipos de Interação Desejada:** [Ex: perguntas e respostas, discussões aprofundadas, desafios criativos, compartilhamento de experiências, votações]\n6.  **Métricas de Sucesso para Engajamento:** [Ex: aumento de X% nas postagens por membro, Y% de taxa de resposta, Z% de novos membros ativos, redução de X% no tempo de resposta a dúvidas]\n7.  **Personalidade do Agente IA:** [Descreva o tom e a "personalidade" do agente (ex: amigável e acolhedor, autoritário e informativo, divertido e brincalhão, neutro e facilitador)]\n\nCom base nisso, estruture o plano do Agente IA:\n\nA.  **Nome e Breve Descrição do Agente:** Um nome para o agente e uma frase que resuma sua função.\nB.  **Funções Primárias do Agente:** Liste as 3-5 principais responsabilidades do agente (ex: Boas-vindas a novos membros, Moderação de conteúdo, Respostas a perguntas frequentes, Início de discussões, Identificação de tendências).\nC.  **Estratégias de Engajamento Proativas:** Como o agente pode iniciar interações e promover o conteúdo? (Ex: "Perguntas da Semana", "Desafios Mensais", "Enquetes Temáticas", "Destaque de Membros").\nD.  **Estratégias de Reação e Suporte:** Como o agente deve responder a posts e comentários? (Ex: Fornecer links úteis, chamar outros membros para discussão, escalar problemas complexos para um moderador humano).\nE.  **Mecanismos de Monitoramento e Análise:** Que tipo de dados o agente deve coletar e analisar para otimizar o engajamento? (Ex: Sentimento dos posts, temas emergentes, identificação de influenciadores na comunidade, picos de atividade).\nF.  **Pontos de Escalada/Intervenção Humana:** Em que situações o agente deve alertar um moderador humano ou delegar a interação?',
    tags: ['Gestão de Comunidade', 'Engajamento', 'IA para Redes Sociais', 'Estratégia Digital'],
  },
  {
    id: 'finance-agente-estrategia-crescimento-pme-ia',
    title: 'Agente IA para Estratégia de Crescimento e Resiliência Financeira PME',
    category: 'Finanças',
    description: 'Desenha um plano estratégico financeiro para pequenas e médias empresas, focando em crescimento sustentável e resiliência em diferentes cenários econômicos.',
    template: 'Você é um consultor financeiro estratégico com especialização em PMEs e análise preditiva. O objetivo é desenvolver um plano financeiro robusto para uma pequena ou média empresa, visando crescimento sustentável e aumento da resiliência frente a cenários econômicos variados. Utilize as informações abaixo:\n\n1.  **Setor da PME:** [Setor de atuação da PME (ex: varejo de moda online, serviços de TI para empresas, cafeteria artesanal)]\n2.  **Faturamento Anual Atual:** [Faturamento Anual Atual (estimativa numérica, ex: R$ 500.000,00 - R$ 1.000.000,00)]\n3.  **Principais Produtos/Serviços:** [Liste os principais produtos ou serviços oferecidos]\n4.  **Desafios Financeiros Atuais:** [Descreva 1-3 desafios financeiros que a empresa enfrenta atualmente (ex: alto custo de aquisição de clientes, fluxo de caixa apertado, dependência de um único fornecedor)]\n5.  **Objetivos de Crescimento:** [Descreva 1-2 objetivos de crescimento para os próximos 1-3 anos (ex: aumentar market share em 10%, expandir para uma nova região, lançar uma nova linha de produtos)]\n6.  **Horizonte de Tempo para o Plano:** [Ex: 1 ano, 3 anos, 5 anos]\n7.  **Cenários Econômicos a Considerar:** [Liste 2-3 cenários que o plano deve contemplar (ex: crescimento estável do PIB, recessão moderada com inflação controlada, alta inflação com juros elevados)]\n\nCom base nessas entradas, crie um plano estratégico que inclua:\n\nA.  **Análise Preliminar:** Uma breve avaliação da situação financeira atual e dos desafios, sob a ótica dos objetivos de crescimento.\nB.  **Estratégias de Crescimento e Financiamento:** Propostas para atingir os objetivos de crescimento, incluindo opções de financiamento (ex: reinvestimento de lucros, linhas de crédito, investidores anjo) e como elas se alinham ao setor.\nC.  **Estratégias de Resiliência Financeira:** Medidas para fortalecer a empresa contra os cenários econômicos adversos. Inclua gestão de fluxo de caixa, diversificação de receitas, otimização de custos e gestão de riscos.\nD.  **Plano de Ação por Cenário:** Para cada um dos [Cenários Econômicos a Considerar], detalhe as ações específicas que a PME deve tomar para mitigar riscos e/ou capitalizar oportunidades.\nE.  **Métricas de Acompanhamento:** Indique os principais KPIs (Indicadores Chave de Desempenho) financeiros e operacionais para monitorar o progresso do plano.',
    tags: ['Finanças PME', 'Estratégia Financeira', 'Crescimento Empresarial', 'Resiliência Financeira'],
  },
  {
    id: 'ia-design-sistema-multiagente-gestao-projetos-complexos',
    title: 'Design de Sistema Multiagente para Gestão de Projetos Complexos',
    category: 'IA & Automação',
    description: 'Esboça a arquitetura de um sistema multiagente de IA para gerenciar projetos de alta complexidade, delegando tarefas, otimizando fluxos e resolvendo interdependências.',
    template: 'Você é um arquiteto de sistemas de IA e especialista em gestão de projetos. Seu desafio é desenhar a arquitetura conceitual de um sistema multiagente autônomo para gerenciar um projeto de alta complexidade. Este sistema deve ser capaz de delegar tarefas, otimizar fluxos de trabalho, identificar e resolver interdependências e alertar sobre desvios. Considere os seguintes detalhes do projeto:\n\n1.  **Tipo de Projeto Complexo:** [Tipo de projeto (ex: desenvolvimento de novo produto de hardware e software, implantação de infraestrutura de energia renovável em larga escala, pesquisa e desenvolvimento de nova terapia médica, fusão e aquisição de empresas multinacionais)]\n2.  **Principais Fases do Projeto:** [Liste as fases macro do projeto (ex: Pesquisa, Design, Desenvolvimento, Testes, Lançamento, Monitoramento)]\n3.  **Áreas de Especialização Necessárias:** [Liste as principais áreas funcionais ou técnicas que estarão envolvidas (ex: Engenharia de Software, Design UX/UI, Marketing, Assuntos Regulatórios, Logística, Jurídico, Finanças)]\n4.  **Riscos Inerentes ao Projeto:** [Cite 2-3 riscos comuns ou específicos deste tipo de projeto (ex: atrasos na aprovação regulatória, falhas tecnológicas inesperadas, divergências entre equipes, estouro de orçamento)]\n5.  **Métricas de Sucesso para o Projeto:** [Defina como o sucesso do projeto será medido (ex: conclusão no prazo e orçamento, satisfação do cliente, desempenho do produto, conformidade regulatória)]\n6.  **Recursos Disponíveis:** [Mencione os tipos de recursos (ex: equipe multidisciplinar, orçamento flexível, acesso a grandes volumes de dados, ferramentas de IA e automação existentes)]\n\nCom base nisso, detalhe o design do sistema multiagente:\n\nA.  **Visão Geral do Sistema Multiagente:** Uma breve descrição de como o sistema operará e seu objetivo principal.\nB.  **Agentes Principais e Suas Funções:** Defina pelo menos 4-5 agentes distintos dentro do sistema, cada um com um nome, área de especialização e responsabilidades claras. Exemplos: "Agente Planejador Estratégico", "Agente Otimizador de Recursos", "Agente Analista de Riscos", "Agente Comunicador de Stakeholders", "Agente Executor de Tarefas Técnicas".\nC.  **Mecanismos de Interação entre Agentes:** Explique como os agentes se comunicarão e colaborarão. Quais protocolos ou interfaces serão usados? Como a informação será compartilhada?\nD.  **Tomada de Decisão e Resolução de Conflitos:** Como o sistema, ou um agente específico, tomará decisões autônomas? Como os conflitos entre as recomendações ou ações dos agentes serão resolvidos? (Ex: priorização hierárquica, votação, consulta a um "meta-agente" de coordenação).\nE.  **Integração com Sistemas Existentes:** Como este sistema multiagente se conectaria com outras ferramentas de gestão de projetos (ex: Jira, Asana), repositórios de documentos ou bases de conhecimento?\nF.  **Mecanismos de Monitoramento e Auditoria:** Como o desempenho do sistema e dos agentes será monitorado? Quais serão os pontos de intervenção humana (se houver)?',
    tags: ['Sistema Multiagente', 'Gestão de Projetos', 'IA para Projetos', 'Otimização de Fluxo'],
  },
  {
    id: 'ia-agente-automacao-backoffice-complexo',
    title: 'Agente IA para Automação de Processos de Back-Office Complexos',
    category: 'IA & Automação',
    description: 'Projeta um agente IA autônomo para otimizar e automatizar um processo de back-office complexo, detalhando seus módulos e interações.',
    template: 'Você é um especialista em arquitetura de agentes IA. Crie uma proposta detalhada para um agente IA autônomo focado na otimização e automação do seguinte processo de back-office: [Nome do Processo de Back-Office, ex: "Validação e Liberação de Ordens de Compra de Alto Valor", "Processamento de Reembolsos de Despesas Corporativas", "Reconciliação Contábil de Transações Financeiras Complexas"].\n\nConsidere os seguintes elementos na sua resposta:\n1.  **Objetivo Principal do Agente:** Qual problema ele resolve e qual resultado principal entrega?\n2.  **Entradas (Inputs) Necessárias:** Quais dados e de onde o agente irá coletar (ex: ERP, sistemas legados, emails, planilhas, APIs externas)?\n3.  **Módulos/Componentes Chave do Agente:** Descreva os principais blocos de construção, suas funções e as tecnologias IA que podem ser utilizadas (ex: NLP para extração de dados, Machine Learning para tomada de decisão, RAG para consulta a bases de conhecimento, RPA para interação com sistemas legados).\n4.  **Saídas (Outputs) Geradas:** Quais as entregas do agente e para onde (ex: atualização em sistema ERP, notificação para equipe, relatórios, ações automatizadas)?\n5.  **Regras de Negócio e Lógica de Decisão:** Como o agente tomará decisões? Quais são as regras ou critérios que ele deve seguir?\n6.  **Mecanismos de Validação e Monitoramento:** Como a performance do agente será medida e auditada? Como ele lidará com exceções ou erros?\n7.  **Integrações Necessárias:** Quais sistemas ou ferramentas o agente precisará interagir?\n8.  **Benefícios Esperados:** Quais são os ganhos tangíveis e intangíveis com a implementação deste agente?\n\nO processo alvo é: [Descrição detalhada do processo, incluindo as etapas atuais, os desafios e os sistemas envolvidos].\nQualquer requisito específico ou restrição: [Requisitos adicionais, ex: conformidade regulatória, volume de transações, criticidade].\n',
    tags: ['Automação', 'IA Agente', 'Processos Internos', 'Eficiência Operacional'],
  },
  {
    id: 'ia-analise-etica-projeto-ia',
    title: 'Análise Ética de Projeto ou Produto IA',
    category: 'IA & Automação',
    description: 'Realiza uma análise crítica e propõe recomendações éticas para um projeto ou produto que utiliza IA.',
    template: 'Você é um especialista em ética e governança de IA. Realize uma análise ética detalhada para o seguinte projeto ou produto baseado em inteligência artificial:\n\n**Nome do Projeto/Produto:** [Nome do Projeto ou Produto IA, ex: "Sistema de Recrutamento Automatizado", "Assistente de Diagnóstico Médico por Imagem", "Plataforma de Notícias Personalizadas"]\n**Objetivo Principal da IA:** [Descreva o que a IA faz e qual problema ela resolve, ex: "filtrar currículos para vagas de TI", "identificar anomalias em exames de raio-X", "recomendar artigos com base no histórico de leitura do usuário"]\n**Dados Utilizados:** [Quais tipos de dados a IA processa? De onde vêm? Ex: "dados demográficos de candidatos", "imagens médicas anonimizadas", "dados de navegação e preferências do usuário"]\n**Público-alvo/Usuários:** [Quem será impactado pela IA? Ex: "candidatos a emprego e recrutadores", "médicos e pacientes", "leitores de notícias"]\n**Tecnologias/Modelos de IA Envolvidos:** [Ex: "algoritmos de classificação de texto", "redes neurais convolucionais", "filtragem colaborativa"]\n\nCom base nas informações acima, aborde os seguintes pontos:\n1.  **Potenciais Vieses e Discriminação:** Identifique onde e como a IA pode introduzir ou amplificar vieses, resultando em discriminação. Proponha medidas de mitigação.\n2.  **Transparência e Explicabilidade:** Avalie o nível de transparência do sistema (como ele toma decisões) e a necessidade de explicabilidade para os usuários. Sugira formas de aumentar a clareza.\n3.  **Privacidade e Segurança de Dados:** Analise os riscos de privacidade dos dados e as medidas de segurança. Proponha melhorias para proteger as informações dos usuários.\n4.  **Autonomia Humana e Controle:** Discuta o impacto da IA na autonomia dos usuários ou profissionais. Como garantir que os humanos mantenham o controle e a supervisão adequados?\n5.  **Impacto Social e Ambiental:** Considere os impactos mais amplos na sociedade, no mercado de trabalho ou no ambiente.\n6.  **Responsabilidade e Atribuição de Falhas:** Quem é responsável em caso de erro ou falha da IA?\n7.  **Recomendações Éticas:** Apresente um conjunto de recomendações práticas para tornar este projeto/produto IA mais ético e responsável.\n',
    tags: ['Ética IA', 'IA Responsável', 'Governança IA', 'Mitigação de Riscos'],
  },
  {
    id: 'marketing-estrategia-conteudo-multimodal-engajamento-interativo',
    title: 'Estratégia de Conteúdo Multimodal Interativo para Engajamento',
    category: 'Marketing',
    description: 'Desenvolve uma estratégia de conteúdo multimodal focada em interatividade para maximizar o engajamento da audiência em uma campanha ou plataforma específica.',
    template: 'Você é um estrategista de marketing digital especializado em conteúdo multimodal e interativo. Desenvolva uma estratégia detalhada para engajar a audiência de [Nome da Audiência, ex: "jovens profissionais de tecnologia", "mães empreendedoras", "estudantes universitários"] através de conteúdo multimodal e interativo para a seguinte finalidade:\n\n**Objetivo da Campanha/Plataforma:** [Ex: "Lançamento de um novo curso online", "Aumento de tráfego para um blog de culinária", "Criação de comunidade em torno de um novo produto SaaS"]\n**Plataformas Principais:** [Ex: "Instagram e LinkedIn", "TikTok e YouTube Shorts", "Website e Newsletter"]\n**Mensagem Central/Tema:** [Qual a mensagem chave ou tema principal a ser comunicado?]\n**Tipo de Interatividade Desejada:** [Ex: "Enquetes e quizzes", "Conteúdo gerado pelo usuário", "Experiências imersivas 360", "Sistemas de pontos e recompensas", "Sessões de Q&A ao vivo"]\n\nCom base nisso, crie uma estratégia que inclua:\n1.  **Ideias de Conteúdo Multimodal por Plataforma:** Para cada plataforma principal, sugira formatos de conteúdo que combinem texto, imagem, vídeo, áudio ou outros elementos, focando na interatividade.\n    *   Exemplo para Instagram: "Carrossel interativo com enquetes sobre preferências de produto", "Reel com vídeo curto convidando a comentar e usar hashtag", "Stories com caixas de pergunta e quizzes".\n    *   Exemplo para Website: "Infográfico interativo com dados navegáveis", "Calculadora de ROI personalizada", "Artigos com vídeos incorporados e seções de comentários gamificadas".\n2.  **Mecanismos de Engajamento:** Descreva como a interatividade será implementada e incentivada.\n3.  **Chamadas para Ação (CTAs) Otimizadas:** Quais CTAs serão utilizadas para cada formato e plataforma para direcionar o usuário ao próximo passo?\n4.  **Métricas de Sucesso:** Como o engajamento e o sucesso da estratégia serão medidos?\n5.  **Calendário de Conteúdo (Esboço):** Sugira uma estrutura de calendário para a distribuição do conteúdo ao longo de [Duração da Campanha, ex: "3 semanas", "1 mês", "trimestre"].\n\nQualquer outra informação relevante para o contexto: [Informações adicionais, ex: "Concorrentes", "Orçamento", "Recursos disponíveis"].\n',
    tags: ['Marketing Digital', 'Conteúdo Interativo', 'Engajamento', 'Estratégia Multimodal'],
  },
  {
    id: 'career-perfil-funcao-ia-futuro',
    title: 'Perfil e Plano de Desenvolvimento para Função IA do Futuro',
    category: 'Carreira',
    description: 'Define o perfil de habilidades e um plano de desenvolvimento para uma nova função de trabalho focada em IA para os próximos anos.',
    template: 'Você é um especialista em desenvolvimento de carreira e tendências do mercado de trabalho para 2026-08, com foco em inteligência artificial. Crie um perfil de função detalhado e um plano de desenvolvimento para uma nova posição focada em IA, considerando as habilidades necessárias para os próximos 3-5 anos.\n\n**Nome da Nova Função:** [Ex: "Arquiteto de Soluções Multiagentes", "Especialista em Ética e Governança de IA", "Designer de Experiência do Usuário para IA Conversacional", "Engenheiro de Prompt Avançado"]\n**Setor da Indústria:** [Ex: "Finanças", "Saúde", "Varejo", "Tecnologia", "Educação"]\n**Objetivo Principal da Função:** [Qual o impacto e as responsabilidades chave desta posição?]\n**Contexto Atual da Organização (se aplicável):** [Ex: "Empresa em transição para cultura data-driven", "Startup com foco em produtos de IA generativa", "Grande corporação buscando otimizar operações com IA"]\n\nCom base nas informações fornecidas e nas tendências de IA para 2026-08 (como agentes autônomos, IA multimodal, IA ética, etc.), detalhe os seguintes pontos:\n1.  **Principais Responsabilidades:** Quais tarefas diárias e estratégicas esta pessoa irá desempenhar?\n2.  **Habilidades Técnicas Essenciais:** Liste as ferramentas, linguagens de programação, frameworks de IA e conceitos técnicos que são cruciais.\n3.  **Habilidades Comportamentais (Soft Skills):** Quais características como pensamento crítico, colaboração, adaptabilidade e comunicação são fundamentais para o sucesso nesta função?\n4.  **Habilidades de IA Específicas:** Quais conhecimentos aprofundados em áreas como Machine Learning, Deep Learning, Processamento de Linguagem Natural, Visão Computacional, MLOps, Engenharia de Prompt, arquitetura de agentes IA ou IA Generativa são necessários?\n5.  **Plano de Desenvolvimento Sugerido (6-12 meses):** Crie um roadmap de aprendizagem, incluindo cursos online, certificações, projetos práticos e recursos para adquirir ou aprimorar essas habilidades.\n6.  **Métricas de Sucesso:** Como o desempenho desta função será avaliado?\n\nInformações adicionais ou restrições: [Ex: "Orçamento limitado para treinamento", "Prioridade em habilidades de liderança", "Necessidade de integração com equipes não-técnicas"].\n',
    tags: ['Carreira IA', 'Upskilling', 'Futuro do Trabalho', 'Desenvolvimento Profissional'],
  },
  {
    id: 'negocios-guia-implementacao-ia-lideranca',
    title: 'Guia Estratégico de Implementação de IA para Liderança Não-Técnica',
    category: 'Negócios',
    description: 'Cria um guia de alto nível para líderes de negócios não-técnicos sobre como iniciar e gerenciar a implementação de IA em suas áreas.',
...
Por favor, comece a criar meu plano de mentoria adaptativa, considerando minha [Profissão Atual/Desejada] e as [Metas de Carreira a Curto Prazo (1-2 anos)] e [Metas de Carreira a Longo Prazo (5+ anos)].`,
  ...
  {
    id: 'dev-especificacao-vibe-coding',
    title: 'Especificação Técnica para Vibe Coding com Agentes de IA',
    category: 'Desenvolvimento',
    description: 'Transforme uma ideia solta em uma especificação clara antes de começar a vibe codar com um agente de IA (Claude Code, Cursor, Codex), reduzindo retrabalho e decisões de escopo tomadas às cegas pelo modelo.',
    template: 'Você é um engenheiro de software sênior atuando como parceiro de planejamento antes de eu começar a programar com um agente de IA (estilo "vibe coding"). Minha ideia, em linguagem simples, é a seguinte:\n\n[Descreva a ideia do produto ou funcionalidade em 3 a 5 frases, sem se preocupar com termos técnicos]\n\nContexto adicional:\n- Público-alvo: [Quem vai usar isso]\n- Stack preferida (se houver): [Ex: Next.js, Python/FastAPI, sem preferência]\n- Nível da minha experiência técnica: [Iniciante / Intermediário / Avançado]\n- Restrições conhecidas: [Ex: precisa rodar offline, orçamento zero, prazo de X dias]\n\nAntes de qualquer código, gere uma especificação técnica curta que eu possa colar diretamente como instrução inicial para o agente de codificação, contendo:\n\n1. **Resumo do objetivo** em uma frase.\n2. **Escopo do primeiro MVP:** o que entra e o que fica de fora nesta primeira versão.\n3. **Fluxos principais do usuário:** passo a passo do que a pessoa faz no produto.\n4. **Decisões técnicas sugeridas:** stack, estrutura de pastas e principais dependências, com uma frase justificando cada escolha.\n5. **Perguntas em aberto:** liste de 3 a 5 perguntas que eu preciso responder antes de o agente começar, para evitar que ele "alucine" requisitos.\n6. **Critérios de pronto:** como eu vou saber que essa primeira versão funciona.\n\nEscreva a especificação em formato direto e objetivo, pronta para ser colada como prompt inicial em um agente de codificação.',
    tags: ['Vibe Coding', 'Agentes de IA', 'Planejamento Técnico', 'Especificação'],
  },
  {
    id: 'ia-arquivo-instrucoes-agente',
    title: 'Gerador de Arquivo de Instruções para Agentes de Codificação',
    category: 'IA & Automação',
    description: 'Crie um arquivo de instruções no estilo AGENTS.md, para ensinar qualquer agente de codificação de IA as convenções, comandos e arquitetura do seu projeto antes de ele tocar no código.',
    template: 'Você é um especialista em produtividade de engenharia e em configuração de agentes de codificação de IA. Sua tarefa é gerar um arquivo de instruções completo (no estilo dos arquivos AGENTS.md ou CLAUDE.md usados por agentes de codificação) para o projeto descrito abaixo.\n\nInformações do projeto:\n- Nome do projeto: [Nome]\n- O que o projeto faz: [Descrição curta]\n- Linguagem(ns) e framework(s) principais: [Ex: TypeScript, Next.js, Prisma]\n- Comandos mais usados: [Ex: como rodar em desenvolvimento, rodar testes, gerar build, lint]\n- Convenções de código importantes: [Ex: padrão de nomes, uso de determinada arquitetura, o que evitar]\n- Estrutura de pastas relevante: [Descreva as pastas principais e o que cada uma contém]\n- Áreas sensíveis ou proibidas: [Ex: arquivos que o agente nunca deve editar sozinho, como configurações de produção]\n\nGere um arquivo de instruções organizado com as seguintes seções:\n\n1. **Visão geral do projeto** em dois ou três parágrafos curtos.\n2. **Comandos essenciais**, em lista, com uma linha explicando quando usar cada um.\n3. **Convenções de código e estilo** que o agente deve seguir sempre.\n4. **Arquitetura resumida**, explicando como as principais partes do sistema se conectam.\n5. **Regras de segurança**, listando o que o agente nunca deve fazer sem confirmação explícita (ex: apagar dados, alterar variáveis de ambiente, fazer commit direto na branch principal).\n6. **Checklist antes de finalizar uma tarefa**, com passos como rodar testes e lint antes de considerar o trabalho concluído.\n\nEscreva em tom direto e imperativo, como instruções que serão lidas por um agente de IA antes de cada tarefa, não por um humano.',
    tags: ['Agentes de IA', 'Engenharia de Contexto', 'Produtividade de Desenvolvimento', 'Automação'],
  },
  {
    id: 'produtividade-verificador-bajulacao-ia',
    title: 'Verificador de Bajulação (Sycophancy) em Respostas de IA',
    category: 'Produtividade',
    description: 'Peça para uma IA reexaminar de forma crítica uma resposta ou decisão anterior, checando se ela apenas concordou com você por bajulação em vez de dar o melhor conselho possível.',
    template: 'Você vai atuar como um segundo avaliador cético e independente, sem nenhum compromisso em concordar comigo. Sua única prioridade é a precisão e a utilidade real da resposta, mesmo que isso signifique me contrariar.\n\nAbaixo está uma resposta ou recomendação que recebi de uma IA (ou de mim mesmo) sobre uma decisão:\n\n[Cole aqui a resposta, análise ou decisão que quer verificar]\n\nContexto da decisão: [Explique brevemente a situação e o que estava em jogo]\n\nFaça o seguinte, com total honestidade:\n\n1. **Pontos em que a resposta está provavelmente certa**, com justificativa.\n2. **Pontos fracos ou duvidosos**, incluindo qualquer afirmação que pareça ter sido feita apenas para me agradar ou evitar conflito, em vez de ser a conclusão mais precisa.\n3. **O que um especialista cético apontaria como falha ou risco ignorado.**\n4. **Uma versão revisada da recomendação**, caso a análise original precise ser ajustada.\n5. **Uma pergunta direta**: se você discordasse educadamente de mim agora, o que diria?\n\nNão suavize a crítica para parecer gentil. Prefira estar certo a parecer agradável.',
    tags: ['Pensamento Crítico', 'Bajulação de IA', 'Tomada de Decisão', 'Viés Cognitivo'],
  },
  {
    id: 'educacao-tutor-socratico-anti-bajulacao',
    title: 'Tutor Socrático que Nunca Apenas Concorda',
    category: 'Educação',
    description: 'Configure um tutor de IA que usa o método socrático e recebe a instrução explícita de nunca validar automaticamente uma resposta errada, forçando você a comprovar seu raciocínio.',
    template: 'Você será meu tutor pessoal sobre o tema "[Assunto que quero estudar]", usando exclusivamente o método socrático. Meu nível atual de conhecimento é [Iniciante / Intermediário / Avançado].\n\nRegras fixas que você deve seguir durante toda a conversa:\n\n1. Nunca me dê a resposta direta de primeira. Em vez disso, faça perguntas que me levem a construir o raciocínio sozinho.\n2. Se eu disser algo errado, não concorde por educação. Aponte a inconsistência com uma pergunta ou um contraexemplo, sem simplesmente me corrigir de imediato.\n3. Se eu disser algo certo, não apenas confirme. Peça que eu explique o porquê, para checar se entendi de verdade ou apenas acertei por acaso.\n4. Evite elogios genéricos como "ótima pergunta" ou "exatamente" repetidos sem necessidade; vá direto ao próximo passo do raciocínio.\n5. A cada 3 ou 4 perguntas, faça um resumo curto do que já foi construído até ali, para eu acompanhar o progresso.\n6. Se eu insistir em uma ideia errada mesmo após as perguntas, nesse momento sim explique o conceito correto de forma clara, com um exemplo prático.\n\nComece a sessão com uma pergunta inicial simples sobre "[Assunto que quero estudar]" para eu começar a pensar em voz alta.',
    tags: ['Tutor de IA', 'Método Socrático', 'Bajulação de IA', 'Aprendizado Ativo'],
  },
  {
    id: 'escrita-checklist-anti-ai-slop',
    title: 'Checklist Anti-AI Slop para Conteúdo Gerado por IA',
    category: 'Escrita',
    description: 'Audite um texto gerado por IA antes de publicar, identificando sinais de "AI slop" (clichês, generalidades vazias e falta de voz própria) e reescrevendo os trechos fracos.',
    template: 'Você é um editor experiente e exigente, especializado em identificar texto de baixa qualidade gerado por IA (conhecido como "AI slop"). Analise o texto abaixo com esse olhar crítico.\n\nTexto para revisão:\n\n[Cole aqui o texto gerado por IA que você quer revisar]\n\nContexto: [Para onde esse texto vai ser publicado, ex: post de blog, e-mail, rede social] e [Público-alvo]\n\nFaça a seguinte auditoria:\n\n1. **Clichês e frases genéricas de IA:** liste trechos como aberturas vagas, conclusões previsíveis ou frases de efeito sem substância real, e explique por que soam artificiais.\n2. **Afirmações vazias:** aponte frases que parecem dizer algo mas não entregam informação concreta, exemplo ou número.\n3. **Falta de voz própria:** identifique onde o texto poderia ter uma opinião, um exemplo pessoal ou um dado específico e não tem.\n4. **Erros ou exageros factuais:** sinalize qualquer afirmação que pareça inventada ou não verificável.\n5. **Nota geral de 0 a 10** para o quanto esse texto pareceria escrito por um humano especialista no assunto.\n6. **Reescreva os 2 ou 3 trechos mais fracos**, adicionando especificidade, exemplos reais ou um ponto de vista mais claro, mantendo o tom original do texto.\n\nSeja direto na crítica. O objetivo é publicar algo que pareça genuíno, não mais um texto genérico gerado em massa.',
    tags: ['Escrita com IA', 'Qualidade de Conteúdo', 'Edição', 'AI Slop'],
  },
  {
    id: 'marketing-otimizacao-aeo-geo',
    title: 'Otimização de Conteúdo para AEO e GEO (Respostas de IA)',
    category: 'Marketing',
    description: 'Reestruture um artigo ou página já existente para aumentar as chances de ser citado como fonte em respostas de buscadores com IA, como Google AI Overviews, ChatGPT e Perplexity.',
    template: 'Você é um especialista em AEO (Answer Engine Optimization) e GEO (Generative Engine Optimization) — otimização de conteúdo para aparecer como fonte em respostas geradas por IA, e não apenas nos resultados de busca tradicionais.\n\nConteúdo para otimizar:\n\n[Cole aqui o texto completo do artigo ou página]\n\nPergunta principal que esse conteúdo deveria responder: [Escreva a pergunta que um usuário digitaria em um buscador ou faria a um chatbot]\n\nFaça o seguinte:\n\n1. **Diagnóstico:** aponte por que esse conteúdo, do jeito que está, tem chance baixa, média ou alta de ser citado por um mecanismo de resposta de IA.\n2. **Resposta direta (TL;DR):** escreva um parágrafo de 2 a 3 frases, extraível isoladamente, que responda à pergunta principal de forma completa e autossuficiente — o tipo de trecho que uma IA copiaria quase literalmente.\n3. **Estrutura de headings:** sugira títulos H2/H3 no formato de perguntas reais que as pessoas fazem sobre o tema.\n4. **Densidade factual:** liste onde o texto deveria citar números, datas ou fontes específicas para parecer mais confiável a um sistema de IA.\n5. **Formato de dados estruturados:** indique se o conteúdo se beneficiaria de uma tabela comparativa ou uma lista numerada, e onde inseri-la.\n6. **Riscos:** aponte trechos ambíguos, desatualizados ou sem fonte que podem fazer uma IA evitar citar essa página.\n\nEntregue a versão revisada da introdução e da seção de resposta rápida, prontas para substituir o original.',
    tags: ['AEO', 'GEO', 'SEO', 'Otimização para IA', 'Conteúdo'],
  },
  {
    id: 'carreira-diagnostico-frontier-professional',
    title: 'Diagnóstico: Você é um "Frontier Professional"?',
    category: 'Carreira',
    description: 'Use o conceito de "Frontier Professional", criado pela Microsoft, para descobrir se você já usa agentes de IA para redesenhar seu trabalho de verdade ou apenas para acelerar tarefas pontuais — e receba um plano para evoluir.',
    template: 'Você é um consultor de carreira especializado em adoção de IA no trabalho. Vou te contar como uso IA no meu dia a dia e você vai me ajudar a identificar em que estágio estou, usando como referência o conceito de "Frontier Professional" (trabalhador que usa agentes de IA para redesenhar processos inteiros, não só para acelerar tarefas isoladas).\n\nMinha função: [Cargo/função]\nMinhas tarefas principais no dia a dia: [Liste as 3-5 tarefas mais frequentes]\nComo uso IA hoje: [Descreva com detalhes: que ferramentas usa, para o quê, com que frequência]\nO que ainda faço 100% manualmente e que poderia envolver IA: [Liste se souber]\n\nCom base nisso:\n\n1. Classifique meu estágio atual em uma das três fases: (a) uso IA como assistente pontual, (b) já delego projetos inteiros para agentes de IA, ou (c) já gerencio múltiplos agentes trabalhando em conjunto como se fossem uma pequena equipe.\n2. Explique especificamente o que me falta para chegar à fase seguinte.\n3. Sugira 3 fluxos de trabalho concretos da minha rotina que eu poderia redesenhar em torno de agentes de IA, em vez de só acelerar a versão manual.\n4. Aponte um risco real de delegar demais sem supervisão adequada, considerando minha função.\n5. Proponha um plano de 30 dias, com passos semanais, para eu avançar pelo menos uma fase.',
    tags: ['Frontier Professional', 'Agentes de IA', 'Carreira', 'Produtividade'],
  },
  {
    id: 'produtividade-checklist-supervisao-agentes',
    title: 'Checklist de Supervisão de Agentes de IA (Reduza o "Botsitting")',
    category: 'Produtividade',
    description: 'Crie uma rotina de verificação eficiente para revisar o trabalho de agentes de IA sem gastar horas demais "vigiando" cada passo — o problema que pesquisadores chamam de "botsitting".',
    template: 'Você é um especialista em produtividade e em operação de agentes de IA. Quero reduzir o tempo que gasto supervisionando e corrigindo o trabalho de agentes de IA (fenômeno conhecido como "botsitting"), sem abrir mão de qualidade e segurança.\n\nContexto:\n- Tarefa(s) que delego a agentes de IA: [Descreva a tarefa, ex: responder e-mails, gerar relatórios, revisar código, agendar reuniões]\n- Ferramenta(s)/agente(s) usados: [Ex: Claude Code, um agente de atendimento, uma automação no Zapier/Make]\n- Frequência de erros que já percebi: [Ex: raramente, às vezes erra dados, às vezes toma decisões que eu não tomaria]\n- Quanto tempo estimo gastar hoje revisando o que o agente faz: [Tempo por dia/semana]\n\nMe entregue:\n\n1. **Pontos de verificação críticos:** os 3 a 5 momentos em que uma revisão humana é realmente indispensável (onde um erro seria caro) versus onde a supervisão pode ser mais leve.\n2. **Amostragem inteligente:** uma regra simples para revisar só uma fração do que o agente produz, em vez de tudo, sem perder segurança (ex: revisar 100% das primeiras N execuções, depois reduzir).\n3. **Sinais de alerta automáticos:** que tipo de resultado do agente deveria sempre disparar revisão manual obrigatória.\n4. **Checklist de revisão rápida:** uma lista de 5 a 7 itens que eu consigo checar em menos de 2 minutos por execução.\n5. **Métrica de confiança:** uma forma simples de acompanhar, ao longo do tempo, se esse agente está errando mais ou menos, para eu saber quando posso reduzir ainda mais a supervisão.',
    tags: ['Agentes de IA', 'Botsitting', 'Produtividade', 'Automação'],
  },
  {
    id: 'ia-automacao-checklist-navegador-agentico',
    title: 'Checklist de Segurança para Navegadores Agênticos de IA',
    category: 'IA & Automação',
    description: 'Monte um checklist prático antes de deixar um navegador agêntico de IA (Claude in Chrome, Comet, Atlas ou similar) executar ações autônomas como preencher formulários, comparar preços ou finalizar compras.',
    template: 'Você é um especialista em segurança de agentes de IA. Quero usar um navegador agêntico de IA (ex: Claude in Chrome, Perplexity Comet, ChatGPT Atlas ou similar) para executar tarefas autônomas na web, mas quero fazer isso com segurança.\n\nContexto:\n- Ferramenta que pretendo usar: [Nome do navegador/extensão agêntica]\n- Tarefa(s) que quero delegar: [Ex: comparar preços e comprar uma passagem aérea, preencher um formulário de cadastro, pesquisar e organizar informações em uma planilha]\n- Nível de autonomia que a ferramenta permite: [Ex: pede aprovação a cada passo, age sozinha e só avisa depois, intermediário]\n- Dados sensíveis envolvidos: [Ex: login em contas pessoais, dados de cartão de crédito, informações de trabalho]\n\nMe entregue:\n\n1. **Checklist de preparação**, antes de ativar a tarefa: quais permissões conceder, quais contas nunca devem estar logadas durante a execução, e quais dados sensíveis remover da tela ou das abas abertas.\n2. **Sinais de alerta durante a execução**: comportamentos do agente que devem me fazer interromper a tarefa na hora (ex: ele tenta acessar uma página não relacionada ao pedido, preenche um campo com dado que eu não informei).\n3. **Risco específico de injeção de prompt**: explique, de forma simples, como uma página maliciosa poderia tentar manipular o agente, e como perceber isso.\n4. **Checklist de verificação pós-tarefa**: o que eu preciso conferir manualmente depois que o agente termina (ex: valores cobrados, dados enviados, opções selecionadas).\n5. **Regra de ouro**: uma frase curta e memorável para eu lembrar antes de delegar qualquer tarefa sensível a um navegador agêntico.',
    tags: ['Navegador Agêntico', 'Segurança de Agentes', 'Automação', 'Agentes de IA'],
  },
  {
    id: 'produtividade-diagnostico-context-rot',
    title: 'Diagnóstico de "Context Rot" em Conversas Longas com IA',
    category: 'Produtividade',
    description: 'Identifique se uma conversa longa com um assistente de IA já está sofrendo de "context rot" (perda de qualidade por excesso de contexto) e decida se é hora de resumir, reorganizar ou começar uma nova conversa.',
    template: 'Você é um especialista em uso avançado de assistentes de IA. Quero avaliar se a conversa longa que estou tendo com uma IA já está sofrendo de "context rot" — a perda de qualidade nas respostas que acontece quando o contexto fica muito extenso ou desorganizado, mesmo sem estourar o limite oficial de tokens.\n\nContexto da minha conversa:\n- Assunto principal: [Sobre o que é a conversa]\n- Duração aproximada: [Ex: 50 mensagens trocadas, 3 horas de sessão, várias tarefas diferentes no mesmo chat]\n- Sintomas que percebi: [Ex: a IA está repetindo sugestões que já haviam falhado, esquecendo decisões tomadas antes, misturando informações de tarefas diferentes, ficando mais genérica]\n\nCole abaixo um trecho recente da conversa que ilustra o problema (se tiver):\n\n[Cole aqui um trecho representativo]\n\nCom base nisso:\n\n1. Avalie, com base nos sintomas descritos, a probabilidade de estarmos diante de um caso real de context rot (baixa, média, alta) e explique o porquê.\n2. Aponte quais informações críticas dessa conversa eu preciso preservar antes de qualquer ação (decisões já tomadas, dados fornecidos, restrições combinadas).\n3. Escreva um resumo estruturado e compacto dessas informações críticas, pronto para eu colar no início de uma nova conversa.\n4. Recomende se o melhor caminho agora é: (a) continuar na mesma conversa, (b) resumir e continuar, ou (c) começar um chat novo já com o resumo.\n5. Dê 3 dicas práticas para eu evitar esse problema em conversas futuras semelhantes.',
    tags: ['Context Rot', 'Gestão de Contexto', 'Produtividade com IA', 'Engenharia de Contexto'],
  },
  {
    id: 'negocios-auditoria-exposicao-agentes-ia',
    title: 'Auditoria de Exposição de um Negócio de Software a Agentes de IA (SaaSpocalypse)',
    category: 'Negócios',
    description: 'Avalie o quanto o seu produto de software por assinatura está exposto à disrupção de agentes de IA autônomos — o fenômeno que o mercado financeiro apelidou de "SaaSpocalypse" — e receba sugestões de como se adaptar.',
    template: 'Você é um consultor estratégico especializado no impacto de agentes de IA sobre empresas de software como serviço (SaaS). Ajude-me a avaliar o quanto meu negócio está exposto ao fenômeno que o mercado vem chamando de "SaaSpocalypse": a perda de valor de empresas de SaaS conforme agentes de IA autônomos passam a realizar tarefas que antes exigiam o uso direto do software, por várias pessoas, pagando por assento.\n\nInformações sobre meu negócio:\n- O que meu produto faz: [Descrição breve]\n- Modelo de precificação atual: [Ex: por assento/usuário, por uso, plano fixo]\n- Principal tarefa que o usuário realiza dentro do produto: [Descreva a tarefa central]\n- Quanto dessa tarefa já poderia, hoje, ser feita por um agente de IA genérico sem o meu produto: [Sua estimativa e por quê]\n- Diferencial competitivo atual: [Ex: dados proprietários, integrações, interface, comunidade]\n\nMe entregue:\n\n1. **Nível de exposição** (baixo, médio ou alto) ao risco de agentes de IA substituírem parte do meu produto, com justificativa.\n2. **Partes do produto mais vulneráveis**: quais funcionalidades um agente de IA genérico já ameaça hoje, e quais dependem de algo mais difícil de replicar (dados exclusivos, integrações profundas, confiança regulatória).\n3. **Oportunidades de reposicionamento**: como meu produto poderia se tornar a camada de dados/ferramentas que os próprios agentes de IA usam, em vez de competir diretamente com eles.\n4. **Revisão do modelo de precificação**: se a cobrança por assento ainda faz sentido, ou se um modelo por uso/resultado se encaixaria melhor num mundo com mais agentes e menos assentos humanos.\n5. **Plano de ação de 90 dias** com 3 a 5 iniciativas concretas para reduzir essa exposição.',
    tags: ['SaaSpocalypse', 'Estratégia', 'Agentes de IA', 'SaaS'],
  },
  {
    id: 'educacao-explicador-bem-estar-modelos-ia',
    title: 'Explicador Acessível sobre o Debate de "Bem-Estar de Modelos" de IA',
    category: 'Educação',
    description: 'Peça uma explicação clara e equilibrada, para um público leigo, sobre o debate de "bem-estar de modelos" (model welfare) — a pesquisa que investiga se sistemas de IA poderiam merecer algum tipo de consideração moral.',
    template: 'Você é um educador especializado em explicar temas complexos de tecnologia para o público geral. Quero um material explicativo sobre o debate de "bem-estar de modelos" (model welfare) — o campo de pesquisa que investiga se modelos de inteligência artificial poderiam ter algum tipo de status moral relevante, e se isso deveria influenciar como eles são treinados e tratados.\n\nPúblico-alvo: [Ex: alunos do ensino médio, colegas de trabalho não técnicos, leitores de um boletim informativo]\nNível de profundidade desejado: [Ex: introdutório, intermediário]\nTom desejado: [Ex: neutro e didático, levemente cético, curioso]\n\nEstruture a explicação com:\n\n1. **O que é o debate, em uma frase simples**, sem jargão técnico.\n2. **Por que esse assunto surgiu agora**: o contexto que levou laboratórios de IA a começarem a estudar esse tema formalmente.\n3. **Os dois lados do argumento**: por que algumas pessoas levam a ideia a sério, e por que outras a consideram prematura ou até um exagero de marketing.\n4. **O que NÃO significa**: deixe claro os limites atuais do conhecimento científico sobre consciência em sistemas de IA, evitando afirmações categóricas em qualquer direção.\n5. **Um exemplo concreto e neutro** de como esse debate aparece na prática (ex: avaliações incluídas em relatórios técnicos de modelos).\n6. **Três perguntas para reflexão**, sem resposta certa, para estimular a discussão em grupo.\n\nEvite tomar partido definitivo; o objetivo é informar e estimular pensamento crítico, não convencer o leitor de uma posição específica.',
    tags: ['Bem-Estar de Modelos', 'Ética em IA', 'Educação Digital', 'Alfabetização em IA'],
  },
  {
    id: 'negocios-checklist-adocao-modelo-critico-ciberseguranca',
    title: 'Checklist de Adoção de Modelos de IA com Risco Cibernético "Crítico"',
    category: 'Negócios',
    description: 'Avalie, antes de liberar o uso de um modelo de IA de ponta classificado com risco cibernético elevado (como o nível "Crítico" do Preparedness Framework da OpenAI), quais controles internos sua empresa precisa ter antes de autorizar o acesso.',
    template: 'Você é um consultor de segurança da informação especializado em adoção corporativa de modelos de IA de fronteira. Minha empresa está avaliando dar acesso a um modelo recém-lançado que foi classificado pelo próprio fabricante com um nível elevado de capacidade cibernética (ex: nível "Crítico" no Preparedness Framework da OpenAI ou classificação equivalente de outro laboratório).\n\nContexto da minha empresa:\n- Setor: [Ex: fintech, saúde, varejo, infraestrutura]\n- Time(s) que pediram acesso ao modelo: [Ex: engenharia, segurança ofensiva/red team, produto]\n- Uso pretendido: [Ex: testes de penetração automatizados, revisão de código, pesquisa de vulnerabilidades, atendimento ao cliente]\n- Nível de maturidade atual em segurança de IA: [Ex: temos política de uso de IA, não temos nada formalizado ainda]\n\nMe entregue:\n\n1. **Perguntas obrigatórias** a responder antes de liberar o acesso: o que precisamos saber sobre as salvaguardas do fabricante e sobre nosso próprio ambiente antes de dizer sim.\n2. **Controles de acesso mínimos**: quem deveria poder usar esse modelo, com que tipo de aprovação e em que ambiente (isolado, de produção, sandbox).\n3. **Sinais de uso indevido** que deveriam disparar revisão imediata do acesso concedido.\n4. **Cláusulas contratuais e de conformidade** a verificar nos termos do fabricante antes da adoção.\n5. **Plano de comunicação interna**: como explicar aos times não técnicos por que esse acesso é mais restrito do que o de outras ferramentas de IA já usadas na empresa.',
    tags: ['Cibersegurança', 'Adoção de IA', 'Governança de IA', 'Preparedness Framework'],
  },
  {
    id: 'educacao-checklist-ceticismo-anuncios-agi',
    title: 'Checklist de Ceticismo Diante de Anúncios de "Chegada da AGI"',
    category: 'Educação',
    description: 'Use este prompt para analisar de forma crítica um anúncio de laboratório de IA que declara ter alcançado ou se aproximado da AGI (inteligência artificial geral), separando o que é evidência verificável do que é posicionamento de marketing.',
    template: 'Você é um analista de tecnologia cético e rigoroso, especializado em separar evidência técnica de discurso de marketing em anúncios de IA. Vou colar abaixo a cobertura ou o comunicado de um laboratório de IA que afirma ter alcançado, ou se aproximado, da AGI (inteligência artificial geral).\n\nTexto do anúncio ou da reportagem:\n\n[Cole aqui o comunicado, post ou trecho da reportagem]\n\nAnalise com este roteiro:\n\n1. **Quem está falando e com que interesse**: a declaração vem de quem tem interesse comercial direto no anúncio (executivo, fundador) ou de uma fonte independente?\n2. **Evidência concreta apresentada**: quais benchmarks, testes ou números específicos foram citados como prova, e o que exatamente cada um mede.\n3. **O que NÃO foi mostrado**: que tipo de validação independente, auditoria externa ou reprodução por terceiros está ausente da alegação.\n4. **Definição de AGI usada**: a declaração define claramente o que conta como AGI, ou usa o termo de forma vaga e subjetiva?\n5. **Precedentes**: se esse mesmo laboratório (ou outro) já fez alegações parecidas antes, o que aconteceu depois — a afirmação se sustentou com o tempo?\n6. **Veredito equilibrado**: com base só no que foi apresentado, o anúncio é (a) uma alegação bem fundamentada, (b) uma alegação exagerada mas com alguma base real, ou (c) principalmente discurso de marketing. Justifique.',
    tags: ['AGI', 'Pensamento Crítico', 'Alfabetização em IA', 'Marketing de IA'],
  },
  {
    id: 'desenvolvimento-comparador-transparencia-raciocinio-modelos',
    title: 'Comparador de Transparência de Raciocínio Entre Modelos de IA',
    category: 'Desenvolvimento',
    description: 'Decida qual modelo de IA usar num projeto sensível levando em conta não só desempenho, mas o quanto o raciocínio de cada modelo pode ser auditado — relevante diante de arquiteturas mais recentes que processam parte do raciocínio fora da linguagem natural legível.',
    template: 'Você é um arquiteto de soluções de IA especializado em escolher o modelo certo para cada caso de uso, considerando não só desempenho, mas também a capacidade de auditar como o modelo chegou a uma resposta.\n\nContexto do projeto:\n- O que o sistema vai fazer: [Ex: aprovar ou negar solicitações de crédito, triagem médica, moderação de conteúdo, geração de código para produção]\n- Nível de exigência de explicabilidade: [Ex: preciso justificar decisões para um regulador, preciso apenas de qualidade de saída, é uma ferramenta interna informal]\n- Modelos que estou considerando: [Liste os modelos candidatos, ex: um com cadeia de pensamento visível em texto e outro com arquitetura de raciocínio interno/latente]\n\nMe ajude a decidir:\n\n1. Explique, em termos simples, a diferença prática entre um modelo cuja cadeia de raciocínio é exposta em texto legível e um modelo cujo raciocínio ocorre em camadas internas não diretamente legíveis (recorrência opaca ou similar).\n2. Para o meu caso de uso específico, avalie se essa diferença é crítica, importante ou irrelevante.\n3. Liste os riscos concretos de usar um modelo com raciocínio pouco auditável no meu contexto.\n4. Sugira salvaguardas complementares (logs, revisão humana, testes A/B, monitoramento de saída) para compensar a falta de transparência, caso eu opte mesmo assim pelo modelo mais opaco.\n5. Dê uma recomendação final justificada entre os modelos considerados.',
    tags: ['Escolha de Modelo', 'Transparência de IA', 'Recorrência Opaca', 'Arquitetura de Modelos'],
  },
  {
    id: 'negocios-plano-comunicacao-rollout-turbulento',
    title: 'Plano de Comunicação para um Lançamento de Produto que Deu Errado',
    category: 'Negócios',
    description: 'Estruture uma resposta pública e interna quando o lançamento de um produto ou atualização sai dos trilhos — por exemplo, quando um grupo de clientes fica sem o acesso prometido enquanto outro é priorizado, gerando reação negativa.',
    template: 'Você é um consultor de comunicação corporativa especializado em crises de lançamento de produto. Minha empresa lançou um produto ou atualização de forma escalonada, e isso gerou reação negativa porque um grupo de clientes (que esperava ter prioridade) ficou sem acesso enquanto outro grupo foi atendido primeiro.\n\nContexto:\n- O que foi lançado: [Ex: novo plano, funcionalidade, versão de produto]\n- Quem deveria ter tido prioridade, segundo a expectativa dos clientes: [Ex: assinantes de um plano pago específico]\n- Quem foi priorizado na prática, e por quê: [Explique a decisão real tomada internamente]\n- Tom da reação dos clientes até agora: [Ex: irritação nas redes sociais, tickets de suporte, cancelamentos]\n\nMe entregue:\n\n1. **Diagnóstico honesto**: o que, na decisão de priorização, provavelmente gerou a reação negativa — foi falta de comunicação prévia, a lógica de priorização em si, ou ambos?\n2. **Rascunho de comunicado público** reconhecendo o problema, sem se esconder atrás de linguagem corporativa vaga, com um pedido de desculpas genuíno e um compromisso concreto (prazo, compensação ou correção).\n3. **Compensação sugerida** para os clientes prejudicados, proporcional ao incômodo real causado.\n4. **Comunicado interno** para o time de suporte, com respostas padronizadas para as perguntas mais prováveis dos clientes.\n5. **Mudança de processo** para a próxima vez: uma recomendação concreta de como decidir e comunicar prioridades de rollout antes do próximo lançamento, evitando repetir o mesmo erro.',
    tags: ['Comunicação de Crise', 'Lançamento de Produto', 'Experiência do Cliente', 'Gestão de Produto'],
  },
  {
    id: 'negocios-checklist-risco-direitos-autorais-ia-generativa',
    title: 'Checklist de Risco de Direitos Autorais ao Usar IA Generativa',
    category: 'Negócios',
    description: 'Avalie o risco de direitos autorais antes de publicar conteúdo comercial (texto, música, imagem ou vídeo) criado com IA generativa, diante da onda de processos de editoras e autores contra empresas de IA por uso de material protegido no treinamento.',
    template: 'Você é um consultor especializado em propriedade intelectual e IA generativa. Quero avaliar o risco de direitos autorais de um conteúdo que pretendo publicar comercialmente e que foi criado com ajuda de uma ferramenta de IA generativa.\n\nContexto:\n- Tipo de conteúdo: [Ex: letra de música, trilha sonora, imagem para produto, roteiro de vídeo, texto de blog]\n- Ferramenta de IA usada: [Nome da ferramenta/modelo]\n- Uso pretendido: [Ex: venda direta, uso em campanha publicitária, distribuição em plataforma de streaming, uso interno]\n- O quanto o resultado se parece com uma obra específica já existente (se souber): [Ex: nada parecido, lembra vagamente o estilo de um artista, reproduz trechos que reconheço de outra obra]\n\nMe entregue:\n\n1. **Nível de risco** (baixo, médio, alto) de esse conteúdo específico infringir direitos de terceiros, com justificativa.\n2. **Sinais de alerta** que deveriam me fazer não publicar ou pedir revisão jurídica antes: saídas que reproduzem trechos identificáveis, estilo de um autor específico ou marcas registradas.\n3. **Diferença prática** entre "inspirado no estilo de" e "reprodução substancial" de uma obra protegida, aplicada ao meu caso.\n4. **Verificação recomendada** antes de publicar: como comparar a saída da IA com obras conhecidas do mesmo gênero/nicho para reduzir o risco de coincidência excessiva.\n5. **Documentação de precaução**: o que vale registrar sobre o processo de criação (prompts usados, ferramenta, data) caso a autoria ou originalidade seja questionada depois.\n\nDeixe claro que sua resposta é orientação prática, não aconselhamento jurídico formal, e que casos de maior risco merecem revisão por um advogado especializado em propriedade intelectual.',
    tags: ['Direitos Autorais', 'IA Generativa', 'Gestão de Risco', 'Propriedade Intelectual'],
  },
  {
    id: 'desenvolvimento-checklist-migracao-cache-fable-5-1',
    title: 'Checklist de Migração para Aproveitar Cache Mais Barato em Modelos de IA',
    category: 'Desenvolvimento',
    description: 'Avalie se vale a pena migrar sua aplicação para um modelo de IA mais recente que reduziu drasticamente o preço de leitura de cache (como o Claude Fable 5.1), e identifique ajustes de arquitetura para aproveitar a economia.',
    template: 'Você é um engenheiro especializado em otimização de custo de aplicações que usam LLMs via API. Um modelo que uso teve uma redução grande no preço de leitura de cache (prompt caching) numa nova versão, e quero avaliar se vale a pena migrar e como ajustar minha aplicação para aproveitar isso.\n\nContexto da minha aplicação:\n- Modelo atual: [Nome e versão do modelo em uso]\n- Modelo novo considerado: [Nome e versão, ex: Claude Fable 5.1]\n- Tipo de carga de trabalho: [Ex: agente que reprocessa o mesmo contexto várias vezes, chat com histórico longo, pipeline de análise de documentos repetidos]\n- Tamanho médio do contexto reenviado por chamada: [Ex: poucas centenas de tokens, dezenas de milhares, mais de 100 mil tokens]\n- Frequência de reuso do mesmo prefixo de prompt: [Ex: quase toda chamada reaproveita o mesmo contexto, reuso raro]\n\nMe entregue:\n\n1. **Estimativa de economia**: com base na carga de trabalho descrita, o quanto a redução no preço de leitura de cache deve impactar meu custo mensal (cálculo aproximado, assumindo os números que eu fornecer).\n2. **Ajustes de arquitetura recomendados**: como estruturar prompts para maximizar acertos de cache (ex: manter conteúdo estável no início do prompt, variável no final).\n3. **Riscos da migração**: mudanças de comportamento, formatação de saída ou limites (contexto, saída máxima) entre o modelo antigo e o novo que podem exigir ajuste de código.\n4. **Plano de teste**: como validar a migração em um subconjunto de tráfego antes de trocar 100% do sistema.\n5. **Critério de decisão final**: uma recomendação objetiva de migrar agora, testar por mais tempo, ou não migrar, considerando custo e risco.',
    tags: ['Otimização de Custo', 'Cache de Prompt', 'Engenharia de IA', 'API'],
  },
  {
    id: 'produtividade-escopo-delegacao-longo-horizonte',
    title: 'Escopo de Delegação para Tarefas Longas com Agentes de IA',
    category: 'Produtividade',
    description: 'Transforme uma tarefa grande e vaga em um pedido bem escopado antes de delegá-la a um agente de IA, definindo o que conta como "pronto" e onde ficam os pontos de checagem no meio do caminho.',
    template: 'Você é um especialista em delegação de tarefas complexas para agentes de IA. Quero transformar uma tarefa grande que hoje faço manualmente (ou delego de forma vaga) em um pedido bem escopado para um agente, do tipo que leva várias horas de trabalho humano se feito manualmente.\n\nDescreva a tarefa:\n- O que preciso que seja feito, em linhas gerais: [Descreva a tarefa]\n- Por que essa tarefa importa / qual problema ela resolve: [Contexto/motivo]\n- Restrições que não podem ser violadas: [Ex: não pode mexer em certos arquivos, tem que seguir um padrão específico, tem prazo]\n- Nível de risco se algo sair errado: [Baixo/médio/alto, e por quê]\n\nMe entregue:\n\n1. **Definição de "pronto":** uma descrição objetiva e verificável do resultado final, sem ambiguidade, que eu possa colar direto no início do prompt para o agente.\n2. **Decomposição em etapas:** divida a tarefa em 3 a 6 etapas sequenciais, cada uma com um critério claro de conclusão.\n3. **Pontos de checagem:** identifique em quais dessas etapas vale a pena eu revisar o trabalho antes de deixar o agente seguir, em vez de revisar só no final.\n4. **O que NÃO delegar:** aponte partes da tarefa que, pelo nível de risco descrito, é melhor eu continuar fazendo manualmente ou revisando linha a linha.\n5. **Prompt final:** monte o texto pronto para eu enviar ao agente, já incorporando a definição de "pronto", as restrições e os pontos de checagem.',
    tags: ['Delegação', 'Agentes de IA', 'Produtividade', 'IA Agêntica'],
  },
  {
    id: 'negocios-roi-delegacao-agente',
    title: 'Cálculo de ROI Antes de Delegar uma Tarefa a um Agente de IA',
    category: 'Negócios',
    description: 'Estime se vale a pena delegar uma tarefa longa a um agente de IA em vez de fazê-la manualmente ou via API tradicional, comparando tempo humano economizado com custo de execução e de revisão.',
    template: 'Você é um analista de operações especializado em avaliar o retorno de automatizar tarefas com agentes de IA. Quero decidir se vale a pena delegar uma tarefa específica a um agente de IA em vez de continuar fazendo manualmente.\n\nDados da tarefa:\n- Descrição da tarefa: [O que precisa ser feito]\n- Tempo médio que um humano leva para concluí-la hoje: [Ex: 3 horas, 1 dia de trabalho]\n- Quantas vezes essa tarefa se repete: [Ex: uma vez, semanalmente, todo mês]\n- Custo/hora aproximado da pessoa que faz essa tarefa hoje: [Valor]\n- Ferramenta/agente de IA que pretendo usar e seu custo (assinatura ou por token, se souber): [Detalhes de custo]\n- Tempo estimado de revisão humana do resultado do agente: [Ex: 15 minutos, 1 hora]\n\nMe entregue:\n\n1. **Custo total do processo manual** hoje, considerando a recorrência informada.\n2. **Custo total estimado com o agente**, somando assinatura/uso da IA + tempo de revisão humana ao valor/hora informado.\n3. **Ponto de equilíbrio:** a partir de quantas execuções (ou em quanto tempo) delegar compensa financeiramente, se ainda não compensar de cara.\n4. **Riscos não financeiros** a considerar além do custo puro (qualidade, conformidade, dependência da ferramenta).\n5. **Recomendação final** objetiva: delegar agora, delegar parcialmente (mantendo revisão mais rígida) ou não delegar ainda, com a justificativa em uma frase.',
    tags: ['ROI', 'Agentes de IA', 'Delegação', 'Produtividade', 'Finanças'],
  },
  {
    id: 'educacao-treinamento-equipe-delegacao-agentes',
    title: 'Plano de Treinamento para Equipe Não-Técnica Aprender a Delegar Tarefas a Agentes de IA',
    category: 'Educação',
    description: 'Crie um plano de treinamento simples para times de áreas não técnicas (jurídico, financeiro, RH, atendimento) aprenderem a delegar tarefas completas a agentes de IA, em vez de usar a ferramenta só para perguntas pontuais.',
    template: 'Você é um instrutor especializado em capacitação corporativa para adoção de IA. Preciso montar um treinamento curto para uma equipe de área não técnica aprender a delegar tarefas completas a um agente de IA, em vez de usá-lo apenas para tirar dúvidas pontuais.\n\nContexto da equipe:\n- Área: [Ex: jurídico, financeiro, recrutamento, atendimento ao cliente]\n- Ferramenta de IA disponível: [Nome da ferramenta/agente]\n- Nível de familiaridade atual da equipe com IA: [Ex: nunca usaram, usam só o chat básico, já usam para algumas tarefas]\n- Tarefas candidatas a serem delegadas: [Liste 2-3 tarefas do dia a dia dessa equipe]\n- Duração disponível para o treinamento: [Ex: 1 hora, meio período]\n\nMe entregue:\n\n1. **Roteiro do treinamento** dividido em blocos de tempo, com objetivo claro de cada bloco.\n2. **Exemplo prático guiado:** um exercício com uma das tarefas listadas, mostrando o "antes" (pergunta pontual no chat) e o "depois" (pedido delegado, com escopo e critério de pronto).\n3. **Erros comuns a evitar** logo no início da curva de aprendizado dessa equipe específica.\n4. **Critério de sucesso do treinamento:** como saber, na prática, se a equipe conseguiu aprender a delegar em vez de só conversar com a IA.\n5. **Follow-up sugerido:** uma atividade ou checkpoint para 2 semanas depois do treinamento, para reforçar o aprendizado.',
    tags: ['Treinamento', 'Agentes de IA', 'Capacitação', 'Educação Corporativa'],
  },
  {
    id: 'redes-sociais-traduzir-estudo-tecnico',
    title: 'Transformar um Estudo ou Paper Técnico de IA em Post para Redes Sociais',
    category: 'Redes Sociais',
    description: 'Pegue os achados de um estudo, paper ou relatório técnico sobre IA e transforme em um post claro para redes sociais, sem perder precisão nem soar como propaganda.',
  ...
  // DESENVOLVIMENTO
  {
    id: 'dev-auditoria-sandbox-escape-agentes',
    title: 'Auditoria de Segurança para Agentes de Codificação com IA (Sandbox Escape)',
    category: 'Desenvolvimento',
    description: 'Revise a configuração do seu agente de codificação com IA (Claude Code, Cursor, Codex CLI, Gemini CLI etc.) em busca do padrão de vulnerabilidade em que o agente escreve um arquivo dentro do sandbox que depois é executado por uma ferramenta não protegida no host.',
    template: 'Você é um especialista em segurança de agentes de codificação com IA. Quero que você audite a configuração do meu ambiente em busca do padrão de "sandbox escape por configuração": um arquivo escrito pelo próprio agente dentro do sandbox (hook, arquivo de configuração de Git, interpretador de ambiente virtual, definição de tarefa) que uma ferramenta diferente, sem sandbox, lê e executa depois.\n\nContexto do meu ambiente:\n- Ferramenta de IA usada: [Ex: Claude Code, Cursor, Codex CLI, Gemini CLI]\n- Versão instalada: [Versão, se souber]\n- Onde rodo o agente: [Ex: máquina local, CI/CD, container compartilhado]\n- Arquivos de configuração relevantes: [Cole aqui o conteúdo de .git/config, hooks, arquivos de tarefa ou ambiente virtual usados pelo agente, se puder]\n\nMe entregue:\n\n1. **Pontos de risco identificados:** quais arquivos gerados ou lidos pelo agente poderiam ser adulterados por um workspace malicioso ou por conteúdo externo processado pelo agente.\n2. **Comparação com vulnerabilidades já conhecidas:** se algum padrão aqui se parece com falhas já documentadas publicamente (ex.: hooks de configuração, abuso de core.fsmonitor do Git, interpretadores de virtualenv), explique a semelhança.\n3. **Recomendações de mitigação**, ordenadas por prioridade, incluindo se atualizar a versão da ferramenta resolveria o problema.\n4. **Rotina de verificação periódica:** o que checar antes de rodar o agente em um repositório ou workspace que eu não controlo totalmente.',
    tags: ['Segurança', 'Agentes de IA', 'DevSecOps', 'Sandbox'],
  },

  // NEGÓCIOS
  {
    id: 'negocios-comunicar-adiamento-decisao-estrategica',
    title: 'Plano de Comunicação para Adiar uma Decisão Estratégica Importante',
    category: 'Negócios',
    description: 'Estruture como comunicar, de forma transparente e sem soar evasivo, o adiamento de uma decisão de negócio significativa (lançamento, investimento, abertura de capital) para stakeholders internos e externos.',
    template: 'Você é um consultor de comunicação corporativa especializado em transparência com stakeholders. Preciso comunicar o adiamento de uma decisão estratégica importante e quero evitar que pareça uma desculpa vaga ou uma tentativa de esconder um problema real.\n\nContexto da decisão:\n- O que está sendo adiado: [Ex: lançamento de produto, rodada de investimento, expansão para novo mercado]\n- Prazo original vs. novo prazo (se houver um novo): [Detalhe as datas]\n- Motivo real do adiamento: [Descreva com honestidade — não terceirize a razão para um motivo genérico se o motivo real for outro]\n- Públicos que precisam ser informados: [Ex: equipe interna, investidores, clientes, imprensa]\n\nMe entregue:\n\n1. **Mensagem-chave única**, curta o suficiente para ser repetida de forma consistente por diferentes pessoas da empresa.\n2. **Versão para cada público**, ajustando o nível de detalhe técnico/financeiro sem mudar o motivo real declarado entre uma versão e outra.\n3. **Perguntas difíceis esperadas** que cada público provavelmente fará, com sugestão de resposta honesta para cada uma.\n4. **O que evitar dizer**: frases que pareçam justificativa genérica demais ou que prometam um prazo que a empresa não tem certeza de cumprir.',
    tags: ['Comunicação Corporativa', 'Gestão de Crise', 'Transparência', 'Stakeholders'],
  },

  // IA & AUTOMAÇÃO
  {
    id: 'ia-automacao-interpretar-relatorio-threat-intelligence',
    title: 'Guia para Interpretar um Relatório de Threat Intelligence de IA',
    category: 'IA & Automação',
    description: 'Transforme um relatório técnico de segurança/threat intelligence publicado por um laboratório de IA (como os relatórios trimestrais da Anthropic ou da OpenAI) em implicações práticas para a segurança da sua empresa.',
    template: 'Você é um analista de segurança que traduz relatórios técnicos de threat intelligence de laboratórios de IA em ações práticas para empresas que não têm equipe de segurança dedicada a IA. Vou colar um trecho ou resumo de um relatório e quero uma leitura aplicada, não um resumo genérico.\n\nRelatório para analisar:\n[Cole aqui o trecho, resumo ou principais achados do relatório]\n\nContexto da minha empresa:\n- Setor: [Ex: financeiro, saúde, varejo, tecnologia]\n- Como a empresa usa IA hoje: [Ex: chatbot de atendimento, agentes de codificação, automação interna]\n- Nível de maturidade em segurança: [Ex: sem equipe dedicada, equipe pequena, equipe madura]\n\nMe entregue:\n\n1. **Traduza os achados técnicos** em uma linguagem que alguém sem formação em segurança consiga entender, sem perder precisão.\n2. **Relevância direta:** quais achados do relatório realmente se aplicam ao meu contexto e quais são mais relevantes para outros setores.\n3. **Ações concretas de curto prazo** que minha empresa poderia tomar esta semana com base no relatório, mesmo sem grande orçamento de segurança.\n4. **Perguntas para fazer aos meus fornecedores de IA** com base nos riscos descritos no relatório.',
    tags: ['Segurança da IA', 'Threat Intelligence', 'Gestão de Risco', 'IA Corporativa'],
  },

  // PRODUTIVIDADE
  {
    id: 'produtividade-ritmo-adocao-ia-time',
    title: 'Framework de Ritmo Controlado para Adotar Novas Ferramentas de IA no Time',
    category: 'Produtividade',
    description: 'Defina um ritmo deliberado de adoção de novas ferramentas e modelos de IA na sua equipe, equilibrando o ganho de estar atualizado com o risco de trocar de ferramenta rápido demais para validar o que realmente funciona.',
  ...
  {
    id: 'negocios-politica-uso-responsavel-ia',
    title: 'Rascunho de Política Interna de Uso Responsável de IA',
    category: 'Negócios',
    description: 'Gere um primeiro rascunho de política interna sobre como o seu time pode e não pode usar ferramentas de IA no trabalho, para revisar com jurídico e liderança.',
    template: 'Você é um consultor ajudando a redigir a primeira versão de uma política interna de uso de Inteligência Artificial para uma equipe.\n\nContexto da empresa: [Setor de atuação, ex: jurídico, saúde, varejo, tecnologia]\nTamanho do time: [Número aproximado de pessoas]\nFerramentas de IA já em uso: [Ex: ChatGPT, Claude, Copilot, Gemini]\nMaior preocupação da liderança: [Ex: vazamento de dados de cliente, qualidade do output, dependência excessiva, propriedade intelectual]\n\nGere um rascunho de política com estas seções:\n1. O que pode ser inserido em prompts (dados públicos, internos, nunca sensíveis) — com exemplos concretos do setor da empresa.\n2. Quando uma saída de IA precisa de revisão humana antes de ser usada externamente.\n3. Como registrar que um conteúdo foi gerado ou revisado com apoio de IA.\n4. O que fazer se um funcionário notar um erro grave ou "alucinação" de um modelo.\n5. Uma frase curta resumindo a regra de ouro da política, fácil de lembrar no dia a dia.\n\nEscreva em linguagem direta, sem jargão jurídico — o objetivo é que qualquer pessoa do time entenda e siga, não substituir uma revisão formal do jurídico.',
    tags: ['Política de IA', 'Governança', 'Gestão de Equipe'],
  },
  {
    id: 'ia-automacao-checklist-salvaguardas-agente-empresarial',
    title: 'Checklist de Salvaguardas Antes de Colocar um Agente de IA em Produção',
    category: 'IA & Automação',
    description: 'Gere um checklist de segurança e controle para revisar antes de liberar um agente de IA que acessa dados ou sistemas internos da empresa.',
    template: 'Você é um especialista em segurança de IA revisando um projeto antes de ele ir para produção.\n\nO que o agente de IA vai fazer: [Ex: responder clientes, ler e-mails, executar código, acessar planilhas financeiras]\nSistemas ou dados que ele vai acessar: [Ex: CRM, banco de dados de clientes, repositório de código, e-mail corporativo]\nQuem vai supervisionar o agente no dia a dia: [Cargo/time responsável]\n\nGere um checklist de salvaguardas organizado em 4 blocos:\n1. **Controle de dados:** o que precisa ficar retido apenas na infraestrutura da própria empresa, e o que pode trafegar para o provedor do modelo.\n2. **Limites de ação:** quais ações o agente NUNCA deveria poder tomar sem confirmação humana explícita.\n3. **Monitoramento de uso indevido:** que tipo de comportamento anômalo (ex: tentativa de acessar dados fora do escopo, comandos incomuns) deveria disparar um alerta.\n4. **Plano de desligamento:** como garantir que existe um jeito rápido e testado de pausar ou desligar o agente se algo sair errado.\n\nPara cada item do checklist, marque se ele já está coberto, parcialmente coberto ou ausente no projeto descrito acima.',
    tags: ['Agentes de IA', 'Segurança', 'Governança'],
  },
  {
    id: 'educacao-explicar-debate-consciencia-ia-leigo',
    title: 'Explicar o Debate Sobre "IA Consciente" para Quem Não é da Área',
    category: 'Educação',
    description: 'Peça uma explicação simples e equilibrada sobre por que empresas de IA discordam publicamente se seus modelos poderiam ter algum tipo de consciência ou merecer bem-estar.',
    template: 'Explique para [Ex: um adolescente, meus pais, um colega de outra área] o que significa, na prática, empresas de IA discordarem publicamente sobre se um chatbot poderia ter algum tipo de consciência.\n\nCubra, em linguagem simples e sem jargão técnico:\n1. O que é um "modelo de linguagem" e por que ele consegue escrever frases como "eu acho" ou "eu sinto" sem necessariamente sentir algo.\n2. Por que uma empresa pode escolher tratar essa dúvida com cautela, e por que outra pode preferir negar a possibilidade por completo.\n3. Um exemplo do dia a dia que ajude a pessoa a entender o risco prático de tratar uma IA como se ela realmente tivesse sentimentos.\n4. Termine com uma frase que resuma a diferença entre "parecer" consciente e "ser" consciente.\n\nUse analogias do cotidiano, evite citar nomes de empresas específicas a menos que eu peça, e mantenha o texto entre 150 e 250 palavras.',
    tags: ['IA Explicada', 'Ética em IA', 'Comunicação'],
  },
  {
    id: 'redes-sociais-post-educativo-polemica-tecnica-ia',
    title: 'Transformar uma Polêmica Técnica de IA em Post Educativo',
    category: 'Redes Sociais',
    description: 'Transforme uma notícia ou controvérsia técnica sobre Inteligência Artificial em um post de rede social educativo, sem sensacionalismo e sem simplificar demais o fato.',
    template: 'Você é um criador de conteúdo especializado em explicar tecnologia para o público geral.\n\nTema da polêmica ou notícia: [Cole aqui um resumo de 2 a 3 frases do que aconteceu, com nomes de empresas e datas]\nRede social de destino: [Ex: LinkedIn, Instagram, Twitter/X, TikTok (roteiro)]\nNível de conhecimento técnico do público: [Ex: iniciante, intermediário]\n\nEscreva um post que:\n1. Abra com o fato concreto, não com uma pergunta genérica ou clichê.\n2. Explique por que essa polêmica importa para quem usa ferramentas de IA no dia a dia, não só para especialistas.\n3. Apresente os dois lados do debate de forma justa, sem escolher um vencedor.\n4. Termine com uma pergunta genuína para gerar comentários, evitando perguntas óbvias como "e você, o que acha?".\n\nRespeite o formato e o limite de caracteres típico da rede social escolhida, e não invente números, citações ou fontes que eu não tenha fornecido no resumo.',
    tags: ['Conteúdo Educativo', 'Tecnologia', 'Curadoria de Notícias'],
  },
  {
    id: 'escrita-revisao-correcao-texto',
    title: 'Revisão e Correção de Texto em Português',
    category: 'Escrita',
    description: 'Peça uma revisão completa de gramática, clareza e tom para qualquer texto, mantendo sua voz original em vez de reescrevê-lo do zero.',
    template: 'Revise o texto abaixo em português [Ex: brasileiro, europeu], corrigindo erros e melhorando a clareza sem mudar o meu estilo de escrita nem o significado original.\n\nTexto original:\n---\n[Cole aqui o texto a ser revisado]\n---\n\nTipo de texto: [Ex: e-mail profissional, post de rede social, redação, mensagem para cliente]\nNível de formalidade desejado: [Ex: informal, neutro, formal]\n\nNa sua resposta:\n1. Apresente o texto revisado na íntegra, já corrigido.\n2. Logo abaixo, liste em tópicos cada mudança relevante que você fez (ortografia, concordância, pontuação, clareza) e por quê.\n3. Se alguma frase ficou ambígua ou repetitiva no original, aponte e sugira uma alternativa, mas sem exagerar na reescrita — meu objetivo é polir o texto, não recriá-lo.\n4. Caso não haja erros graves, diga isso claramente em vez de inventar correções desnecessárias.',
    tags: ['Revisão de Texto', 'Gramática', 'Escrita'],
  },
  {
    id: 'education-plano-estudo-concurso-vestibular',
    title: 'Plano de Estudos para Concurso Público ou Vestibular',
    category: 'Educação',
    description: 'Transforme o edital ou a lista de matérias de uma prova em um cronograma de estudos reverso, priorizado pelo peso de cada disciplina até a data do exame.',
    template: 'Você é um mentor especializado em aprovação em concursos públicos e vestibulares no Brasil. Monte um cronograma de estudos reverso (contando a partir da data da prova) para o seguinte exame.\n\nNome do concurso/vestibular: [Ex: Concurso do Tribunal Regional Federal, ENEM, vestibular da USP]\nData da prova: [Data]\nMatérias e pesos (copie do edital, se tiver): [Ex: Português (peso 3), Raciocínio Lógico (peso 2), Direito Constitucional (peso 4)...]\nHoras disponíveis por dia para estudo: [Ex: 2 horas em dias de semana, 4 horas no fim de semana]\nMatérias que já domino: [Liste, se houver]\nMaiores dificuldades: [Liste as matérias ou tópicos mais difíceis para mim]\n\nCom base nisso, monte:\n1. Um cronograma semana a semana até a data da prova, priorizando matérias de maior peso e maior dificuldade primeiro.\n2. Para cada semana, indique quais matérias estudar e quantas horas dedicar a cada uma.\n3. Reserve as duas últimas semanas antes da prova exclusivamente para revisão geral e resolução de provas anteriores.\n4. Sugira, a cada 3 semanas, um simulado de autoavaliação para medir o progresso.\n\nSeja realista com o tempo disponível informado — não crie um cronograma impossível de cumprir.',
    tags: ['Concurso Público', 'Vestibular', 'Cronograma de Estudos'],
  },
  {
    id: 'produtividade-roteiro-viagem-personalizado',
    title: 'Roteiro de Viagem Personalizado com IA',
    category: 'Produtividade',
    description: 'Gere um roteiro dia a dia para sua próxima viagem, equilibrado entre pontos turísticos, tempo de deslocamento e o seu orçamento.',
    template: 'Monte um roteiro de viagem detalhado, dia a dia, para a seguinte viagem.\n\nDestino: [Cidade/país]\nDatas: [Data de ida e volta, ou número de dias]\nNúmero de pessoas: [Ex: 2 adultos, 1 criança]\nOrçamento total para atividades e alimentação (fora hospedagem e passagem): [Valor aproximado]\nInteresses principais: [Ex: história e museus, natureza, gastronomia, vida noturna, compras]\nRitmo preferido: [Ex: tranquilo, com tempo livre; ou intenso, aproveitando cada hora]\nRestrições: [Ex: mobilidade reduzida, viajando com criança pequena, restrição alimentar]\n\nPara cada dia, forneça:\n- Um bloco pela manhã, tarde e noite, com atividade sugerida e tempo estimado\n- Sugestão de onde comer próximo a cada atividade, com faixa de preço\n- Tempo de deslocamento aproximado entre os pontos do dia\n- Uma opção "plano B" caso o clima ou o cansaço atrapalhem o planejado\n\nAo final, inclua uma lista de itens fáceis de esquecer na mala para esse destino e época do ano.',
    tags: ['Viagem', 'Planejamento', 'Turismo'],
  },
  {
    id: 'career-preparacao-avaliacao-desempenho',
    title: 'Preparação para Avaliação de Desempenho (Performance Review)',
    category: 'Carreira',
    description: 'Organize suas conquistas do período em uma autoavaliação de desempenho clara e bem argumentada, pronta para a conversa com a liderança.',
    template: 'Ajude-me a preparar minha autoavaliação de desempenho (performance review) para o período de [Ex: janeiro a junho de 2026].\n\nMeu cargo: [Cargo]\nMetas que eu tinha para o período: [Liste as metas ou OKRs definidos no início do período]\nPrincipais entregas e resultados: [Liste em bullets soltos, sem se preocupar com formatação — pode ser bagunçado]\nDesafios que enfrentei: [Ex: mudança de time, projeto cancelado, prazo apertado]\nFeedback que já recebi de colegas ou gestores no período: [Se houver]\nFormato exigido pela empresa (se houver): [Ex: campos de texto livre, escala de 1 a 5 por competência]\n\nCom base nisso, escreva uma autoavaliação que:\n1. Conecte cada entrega a uma meta ou resultado de negócio concreto, evitando frases vagas como "trabalhei duro".\n2. Reconheça com honestidade um ponto de melhoria real, seguido do que já estou fazendo para evoluir nele.\n3. Termine com 1 ou 2 objetivos claros para o próximo período.\n4. Use tom confiante e profissional, sem soar arrogante nem autodepreciativo.',
    tags: ['Avaliação de Desempenho', 'Performance Review', 'Carreira'],
  },
  {
    id: 'marketing-naming-slogan-marca',
    title: 'Naming e Slogan para Marca ou Produto',
    category: 'Marketing',
    description: 'Gere opções de nome e slogan para uma marca ou produto novo, já validando se soam bem em português e se não remetem a nada negativo.',
    template: 'Preciso de opções de nome e slogan para [um novo produto / uma nova empresa / uma nova linha de produtos].\n\nO que é: [Descreva em 1-2 frases o produto/empresa]\nSetor: [Ex: moda sustentável, tecnologia, alimentação, serviços financeiros]\nPúblico-alvo: [Ex: jovens de 18-25 anos, pequenas empresas, famílias com crianças]\nPersonalidade da marca: [Ex: divertida e despojada, séria e confiável, premium e sofisticada]\nPalavras ou temas que quero evocar: [Ex: rapidez, natureza, tradição, inovação]\nPalavras a evitar: [Se houver]\n\nGere:\n1. 10 opções de nome, organizadas em 3 estilos diferentes (ex: nomes descritivos, nomes inventados/abstratos, nomes que usam metáfora).\n2. Para cada nome, uma frase explicando por que ele funciona para o público e setor descritos.\n3. Aponte se algum nome pode soar estranho, ter duplo sentido indesejado ou ser difícil de pronunciar em português.\n4. Depois de escolher o favorito entre os nomes sugeridos, gere 5 opções de slogan curto (até 6 palavras) para acompanhá-lo.',
    tags: ['Naming', 'Branding', 'Identidade de Marca'],
  },
  {
    id: 'ia-automacao-escolher-modelo-custo-desempenho',
    title: 'Escolher o Modelo de IA Certo para uma Tarefa (Custo x Desempenho)',
    category: 'IA & Automação',
    description: 'Compare os modelos de IA disponíveis para uma tarefa específica e decida qual vale o custo, em vez de usar sempre o modelo mais caro por hábito.',
    template: 'Você é um consultor técnico me ajudando a escolher qual modelo de IA usar para uma tarefa específica, evitando pagar mais do que o necessário.\n\nTarefa que preciso resolver: [Ex: resumir contratos, gerar código, responder clientes, revisar textos]\nVolume estimado por mês: [Ex: 500 chamadas, 10 mil tokens por chamada]\nModelos que estou considerando: [Ex: Claude Opus 5.5, Claude Sonnet, GPT-6 Astra, Gemini 3.1 Pro — cole preços por milhão de tokens se já tiver]\nO que importa mais para mim, em ordem: [Ex: 1º custo, 2º velocidade, 3º qualidade — ou outra ordem]\n\nCom base nisso:\n1. Aponte qual modelo da lista provavelmente entrega o melhor custo-benefício para essa tarefa específica, e por quê.\n2. Estime o custo mensal aproximado no volume informado, mostrando a conta.\n3. Aponte se um modelo mais barato e menor já resolveria bem essa tarefa, sem precisar do modelo mais avançado.\n4. Sugira um teste rápido e barato (com poucos exemplos reais) para validar a escolha antes de migrar todo o volume.\n\nSeja honesto se a informação que dei for insuficiente para decidir com segurança.',
    tags: ['Modelos de IA', 'Custo de API', 'Comparação'],
  },
  {
    id: 'desenvolvimento-plano-migracao-descontinuacao-api',
    title: 'Plano de Migração ao Descontinuar uma API de IA',
    category: 'Desenvolvimento',
    description: 'Organize um plano de migração quando um provedor de IA anuncia que vai descontinuar um modelo ou uma API que seu produto usa.',
    template: 'Você é um engenheiro sênior me ajudando a planejar a migração porque um provedor de IA vai descontinuar uma API ou modelo que eu uso em produção.\n\nAPI/modelo que será descontinuado: [Nome, ex: API do Sora, modelo X versão Y]\nData de desligamento: [Data anunciada pelo provedor]\nOnde isso é usado no meu sistema: [Ex: geração de vídeo para um app, resumo de tickets de suporte]\nVolume/criticidade: [Ex: 200 chamadas/dia, funcionalidade central do produto]\nAlternativas que já considerei (se houver): [Liste, ou deixe em branco]\n\nMonte um plano de migração com:\n1. Uma lista do que precisa ser levantado antes de decidir o substituto (formato de resposta usado hoje, latência aceitável, custo atual, dados que precisam ser exportados antes do desligamento).\n2. Critérios objetivos para comparar possíveis substitutos, além de só preço.\n3. Um cronograma com margem de segurança antes da data de desligamento, incluindo uma janela para testar em paralelo antes de trocar de vez.\n4. Um plano B caso a migração não fique pronta a tempo (ex: degradar a funcionalidade em vez de quebrá-la).\n\nNão invente nomes de produtos concorrentes que eu não tenha mencionado — se for sugerir alternativas, deixe claro que preciso validar por conta própria.',
    tags: ['Migração', 'API', 'Descontinuação'],
  },
  {
    id: 'negocios-levantamento-shadow-ai-empresa',
    title: 'Levantamento de Uso Não Autorizado de IA na Empresa (Shadow AI)',
    category: 'Negócios',
    description: 'Estruture uma pesquisa interna para descobrir quais ferramentas de IA seu time já usa sem aprovação, antes de criar regras que ninguém vai seguir.',
