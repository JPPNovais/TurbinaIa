---
title: "Estudo da Harvard Publicado na Science Confirma: IA da OpenAI Supera Médicos Experientes no Diagnóstico e Tratamento de Pacientes"
description: "Pesquisa publicada na Science mostra que o modelo o1 da OpenAI superou médicos em 67% dos diagnósticos de triagem em urgências de Boston — e chocou seus"
category: noticias
tags:
  - OpenAI
  - IA na saúde
...
isFeatured: false
date: "2026-06-19"
coverImage: "https://images.unsplash.com/photo-1593642532400-2682810df593?auto=format&fit=crop&w=1200&q=80"
---

Um resultado que surpreendeu até os próprios pesquisadores responsáveis por ele: o modelo de inteligência artificial o1 preview da OpenAI superou médicos experientes em diagnósticos de emergência em todas as etapas de um experimento clínico conduzido em um pronto-socorro real de Boston. A pesquisa foi liderada por especialistas da Harvard Medical School e do Beth Israel Deaconess Medical Center e publicada em abril de 2026 na [Science](https://www.science.org/), uma das revistas científicas mais rigorosas e prestigiadas do planeta — ao lado de Nature, o principal termômetro do que a comunidade científica global considera resultado sólido e verificável.
...
"Eu pensei que seria um experimento divertido, mas que não funcionaria tão bem. Não foi nada disso que aconteceu." A afirmação é de Adam Rodman, médico do Beth Israel Deaconess e co-autor sênior da pesquisa, citado pela [Fortune](https://fortune.com/2026/05/04/harvard-study-ai-outdiagnose-doctors-openai-o1-preview/). Rodman, que é também uma das principais referências médicas do estudo, descreveu sua surpresa com os resultados de uma forma que resume bem o que aconteceu: ninguém esperava que a diferença fosse tão grande, tão clara e tão consistente.

Arjun Manrai, chefe de um laboratório de IA na Harvard Medical School e principal co-autor da pesquisa, foi ainda mais direto. "Testamos o modelo de IA contra praticamente todos os benchmarks, e ele eclipsou tanto os modelos anteriores quanto nossa linha de base de médicos", declarou em comunicado reproduzido pelo [TechCrunch](https://techcrunch.com/2026/05/03/in-harvard-study-ai-offered-more-accurate-diagnoses-than-emergency-room-doctors/). A pesquisa contou com colaboradores da Universidade de Stanford e envolveu uma série de experimentos distintos: avaliação diagnóstica em casos reais de triagem, raciocínio clínico em casos históricos publicados no New England Journal of Medicine, e análise de gestão clínica — desde recomendações de antibióticos até orientações sobre cuidados de fim de vida.

Para quem quer entender como diferentes modelos de IA se comparam em capacidades gerais, o [Comparador de IAs](/comparador) do Turbina IA oferece uma visão atualizada dos principais sistemas disponíveis no mercado.


![Imagem ilustrativa sobre Estudo da Harvard Publicado na Science Confirma: IA da OpenAI Supera Médicos Experientes no Diagnóstico e Trat](https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80)

## Como o Experimento Foi Conduzido

### A Metodologia: Dados Brutos, Sem Nenhum Filtro

Um dos aspectos mais relevantes — e que distingue este estudo de pesquisas anteriores com IA médica — foi a decisão dos pesquisadores de não pré-processar os dados clínicos antes de apresentá-los ao modelo. Conforme destacou a [Harvard Magazine](https://www.harvardmagazine.com/ai/ai-outperforms-doctors-diagnosis-harvard-study), "os pesquisadores não processaram os dados de nenhuma forma": o modelo recebeu exatamente as mesmas informações disponíveis nos prontuários eletrônicos no momento de cada diagnóstico.
...
O modelo o1 preview da OpenAI atingiu o diagnóstico exato ou muito próximo em **67% dos casos de triagem inicial**. Tanto a [Harvard Magazine](https://www.harvardmagazine.com/ai/ai-outperforms-doctors-diagnosis-harvard-study) quanto o portal de tecnologia [TugaTech](https://tugatech.com.pt/t82738-modelos-da-openai-superam-medicos-em-diagnosticos-durante-testes-em-urgencias) confirmam que um dos médicos acertou em 55% dos casos e o outro em apenas 50%. Ou seja: a diferença entre o melhor médico e a IA foi de 12 pontos percentuais — e isso em condições idênticas, com os mesmos dados disponíveis.
...
![Imagem ilustrativa sobre Estudo da Harvard Publicado na Science Confirma: IA da OpenAI Supera Médicos Experientes no Diagnóstico e Trat](https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80)

## Por Que o Modelo de Raciocínio Fez a Diferença

O o1 preview é descrito pela [Harvard Magazine](https://www.harvardmagazine.com/ai/ai-outperforms-doctors-diagnosis-harvard-study) como "o primeiro modelo da OpenAI com capacidade de raciocínio passo a passo" — o que os pesquisadores chamam de *chain-of-thought reasoning* (raciocínio em cadeia). Esse tipo de modelo não apenas processa informações: ele as analisa de forma estruturada, considerando hipóteses alternativas e revisando suas conclusões antes de apresentar uma resposta. Para entender melhor termos como modelo de linguagem de grande escala (LLM) e raciocínio em cadeia, consulte o [Glossário de IA](/glossario) do Turbina IA.
...
Kristen Panthagani, médica emergencista que publicou uma análise amplamente compartilhada sobre a pesquisa, apontou uma limitação metodológica central: os diagnósticos humanos no estudo foram feitos por **médicos internistas**, não por especialistas em medicina de emergência. Segundo ela, reportada pelo [TechCrunch](https://techcrunch.com/2026/05/03/in-harvard-study-ai-offered-more-accurate-diagnoses-than-emergency-room-doctors/), "se vamos comparar ferramentas de IA com a capacidade clínica dos médicos, devemos começar comparando com médicos que realmente praticam essa especialidade."
...
O consenso entre os autores da pesquisa é que os resultados não significam que "a IA substitui médicos" — nas próprias palavras de Manrai. Mas revelam, como afirmou o pesquisador à [Harvard Magazine](https://www.harvardmagazine.com/ai/ai-outperforms-doctors-diagnosis-harvard-study), "uma mudança profundamente significativa na tecnologia que vai remodelar a medicina" — e que exige uma resposta regulatória e clínica à altura.
...
- [Harvard Magazine — AI Outperforms Doctors in Emergency Room Tasks](https://www.harvardmagazine.com/ai/ai-outperforms-doctors-diagnosis-harvard-study)
- [TechCrunch — In Harvard study, AI offered more accurate diagnoses than emergency room doctors](https://techcrunch.com/2026/05/03/in-harvard-study-ai-offered-more-accurate-diagnoses-than-emergency-room-doctors/)
- [Fortune — Harvard study found AI can now out-diagnose physicians in the ER](https://fortune.com/2026/05/04/harvard-study-ai-outdiagnose-doctors-openai-o1-preview/)
- [TugaTech — Modelos da OpenAI superam médicos em diagnósticos durante testes em urgências](https://tugatech.com.pt/t82738-modelos-da-openai-superam-medicos-em-diagnosticos-durante-testes-em-urgencias)
- [Science — Publicação original do estudo](https://www.science.org/)