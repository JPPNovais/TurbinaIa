---
title: "IA e o Futuro do Trabalho: 170 Milhões de Empregos Criados até 2030, mas 92 Milhões em Risco"
description: "Dados do WEF, McKinsey e OIT revelam o impacto real da IA no mercado de trabalho em 2025-2026: automação, novas profissões e o que fazer agora."
category: noticias
tags:
  - IA
  - Futuro do Trabalho
...
A inteligência artificial está redesenhando o mercado de trabalho global em uma velocidade sem precedentes. O [Fórum Econômico Mundial (WEF)](https://www.weforum.org/publications/the-future-of-jobs-report-2025/) projeta que **170 milhões de novos empregos serão criados até 2030** — ao mesmo tempo em que **92 milhões de funções serão eliminadas**, resultando em um saldo positivo líquido de 78 milhões de postos. Mas esses números escondem uma realidade mais complexa e urgente: a transição exige ação imediata de trabalhadores, empresas e governos.
...
O [Future of Jobs Report 2025](https://www.weforum.org/press/2025/01/future-of-jobs-report-2025-78-million-new-job-opportunities-by-2030-but-urgent-upskilling-needed-to-prepare-workforces/) do WEF, baseado em pesquisa com mais de **1.000 empresas em 22 indústrias e 55 economias**, oferece o panorama mais abrangente disponível:
...
A análise do [Goldman Sachs](https://www.goldmansachs.com/insights/articles/how-will-ai-affect-the-global-workforce) oferece uma perspectiva mais cautelosa sobre o desemprego imediato:
...
O relatório da [Organização Internacional do Trabalho (OIT)](https://www.ilo.org/resource/news/one-four-jobs-risk-being-transformed-genai-new-ilo%E2%80%93nask-global-index-shows) traz uma perspectiva crítica sobre as desigualdades da automação:
...
Nem tudo é destruição. O [Global AI Jobs Barometer 2025 da PwC](https://www.pwc.com/gx/en/services/ai/ai-jobs-barometer.html), baseado na análise de quase **1 bilhão de anúncios de vagas em seis continentes**, revelou um lado positivo robusto:
...
2. **Especialistas em big data e análise de dados**
3. **Engenheiros de segurança cibernética**
4. **Desenvolvedores de software e aplicações**
5. **Trabalhadores de cuidados (saúde, educação, serviços sociais)**
6. **Motoristas e entregadores** (demanda física que a IA ainda não substitui)
7. **Trabalhadores rurais e de construção civil**

### Funções com Maior Risco de Declínio (WEF + Goldman Sachs)

1. Digitadores e escriturários administrativos
2. Caixas e atendentes de caixa
3. Secretárias e assistentes administrativos
4. Operadores de telemarketing
5. Assistentes jurídicos e revisores de texto
6. Analistas de crédito e processadores de dados financeiros
7. Agentes de atendimento ao cliente de nível básico
...
1. **Pensamento analítico e crítico**: validar saídas de IA e identificar erros ou vieses em sistemas automatizados
2. **Fluência em IA (AI Literacy)**: saber usar, dirigir e supervisionar ferramentas de IA no contexto profissional — a habilidade com crescimento mais rápido do mercado
3. **Inteligência emocional e social**: negociação, liderança, empatia, resolução de conflitos — competências exclusivamente humanas
...
Priorize: fluência em ferramentas de IA (saber usar ChatGPT, Gemini, Claude, Copilot para sua área), pensamento crítico para validar outputs de IA, habilidades interpessoais (liderança, negociação, empatia) e capacidade de aprendizado contínuo. A PwC mostra que trabalhadores com habilidades avançadas em IA ganham **56% a mais** do que seus pares. Use o [Comparador de IAs](/comparador) para encontrar a ferramenta certa para a sua área de atuação.
...
- [WEF — Future of Jobs Report 2025 (publicação completa)](https://www.weforum.org/publications/the-future-of-jobs-report-2025/)
- [McKinsey Global Institute — Agents, Robots, and Us: Skill Partnerships in the Age of AI (novembro 2025)](https://www.mckinsey.com/mgi/our-research/agents-robots-and-us-skill-partnerships-in-the-age-of-ai)
- [McKinsey — AI in the Workplace: A Report for 2025 (Superagency)](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/superagency-in-the-workplace-empowering-people-to-unlock-ais-full-potential-at-work)
...
- [OIT — One in Four Jobs at Risk of Being Transformed by GenAI](https://www.ilo.org/resource/news/one-four-jobs-risk-being-transformed-genai-new-ilo%E2%80%93nask-global-index-shows)
- [OIT — Generative AI and Jobs: A 2025 Update](https://www.ilo.org/publications/generative-ai-and-jobs-2025-update)
- [PwC — Global AI Jobs Barometer 2025](https://www.pwc.com/gx/en/services/ai/ai-jobs-barometer.html)
- [Banco Mundial — Generative AI and Jobs in Latin America and the Caribbean](https://www.worldbank.org/en/topic/poverty/publication/generative-ai-and-jobs-in-lac)
- [Fortune — Why AI Won't Take Your Job: McKinsey on Agents and Robots (novembro 2025)](https://fortune.com/2025/11/25/why-ai-wont-take-your-job-partnership-agents-robots-mckinsey/)
