...
export const AI_TOOLS: AITool[] = [
  // Texto & Redação
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (acesso limitado a modelos básicos como GPT-3.5). ChatGPT Plus a US$ 20/mês (acesso a GPT-4o, ChatGPT Images 2.0, navegação web, análise de dados). ChatGPT Team a US$ 25/usuário/mês (faturamento mensal) ou US$ 20/usuário/mês (faturamento anual, mínimo de 2 usuários), inclui GPT-4o, privacidade, workspace compartilhado, controles administrativos. ChatGPT Enterprise sob consulta (segurança empresarial, residência de dados, suporte 24/7). API GPT-4o a US$ 5.00/M tokens entrada e US$ 15.00/M tokens saída.',
  ...
  },
  {
    ...
    pricing: 'Grátis',
    pricingDetails: 'Grátis (public preview), com acesso a modelos de IA avançados como Gemini 3.1 Pro, Flash, Claude 3.5 Sonnet e Claude 3 Opus. Preços de API aplicáveis para uso avançado dos modelos.',
  ...
  },
  {
    ...
    description:
      'Magic Studio da Stability AI é uma suite de ferramentas de IA para edição e geração de imagens, rivalizando com o Adobe Firefly. Inclui recursos para retoque, upscaling, remoção de objetos e geração de imagens a partir de texto, com foco na acessibilidade e poder criativo.',
    useCases: [
  ...
  // Vídeo
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Sora foi descontinuado em 26 de abril de 2026, com a API programada para ser desativada em 24 de setembro de 2026. Anteriormente, o acesso era limitado e os preços futuros estimados eram: Acesso via ChatGPT Pro (US$ 200/mês, com mais créditos e recursos). API (preços futuros estimados: Sora (Standard) a US$ 0.10/segundo (720p); Sora Pro a US$ 0.30/segundo (720p) ou US$ 0.50/segundo (1024p)).',
  ...
  },
  {
    ...
    description:
      'Kling AI é um modelo de geração de vídeo da empresa chinesa Kuaishou, capaz de gerar vídeos de até 2 minutos com física e movimentos de câmera realistas. Recebeu forte atenção internacional por seus resultados impressionantes. Atualmente em acesso limitado (private beta).',
    useCases: [
    ...
    pricing: 'Freemium',
    pricingDetails: 'Atualmente em acesso limitado (private beta). Previsão de Grátis (com créditos diários) e planos pagos a partir de US$ 9,99/mês. Preços exatos para acesso internacional podem variar após lançamento completo.',
