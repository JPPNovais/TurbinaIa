...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'GPT-5.5 Instant (lançado em 5 de maio de 2026) é o modelo padrão para todos os usuários do ChatGPT no chat padrão, com estilo de resposta aprimorado e qualidade melhorada (atualizado em 28 de maio de 2026 e 24 de junho de 2026), sendo mais natural, fácil de ler e com menos respostas longas ou com muitas listas.',
      ...
      'ChatGPT para PowerPoint (geralmente disponível em 6 de julho de 2026) permite criar e revisar apresentações diretamente no Microsoft PowerPoint para Enterprise e Edu.'
    ],
    cons: [
  ...
  },
  {
    ...
    pros: [
      ...
      'Conformidade HIPAA agora autogerenciável para organizações Enterprise e API (lançado em 14 de julho de 2026).',
  ...
  },
  {
    ...
    cons: [
      'A API para Gemini 1.5 Pro e 1.5 Flash possui preços escalonados para prompts com contexto muito longo (>128K tokens).',
      ...
      'Modelos anteriores como Gemini 1.0 Pro, 1.0 Ultra, 1.0 Flash foram desativados.'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
    ...
    description: 'A família Gemini do Google é liderada pelos modelos Gemini 1.5 Pro e Gemini 1.5 Flash, oferecendo uma combinação de capacidades avançadas e eficiência. Gemini 1.5 Pro (com 1 milhão de tokens de contexto) é um modelo multimodal poderoso ideal para análise de grandes volumes de informações em texto, imagem, áudio e vídeo, com capacidades de execução de código. Gemini 1.5 Flash é otimizado para velocidade e custo-benefício, ideal para tarefas de alto volume. A plataforma Gemini se integra profundamente com o ecossistema Google, incluindo Workspace, Search e NotebookLM, com novos recursos como Personal Intelligence e o futuro Project Astra para agentes de IA autônomos. Os planos de assinatura Google AI Pro oferecem acesso expandido a modelos e recursos avançados. No entanto, os custos da API para contextos muito longos podem ser mais altos.'
  },
  {
    ...
    pros: [
      ...
      'Ecossistema robusto de provedores de API terceirizados para modelos Llama 3.x, oferecendo custos competitivos (Deepinfra) e velocidade (Groq).'
    ],
    cons: [
  ...
  },
  {
    ...
    pricing: 'Incluso no ChatGPT Plus (US$ 20/mês, com acesso a modelos GPT-5.6 Sol, GPT-5.5 Instant, GPT Image 2.0/1.5). A API para GPT Image 1.5 (substituindo DALL-E 3) custa: US$ 0.04–US$ 0.12 por imagem, dependendo da resolução e qualidade. Usuários gratuitos do ChatGPT têm gerações limitadas (~15/mês).',
    pros: [
  ...
  },
  {
    ...
    pros: [
      ...
      'Integração nativa com os principais modelos de IA, incluindo OpenAI GPT-5.6, GPT-5.5, Anthropic Claude Opus 4.8, Claude Sonnet 5, Google Gemini 1.5 Pro e Gemini 1.5 Flash.',
