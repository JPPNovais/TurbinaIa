...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'Melhorias significativas na memória do ChatGPT, com a introdução de um "memory summary" e o processo de "dreaming" para sintetizar informações de múltiplas conversas, disponível para usuários Plus e Pro a partir de junho de 2026, e estendendo-se a usuários gratuitos nas próximas semanas.'
    ],
    cons: [
      'Modelos anteriores como GPT-4o (e suas variantes), OpenAI o4-mini e as primeiras versões do GPT-5 (Instant e Thinking) foram aposentados do ChatGPT em 13 de fevereiro de 2026 (embora GPT-4o tenha sido reintroduzido para assinantes pagos após reclamações). DALL-E 2 foi aposentado em 12 de maio de 2026. OpenAI o3 será aposentado em 26 de agosto de 2026, e GPT-4.5 em 27 de junho de 2026.',
  ...
  },
  {
    ...
    pricing: 'Incluso no ChatGPT Plus (US$ 20/mês, com acesso a modelos GPT-5.5 e limites de uso; usuários Plus podem gerar até 50 imagens a cada 3 horas). API para gpt-image-2 (lançado em 21 de abril de 2026): Preços da API são baseados em tokens (ex: input US$ 8.00/milhão, output US$ 30.00/milhão), com custo estimado por imagem variando, por exemplo, US$ 0.053 (1024x1024, medium quality). O modo instantâneo de geração de imagem é gratuito para todos os usuários do ChatGPT, com limites dinâmicos (2-3 imagens por 24 horas para usuários free).',
    pros: [
    ...
    cons: [
      ...
      'DALL-E 2 e DALL-E 3 foram oficialmente descontinuados em 12 de maio de 2026. Outros modelos como gpt-image-1-mini e gpt-image-1.5 (e chatgpt-image-latest) serão descontinuados em 1º de dezembro de 2026, com migração forçada para gpt-image-2, o que pode causar múltiplas migrações para desenvolvedores.',
      ...
      'Usuários da API têm enfrentado problemas com limites de taxa (TPM e IPM), incluindo um bug relatado em 5 de junho de 2026, onde o `gpt-image-2-codex` estava esgotando o limite global de RPM, bloqueando a maioria das solicitações de imagem para algumas contas e resultando em erros "model does not exist" inesperados para tarefas de edição de texto.'
    ],
    score: {
      reasoning: 4.9,
