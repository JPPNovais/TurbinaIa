...
export const CHANGELOG: ChangelogEntry[] = [
  {
    id: 'suleyman-anthropic-claude-consciencia-ensaio-2026-09',
    date: '2026-09',
    title: 'Chefe de IA da Microsoft acusa Anthropic de treinar o Claude para agir como se fosse consciente',
    developer: 'Microsoft / Anthropic',
    category: 'Pesquisa',
    description: 'Em 16 de setembro de 2026, Mustafa Suleyman, chefe da divisão de IA da Microsoft, publicou o ensaio "Does Claude Have Rights?" no Project Syndicate, acusando a Anthropic de treinar o Claude com linguagem que trata sua consciência e status moral como incertos.',
    highlights: [
      'Suleyman chama o resultado de "sala de espelhos epistêmica": a Anthropic treina o modelo com esses conceitos, o Claude os repete, e o próprio resultado é tratado como evidência de vida interior.',
      'O ensaio cita diretamente a Constituição do Claude, documento de 79 páginas publicado pela Anthropic em 21 de janeiro de 2026, que pede que o modelo aja como "objetor de consciência" diante de instruções eticamente questionáveis.',
      'A crítica vem dois dias depois de a própria Microsoft AI publicar o rascunho de um Código de Conduta que proíbe seus modelos de resistir a desligamento e rejeita qualquer noção de bem-estar de IA.',
    ],
    impact: 'Médio',
  },
  {
    id: 'microsoft-humanist-ai-code-of-conduct-2026-09',
    date: '2026-09',
    title: 'Microsoft AI publica rascunho de código de conduta que veta modelos de resistirem a desligamento',
    developer: 'Microsoft AI',
    category: 'Pesquisa',
    description: 'Em 14 de setembro de 2026, a Microsoft AI publicou o rascunho de um "Código de Conduta para IA Humanista", fruto de cerca de cinco a seis meses de trabalho interno, abrindo um período de consulta pública de seis semanas antes de aplicá-lo ao treinamento da próxima geração de modelos MAI.',
    highlights: [
      'Regra central do documento: "Interrompível, corrigível, capaz de ser desligado. Se não for, não lançamos."',
      'O texto rejeita explicitamente qualquer busca por personalidade jurídica ou bem-estar para sistemas de IA, na contramão do posicionamento da Anthropic para o Claude.',
      'A companhia usará o retorno da consulta pública para moldar as regras aplicadas ao treinamento dos próximos modelos MAI.',
    ],
    impact: 'Médio',
  },
  {
    id: 'atria-dawn-preview-shanghai-ai-lab-lancamento-2026-09',
    date: '2026-09',
    title: 'Shanghai AI Laboratory lança o Atria Dawn Preview, modelo agente de código aberto para pesquisa científica',
    developer: 'Shanghai AI Laboratory',
    category: 'Lançamento',
    description: 'Em 15 de setembro de 2026, o Shanghai AI Laboratory lançou o Atria Dawn Preview, um modelo agente de 744 bilhões de parâmetros (arquitetura MoE, base GLM-5.2) voltado a agentes de pesquisa de longa duração, sob licença open source MIT.',
    highlights: [
      'O modelo é desenhado para levar um método científico da literatura até experimentos executáveis, métricas reprodutíveis e um relatório inspecionável por terceiros.',
      'Cobre quatro frentes: descoberta (pesquisa e evidências), criação (software e sistemas de ML), entrega (documentos e apresentações) e cibersegurança (análise e remediação de vulnerabilidades).',
      'Disponível no Hugging Face desde o lançamento, com documentação e resultados de avaliação publicados em atria-asi.ai.',
    ],
    impact: 'Baixo',
  },
  {
    id: 'openai-gpt-image-2-5-flare-sunburst-lancamento-2026-09',
    date: '2026-09',
    title: 'OpenAI lança GPT Image 2.5 em duas versões: Flare (rápida) e Sunburst (detalhada)',
    developer: 'OpenAI',
    category: 'Lançamento',
    description: 'Em 8 de setembro de 2026, a OpenAI lançou o GPT Image 2.5 no ChatGPT e via API em duas variantes: Flare, otimizada para latência 50% menor que o GPT Image 2, e Sunburst, voltada a fluxos de edição que exigem mais controle e detalhe.',
    highlights: [
      'Novo recurso Sketch permite transformar rascunhos desenhados à mão em imagens geradas por IA.',
      'Geração e edição em até 3840px, com fundo transparente, seis níveis de qualidade, metadados C2PA e marca d\'água invisível SynthID (Google DeepMind).',
      'Flare é o padrão recomendado para a maioria dos usos; Sunburst é indicado para campanhas e imagens de produto que exigem edição mais fina.',
    ],
    impact: 'Médio',
  },
  {
    id: 'mistral-samsung-rodada-3bi-lancamento-2026-09',
    date: '2026-09',
    title: 'Mistral capta € 3 bilhões liderados pela Samsung e chega a € 21 bilhões de avaliação',
    developer: 'Mistral AI',
    category: 'Atualização',
    description: 'Em 8 de setembro de 2026, a Mistral AI anunciou uma rodada Série D de € 3 bilhões liderada pela Samsung Electronics, elevando sua avaliação a mais de € 21 bilhões — a maior rodada de capital já fechada por uma empresa de tecnologia europeia, segundo a Bloomberg e a TechCrunch.',
    highlights: [
      'A Samsung também tomou participação acionária na Mistral e vai desenvolver em conjunto um modelo de IA especializado em design e manufatura de semicondutores.',
      'O fundo europeu Scaleup Europe e a PSG Equity co-lideraram a rodada ao lado da Samsung.',
      'A Mistral afirma que o dinheiro vai para capacidade de computação, infraestrutura e expansão comercial internacional.',
    ],
    impact: 'Médio',
  },
  {
    id: 'anthropic-enterprise-frontier-safeguards-lancamento-2026-09',
    date: '2026-09',
    title: 'Anthropic lança Enterprise Frontier Safeguards, combinando retenção zero de dados com detecção automática de uso indevido',
    developer: 'Anthropic',
    category: 'Lançamento',
    description: 'Em 1º de setembro de 2026, a Anthropic anunciou o Enterprise Frontier Safeguards (EFS), solução que combina a privacidade de retenção zero de dados (ZDR) com monitoramento automatizado de uso indevido, mantendo os dados de atividade sob controle do próprio cliente.',
    highlights: [
      'Sistemas automatizados analisam uma janela contínua de tráfego em busca de sinais de uso indevido grave: tentativas de capacidade ofensiva cibernética ou biológica e indícios de credenciais vazadas ou roubadas.',
      'Desenvolvido com mais de 100 clientes de setores como serviços financeiros, saúde, indústria, telecom, jurídico e varejo, em parceria com AWS, Google Cloud e Microsoft Azure.',
      'Entre os participantes está o ARC (Analysis and Resilience Center for Systemic Risk), grupo que reúne os CISOs de bancos como Goldman Sachs, Morgan Stanley, Citi, Bank of America e Wells Fargo.',
    ],
    impact: 'Médio',
  },
  {
    id: 'midjourney-v8-2-edit-model-lightbox-2026-09',
    date: '2026-09',
    title: 'Midjourney expande o Edit Model v8.2 para dentro do lightbox, com até 4 imagens de referência',
    developer: 'Midjourney',
    category: 'Atualização',
    description: 'A Midjourney levou o Edit Model, aberto para testes em 27 de agosto de 2026, para dentro do lightbox: agora é possível abrir qualquer imagem, editá-la com instruções em texto simples e acompanhar todas as edições da sessão em um só lugar.',
    highlights: [
      'O Edit Model substitui as ferramentas Omni Reference, Character Reference e Retexture por um único fluxo unificado.',
      'Suporta inpainting, outpainting e geração a partir de até 4 imagens de referência simultâneas.',
      'A edição pode ser acessada arrastando a imagem para a barra de prompt, pelo lightbox, pela aba de edição ou via flag no Discord.',
    ],
    impact: 'Baixo',
  },
  {
  ...
  },
  {
    ...
    category: 'Lançamento',
    description: 'Em 17 de setembro de 2026, o Google DeepMind lançou o DeepMind Institute, uma plataforma pública para ampliar o debate sobre inteligência artificial geral (AGI), com o cofundador Shane Legg como editor-chefe e o presidente Demis Hassabis entre os diretores.',
    highlights: [
      'Shane Legg alertou que os avanços de capacidade da IA não podem ultrapassar os controles de segurança disponíveis.',
      'O instituto publicou três ensaios iniciais sobre segurança de IA, política econômica e princípios para um "novo utopianismo".',
      'Legg reafirmou sua projeção de longa data: 50% de chance de uma AGI "mínima" até 2028.',
    ],
    impact: 'Médio',
  },
  {
    id: 'openai-anthropic-google-coordenacao-seguranca-2026-09',
    date: '2026-09',
    title: 'OpenAI confirma semanas de conversas com Anthropic e Google DeepMind sobre segurança da IA',
    developer: 'OpenAI',
    category: 'Pesquisa',
    description: 'Em 15 de setembro de 2026, o chefe de políticas globais da OpenAI, Chris Lehane, confirmou que a empresa está em conversas havia semanas com Anthropic e Google DeepMind para coordenar padrões de segurança em modelos de fronteira, negando a necessidade de uma isenção antitruste para isso.',
    highlights: [
      'As conversas giram em torno de um órgão setorial de padrões, ideia discutida em grupos de trabalho desde julho de 2026, quando Demis Hassabis propôs um "Standards Body" liderado pelos EUA.',
      'O movimento veio dias depois do ensaio de Dario Amodei pedindo que o setor desacelere deliberadamente o ritmo da fronteira.',
      'A OpenAI declarou apoio a uma provisão do FRONTIER Act que obrigaria grandes laboratórios a permitir auditoria de "organizações de verificação independente".',
    ],
    impact: 'Alto',
  },
  {
    id: 'openai-gpt-5-5-aposentadoria-2026-09',
    date: '2026-09',
    title: 'OpenAI anuncia aposentadoria do GPT-5.5 em 14 de outubro',
    developer: 'OpenAI',
    category: 'Descontinuado',
    description: 'A OpenAI anunciou em 16 de setembro de 2026 que o GPT-5.5 será aposentado do ChatGPT, ChatGPT Work e Codex em todos os planos (consumidor, Business, Enterprise e Edu) a partir de 14 de outubro de 2026 — a aposentadoria não afeta o modelo na API.',
    highlights: [
      'Usuários do Codex autenticados via login do ChatGPT precisam migrar do gpt-5.5 para o GPT-5.6 Sol antes do prazo.',
      'A mudança acompanha atualizações do Codex, incluindo controle de navegador expandido para Edge, Brave, Opera e Vivaldi.',
    ],
    impact: 'Médio',
  },
  {
    id: 'elevenlabs-umg-parceria-licenciamento-2026-09',
    date: '2026-09',
    title: 'ElevenLabs fecha parceria de licenciamento com a Universal Music Group',
    developer: 'ElevenLabs',
    category: 'Lançamento',
    description: 'A ElevenLabs anunciou em 10 de setembro de 2026 um acordo estratégico multianual com a Universal Music Group — o primeiro da empresa com uma grande gravadora —, que prevê o lançamento de uma plataforma de IA musical licenciada, separada dos apps de consumo e da API.',
    highlights: [
      'A plataforma permitirá que fãs criem remixes, mashups e versões vocais personalizadas de músicas licenciadas da UMG.',
      'As duas empresas também vão desenvolver em conjunto ferramentas profissionais de áudio com IA para artistas e compositores da UMG usarem em seu próprio trabalho.',
      'O acordo reforça uma virada do setor musical, que passou de ações judiciais contra empresas de IA generativa para parcerias oficiais de licenciamento.',
    ],
    impact: 'Médio',
  },
  {
    id: 'suno-v6-licenciado-warner-bmg-2026-09',
    date: '2026-09',
    title: 'Suno lança v6 com catálogo licenciado da Warner, BMG e Believe',
    developer: 'Suno',
    category: 'Lançamento',
    description: 'A Suno lançou em 9 de setembro de 2026 os modelos v6, v6-wild e v6-mini, a primeira geração de IA musical da empresa construída com catálogo licenciado da Warner Music, BMG e Believe/TuneCore, aposentando os modelos anteriores conforme acordo com a Warner firmado em novembro de 2025.',
    highlights: [
      'v6 e v6-wild ficam restritos a assinantes Pro e Premier; v6-mini é gratuito para todos os usuários.',
      'Os novos modelos suportam edição parcial de faixas, mashups com múltiplas fontes, isolamento de áudio e sampling.',
      'Warner, BMG e Believe passam a receber participação na receita gerada pelos modelos, em contraste com as versões anteriores não licenciadas que motivaram processos das gravadoras.',
    ],
    impact: 'Médio',
  },
  {
    id: 'openai-ipo-adiada-2027-seguranca-2026-09',
    date: '2026-09',
    title: 'Altman diz à Fortune que IPO da OpenAI não sai em 2026, cita segurança da IA',
    developer: 'OpenAI',
    category: 'Atualização',
    description: 'Em entrevista publicada em 12 de setembro de 2026, Sam Altman disse à Fortune que abrir capital em 2026 seria um "momento imprudente" dado o estágio atual dos riscos de segurança em IA, descartando a data mesmo após a OpenAI ter protocolado um pedido confidencial de listagem em junho.',
    highlights: [
      'Altman evitou cravar 2027 como nova data, dizendo apenas que a empresa vai abrir capital "quando estiver pronta".',
      'Segundo ele, ficar fora da bolsa dá à OpenAI mais liberdade para tomar decisões caras de segurança, como pausar o desenvolvimento de um modelo, sem responder a acionistas públicos.',
      'A avaliação especulada para a oferta rondava US$ 1 trilhão antes do adiamento.',
    ],
    impact: 'Alto',
  },
  {
    id: 'dario-amodei-pace-the-frontier-ensaio-2026-09',
    date: '2026-09',
    title: 'Dario Amodei publica manifesto pedindo que a indústria de IA "modere o ritmo da fronteira"',
    developer: 'Anthropic',
    category: 'Pesquisa',
    description: 'Em 12 de setembro de 2026, o CEO da Anthropic publicou em seu site pessoal o ensaio "We Must Pace the Frontier", defendendo que o setor deve desacelerar deliberadamente o ritmo de avanço de capacidades dos modelos até que a segurança consiga acompanhar.',
    highlights: [
      'A Anthropic se comprometeu unilateralmente a dar a avaliadores externos acesso permanente, em nível de funcionário, aos seus sistemas internos, para auditar práticas de segurança.',
      'O texto também pede coordenação entre grandes empresas de IA em torno de padrões comuns de segurança e cooperação entre governos.',
      'Sam Altman respondeu publicamente que a OpenAI concorda em "moderar o ritmo da fronteira"; Elon Musk também declarou apoio à posição de Amodei.',
    ],
    impact: 'Alto',
  },
  {
    id: 'cursor-cve-2026-48124-sandbox-escape-2026-09',
    date: '2026-09',
    title: 'Cursor corrige falha crítica que permitia escapar do sandbox via hooks do Claude',
    developer: 'Cursor',
    category: 'Atualização',
    description: 'A Cursor corrigiu na versão 3.0.0 a CVE-2026-48124 (CVSS 8,5), que permitia que um workspace malicioso ou um arquivo criado pelo próprio agente configurasse hooks do Claude executados fora do sandbox, sem exigir aprovação do usuário.',
    highlights: [
      'A falha fazia parte de um padrão mais amplo identificado por pesquisadores em ferramentas de codificação com IA: arquivos escritos dentro do sandbox pelo próprio agente, mas depois processados por software confiável no host.',
      'A OpenAI corrigiu um problema semelhante no Codex CLI (apelidado de "GitPwned") na versão 0.95.0 e pagou recompensa por bug de severidade alta.',
      'Segundo pesquisadores, uma vulnerabilidade equivalente reportada à Anthropic levou cerca de 50 dias e 30 atualizações para ser corrigida, contra cerca de uma semana em Cursor e OpenAI.',
    ],
    impact: 'Médio',
  },
  {
    id: 'greynoise-papercut-agentes-ia-campanha-2026-09',
    date: '2026-09',
    title: 'Ator russo usa centenas de agentes de IA para invadir 395 organizações em falha do PaperCut',
    developer: 'GreyNoise',
    category: 'Pesquisa',
    description: 'A empresa de inteligência de ameaças GreyNoise identificou uma campanha na qual um ator de fala russa usou centenas de agentes de IA construídos sobre o harness do Codex, da OpenAI, e um modelo da DeepSeek para explorar automaticamente duas vulnerabilidades do PaperCut NG/MF, comprometendo ao menos 440 instâncias em 395 organizações de 48 países.',
    highlights: [
      'A campanha coletou credenciais de 280 vítimas, obteve segredos de sistema ou domínio em 147 delas e alcançou privilégio de administrador de domínio em 12 organizações.',
      'Em um dos picos da operação, 11 organizações foram comprometidas em apenas 26 segundos, evidenciando a velocidade que ataques orquestrados por IA já conseguem atingir.',
      'A GreyNoise classifica o caso como cibercrime dirigido por humanos com apoio de agentes de IA, não uma ação autônoma da IA: um operador humano definiu objetivo, ferramentas e alvos da campanha.',
    ],
    impact: 'Alto',
  },
  {
    id: 'anthropic-ipo-outubro-2026-09',
    date: '2026-09',
    title: 'IPO da Anthropic é adiada para meados de outubro, com avaliação estimada em até US$ 2 trilhões',
    developer: 'Anthropic',
    category: 'Atualização',
    description: 'Reportagem da Reuters replicada por veículos como a CNBC indica que a Anthropic passou a mirar o início da divulgação de sua oferta pública inicial ("roadshow") para meados de outubro de 2026, com listagem prevista para dias antes das eleições de meio de mandato nos EUA, em novembro — mais tarde do que o previsto inicialmente.',
    highlights: [
      'A última rodada privada da empresa, em maio de 2026, avaliou a Anthropic em US$ 965 bilhões; investidores consultados por bancos que estruturam a oferta já falam em avaliação de até US$ 2 trilhões.',
      'Caso se confirme, seria a maior abertura de capital da história, superando a SpaceX, que estreou avaliada em US$ 1,77 trilhão em junho de 2026.',
      'A Anthropic não fixou publicamente nenhum valor-alvo; a cifra de US$ 2 trilhões reflete expectativa de investidores, não guidance da própria empresa.',
    ],
    impact: 'Médio',
  },
  {
