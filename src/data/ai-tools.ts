...
export const AI_TOOLS: AITool[] = [
  // Texto & Redação
  {
    ...
    description:
      'ChatGPT Plus é a versão premium do modelo GPT-5.5 da OpenAI, com acesso a plugins, navegação web e geração de imagens. É o assistente conversacional mais versátil disponível, excelente para redação, análise e brainstorming.',
    useCases: [
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (uso limitado, com anúncios); Go a US$ 8/mês (com ads e limitações); Plus a US$ 20/mês (acesso a GPT-5.5, Deep Research, Sora video, Codex e Agent Mode); Pro a US$ 100/mês (5x uso do Plus, acesso a GPT-5.5 Pro); Pro a US$ 200/mês (20x uso do Plus, 1M token contexto, o1 Pro mode); Business a US$ 20-25/usuário/mês; Enterprise sob consulta. API GPT-4o a US$ 2.50/M tokens entrada e US$ 10.00/M tokens saída.',
  ...
  },
  {
    ...
    description:
      'Claude é o assistente de IA da Anthropic, reconhecido por suas capacidades de raciocínio avançado, escrita de alta qualidade e janela de contexto de até 1.000.000 tokens. Destaca-se em análises longas, redação técnica e tarefas que exigem precisão.',
    useCases: [
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (com Claude Sonnet 4.6, uso limitado); Pro a US$ 20/mês (US$ 17/mês anual); Max 5x a US$ 100/mês; Max 20x a US$ 200/mês. API (pay-per-token): Haiku 4.5 US$ 1.00/US$ 5.00 por M tokens (entrada/saída); Sonnet 4.6 US$ 3.00/US$ 15.00 por M tokens; Opus 4.7 US$ 5.00/US$ 25.00 por M tokens.',
    url: 'https://claude.ai',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (com Gemini 3.5 Flash, uso limitado de 2.5 Pro); Google AI Plus a US$ 7.99/mês; Google AI Pro a US$ 19,99/mês (acesso a Gemini 3.1 Pro, Deep Research, 5 TB de armazenamento, 1.000 créditos AI/mês, integração Workspace, acesso a Veo 3.1); Google AI Ultra a US$ 249,99/mês. API: Gemini 2.5 Pro a US$ 1.25/M tokens entrada e US$ 10.00/M tokens saída; Gemini 2.5 Flash a US$ 0.15/M tokens entrada e US$ 0.60/M tokens saída.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (Hobby, 2.000 completions/mês, 50 requisições premium lentas); Pro a US$ 20/mês (US$ 16/mês anual, 500 requisições premium rápidas, uso ilimitado de auto mode e $20 em créditos); Pro+ a US$ 60/mês (3x créditos do Pro); Ultra a US$ 200/mês (20x créditos do Pro); Teams a US$ 40/usuário/mês (US$ 32/usuário/mês anual); Enterprise sob consulta.',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Acesso via planos Claude Pro (US$ 20/mês), Max 5x (US$ 100/mês) ou Max 20x (US$ 200/mês) com limites de uso. A partir de 15 de junho de 2026, o uso de agentes SDK via APIs de terceiros terá um crédito mensal separado, sendo cobrado à parte após o limite. Pago por uso via API Anthropic: Sonnet US$ 3.00/US$ 15.00 por M tokens (entrada/saída); Opus US$ 5.00/US$ 25.00 por M tokens. Não há plano gratuito ou trial para a ferramenta de terminal.',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Incluso no ChatGPT Plus (US$ 20/mês), Pro (US$ 100/mês ou US$ 200/mês), Business e Enterprise com diferentes limites de uso. Preços para API (token-based a partir de 2 de abril de 2026): GPT-5.3-Codex-Spark (research preview), GPT-5.1-Codex-Max, GPT-5.1-Codex-Mini, com custos variando por milhão de tokens (entrada/saída) e taxa por container para Cloud tasks.',
  ...
  // Imagens
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (uso limitado via ChatGPT, 2 imagens/dia); Incluso no ChatGPT Plus (US$ 20/mês, 50 gerações por 3 horas, acesso a DALL-E 4); API a partir de US$ 0,040-0,080/imagem (1024x1024, qualidade padrão).',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Incluso no Google AI Pro (US$ 19,99/mês) e Google AI Ultra (US$ 249,99/mês), com uso gratuito limitado via Gemini Apps.',
  ...
  // Vídeo
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Incluso no ChatGPT Plus (US$ 20/mês, acesso ilimitado a 480p até 10s); ChatGPT Pro (US$ 200/mês, 10.000 créditos para ~500 vídeos prioritários em 480p, ~50 vídeos em 1080p). API: Sora 2 (Standard) a US$ 0.10/segundo (720p); Sora 2 Pro a US$ 0.30/segundo (720p) ou US$ 0.50/segundo (1024p).',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Disponível através de Google AI Pro a US$ 19,99/mês (acesso a Veo 3.1 e Flow editor); Google AI Ultra a US$ 249,99/mês (acesso a Veo 3 e Flow video editor); APIs do Google AI Studio/Vertex AI (Veo 3: US$ 0.40/segundo; Veo 3 Fast: US$ 0.15/segundo).',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (1 hora de mídia/mês, marca d\'água, sem créditos AI); Hobbyist a US$ 24/mês (US$ 16/mês anual, 10 horas de mídia); Creator a US$ 35/mês (US$ 24/mês anual, 30 horas de mídia); Business a US$ 65/mês (US$ 50/mês anual, 40 horas de mídia); Enterprise sob consulta.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis para uso básico (100 notebooks, 50 fontes/notebook, 50 chats diários, 500.000 palavras/notebook); NotebookLM Plus via Google AI Plus (US$ 7.99/mês); NotebookLM Pro via Google AI Pro (US$ 19,99/mês, 500 notebooks, 300 fontes/notebook, 500 chats diários, 20 Audio/Video Overviews/dia); NotebookLM Ultra via Google AI Ultra (US$ 249,99/mês).',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Open source e auto-hospedagem gratuita (paga apenas pelo servidor, ~US$ 3-7/mês); Cloud Starter a €24/mês (2.500 execuções); Cloud Pro a €60/mês (10.000 execuções); Cloud Business a €800/mês (40.000 execuções, SSO); Enterprise sob consulta (a partir de €20.000/ano para 600.000 tokens/créditos).',
    url: 'https://n8n.io',
