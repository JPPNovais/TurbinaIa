...
export const aiModels: AIModel[] = [
  {
    ...
    cons: [
      ...
      'Apesar das melhorias, os modelos ainda podem gerar respostas imprecisas ou alucinações. O custo da API para GPT-5.6 Sol é alto, especialmente para tokens de saída.',
      ...
      'A precificação de contexto longo para GPT-5.6 na API (acima de 272K tokens de entrada) é mais cara (2x entrada / 1.5x saída).',
  ...
  },
  {
    ...
    cons: [
      ...
      'Claude Sonnet 5 utiliza um tokenizer atualizado que pode mapear para aproximadamente 1.0–1.35x mais tokens para o mesmo input, dependendo do conteúdo, o que pode aumentar o custo real da tarefa.',
