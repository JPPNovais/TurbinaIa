...
export const AI_MODELS: CalculatorModel[] = [
  // Google
  {
    ...
    description: 'O modelo Pro mais recente da Google, com raciocínio avançado e contexto de até 1M tokens (2M em preview). Preços baseados na precificação do Gemini 1.5 Pro a partir de Julho de 2026 para contextos acima de 128K tokens. Para contextos até 128K, os preços são $3.50/M de entrada e $10.50/M de saída.',
  },
  {
    name: 'Gemini 1.5 Flash',
    provider: 'Google',
    inputPricePerM: 0.70,
    outputPricePerM: 2.10,
    contextWindow: '1M tokens',
    description: 'O modelo Flash da Google, otimizado para tarefas de alta frequência e baixo custo, com até 1M de contexto. É o modelo mais econômico da série Gemini 1.5. Preços baseados na precificação do Gemini 1.5 Flash a partir de Julho de 2026 para contextos acima de 128K tokens. Para contextos até 128K, os preços são $0.35/M de entrada e $1.05/M de saída.',
  },
  // OpenAI
  {
    name: 'GPT-5.6 Sol',
  ...
  },
  {
    ...
    contextWindow: '1M tokens',
    description: 'O modelo GPT-5.6 Terra da OpenAI, que equilibra inteligência e custo. Preços e janela de contexto baseados na precificação do GPT-5.6 Terra a partir de Julho de 2026, para contextos menores que o limite de longo contexto. Para contextos longos, os preços são $4.00/M de entrada e $18.00/M de saída.',
  },
  {
    name: 'GPT-5.6 Luna',
    provider: 'OpenAI',
  ...
  // Anthropic
  {
    ...
    description: 'O modelo mais inteligente da família Claude da Anthropic (Claude 3 Opus), para raciocínio complexo e tarefas agênticas, com 200K de contexto. Preços e janela de contexto baseados no Claude 3 Opus a partir de Julho de 2026.',
  },
  {
