...
export const aiModels: AIModel[] = [
  ...
  },
  {
    ...
    cons: [
      'Claude Sonnet 5 terá seu preço padrão (US$ 3/milhão de tokens de entrada e US$ 15/milhão de tokens de saída) a partir de 1º de setembro de 2026, encerrando o preço promocional (US$ 2/milhão de tokens de entrada e US$ 10/milhão de tokens de saída até 31 de agosto de 2026).',
