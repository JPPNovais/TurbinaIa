...
export const aiModels: AIModel[] = [
  {
    ...
    pricing: 'Plano gratuito disponível (acesso limitado a GPT-5.5 Instant para funções básicas, com limites de mensagens; inclui anúncios nos EUA e para usuários Go). ChatGPT Go: US$ 8/mês (lançado em 15 de janeiro de 2026; acesso a GPT-5.5 Instant com limites de 160 mensagens/3 horas). ChatGPT Plus: US$ 20/mês (acesso total a GPT-5.5 Instant e GPT-5.5 Thinking Mode como padrão; inclui Deep Research - 10 execuções/mês, Codex com Computer Use no Windows, Agent Mode, Advanced Voice Mode, Custom GPTs, DALL-E 4; limite de 160 mensagens/3 horas para GPT-5.5 Thinking e 80 uploads de arquivos/3 horas). ChatGPT Pro ($100): US$ 100/mês (lançado em 9 de abril de 2026; acesso a GPT-5.5, GPT-5.5 Pro e o1 Pro mode; 50 execuções de Deep Research/mês, 5x os limites do Plus, e uma promoção de lançamento de 10x uso do Codex até 31 de maio de 2026, depois 5x). ChatGPT Pro ($200): US$ 200/mês (acesso ilimitado a GPT-5.5 Thinking, GPT-5.5 Pro e o1 Pro mode; 250 execuções de Deep Research/mês, Deep Think para raciocínio ilimitado, janela de contexto de 1 milhão de tokens, acesso prioritário a novos recursos, uso máximo de todos os recursos). ChatGPT Business: US$ 20/usuário/mês (anual, mínimo de 2 usuários) ou US$ 25-30/usuário/mês (mensal, mínimo de 2 usuários); o preço anual caiu de US$ 25 para US$ 20 em 2 de abril de 2026; inclui acesso ilimitado a GPT-5.5 Thinking e GPT-5.5 Pro, workspaces compartilhados. ChatGPT Enterprise: Preço personalizado (contato com vendas), mínimo de 150 usuários. API para GPT-5.4 Mini: US$ 0.75/milhão de tokens de entrada e US$ 4.50/milhão de tokens de saída. API para GPT-5.4 Standard: US$ 2.50/milhão de tokens de entrada e US$ 15.00/milhão de tokens de saída. API para GPT-5.5: US$ 5.00/milhão de tokens de entrada e US$ 30.00/milhão de tokens de saída (lançado em 23 de abril de 2026). API para GPT-5.5 Pro: US$ 30.00/milhão de tokens de entrada e US$ 180.00/milhão de tokens de saída (lançado em 23 de abril de 2026). API para gpt-image-2 (DALL-E 4): US$ 8.00/milhão de tokens de entrada e US$ 30.00/milhão de tokens de saída, com custo estimado por imagem variando (ex: US$ 0.053 para 1024x1024, qualidade média). A API em lote (Batch API) oferece 50% de desconto nas taxas padrão.',
    pros: [
      'GPT-5.5 Instant (lançado em 5 de maio de 2026) é o modelo padrão do ChatGPT para todos os usuários, oferecendo respostas 4x mais rápidas, precisas e com menos alucinações (52.5% de redução em afirmações alucinadas em prompts de alto risco), com melhorias no estilo e qualidade de resposta em 28 de maio de 2026.',
    ...
    cons: [
      ...
      'O plano Go (US$ 8/mês) e o plano gratuito exibem anúncios nos EUA.',
