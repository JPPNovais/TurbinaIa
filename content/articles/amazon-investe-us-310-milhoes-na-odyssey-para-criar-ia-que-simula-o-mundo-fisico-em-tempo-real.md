---
title: "Amazon Investe US$ 310 Milhões na Odyssey para Criar IA que Simula o Mundo Físico em Tempo Real"
description: "Amazon lidera rodada de US$ 310 mi na Odyssey ML: a startup que cria mundos 3D simulados por IA. Entenda os world models e por que Nvidia, AMD e a CIA"
category: noticias
tags:
  - World Models
  - Amazon AWS
...
Para entender o que a Amazon está comprando, é preciso primeiro entender o que a Odyssey constrói. Diferente dos grandes modelos de linguagem (LLMs) como o [ChatGPT](/blog/chatgpt-vs-gemini-vs-claude-qual-a-melhor-ia-em-2026) ou o Gemini, que aprendem padrões estatísticos em texto, os *world models* são treinados em **física, causa e efeito, e relações espaciais entre objetos**.

"Pegamos uma construção semelhante ao cérebro humano e só ensinamos a linguagem", disse [Jay Zaveri, parceiro da Natural Capital](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/), a firma que liderou o investimento. Para ele, os *world models* representam uma "segunda onda da IA", destinada a revolucionar indústrias que vão da robótica ao entretenimento.
...
Numa demonstração revelada durante o anúncio, Oliver Cameron, CEO da Odyssey, mostrou o modelo recriando uma versão multiplayer do jogo *GoldenEye*, de 1997, a partir apenas de "pixels, ações e sons" — sem nenhum conhecimento prévio da física ou das regras do jogo original. Já em maio de 2025, conforme [reportou o TechCrunch](https://techcrunch.com/2025/05/28/odysseys-new-ai-model-streams-3d-interactive-worlds/), a empresa havia lançado uma demonstração pública em que o modelo gerava e transmitia frames de vídeo a cada 40 milissegundos, permitindo que usuários "explorassem" ambientes como se estivessem dentro de um jogo 3D.


![Imagem ilustrativa sobre Amazon Investe US$ 310 Milhões na Odyssey para Criar IA que Simula o Mundo Físico em Tempo Real](https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1200&q=80)
...
"Meu objetivo é poder dizer ao meu filho que construí o melhor acelerador de IA do mundo", declarou [Ron Diamant, vice-presidente da AWS](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/), ao comentar a parceria. A afirmação soa ambiciosa — especialmente porque os modelos da Odyssey ainda rodam nos chips H200 e B200 da Nvidia, com custo entre **US$ 2 e US$ 4 por hora de uso por pessoa** (sem incluir o custo de treinamento). A transição para Trainium, portanto, é uma aposta no futuro — tanto da Odyssey quanto dos chips da Amazon.

O CEO da Amazon, Andy Jassy, tem apostado pesadamente em IA. Além do investimento na Odyssey, ele já comprometeu até [US$ 83 bilhões na Anthropic](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/) e afirmou a investidores no início deste ano que a empresa tinha aproximadamente US$ 225 bilhões em contratos pendentes para chips Trainium. O fundador Jeff Bezos, por sua vez, está desenvolvendo sua própria startup de IA, chamada **Prometheus**.

Se quiser explorar como diferentes modelos de IA se comparam em termos de custo e desempenho, o [Comparador de IAs](/comparador) do Turbina IA reúne as principais opções disponíveis no mercado — incluindo aceleradores e APIs para desenvolvedores.
...
"Nossos modelos terão uma compreensão muito mais completa do mundo — física, linguagem corporal, dinâmicas — todas as coisas que existem no mundo e que a linguagem não captura realmente", disse [Cameron ao Irish Times](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/) nesta terça.
...
![Imagem ilustrativa sobre Amazon Investe US$ 310 Milhões na Odyssey para Criar IA que Simula o Mundo Físico em Tempo Real](https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80)
...
Luna Schmid, parceira da GV com sede em Londres — que também participou desta rodada —, usou uma metáfora precisa para descrever o que a infusão de capital pode significar: o investimento pesado em treinamento e execução de *world models* vai ajudar a desbloquear um "[momento GPT-3](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/)" para o campo.
...
O próprio Oliver Cameron foi transparente sobre os limites atuais: na demonstração de maio de 2025, registrada pelo [TechCrunch](https://techcrunch.com/2025/05/28/odysseys-new-ai-model-streams-3d-interactive-worlds/), o ambiente gerado era borrado, distorcido e instável — se o usuário caminhasse numa direção por tempo suficiente ou virasse, os arredores podiam mudar de aparência. A empresa reconheceu os problemas e prometeu melhorias rápidas.
...
Mas o espectro de aplicações vai além. Ao custo de entre US$ 2 e US$ 4 por hora de uso, conforme [informado pelo Irish Times](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/), a Odyssey já permite que usuários interajam com ambientes gerados. Isso abre portas para:
...
Para quem desenvolve aplicações com IA e quer entender como calcular os custos de inferência e uso por hora, a [Calculadora de Custos de IA](/calculadora) do Turbina IA oferece uma comparação atualizada entre os principais provedores.
...
- [Amazon backs AI start-up developing models to simulate physical world — The Irish Times](https://www.irishtimes.com/business/2026/06/17/amazon-backs-ai-start-up-developing-models-to-simulate-physical-world/)
- [After taking Nvidia's money, Odyssey raises $310M and bets on Amazon and AMD instead — TechFundingNews](https://techfundingnews.com/odyssey-310m-series-b-nvidia-amazon-amd-ai-world-models/)
- [Odyssey's new AI model streams 3D interactive worlds — TechCrunch](https://techcrunch.com/2025/05/28/odysseys-new-ai-model-streams-3d-interactive-worlds/)