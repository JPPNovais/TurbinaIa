...
export const aiModels: AIModel[] = [
  {
    ...
    pricing: 'Plano gratuito disponível (com anúncios para usuários nos EUA desde 9 de fevereiro de 2026, acesso limitado a GPT-5.5 Instant no chat padrão, acesso à GPT-5.6 Terra em ChatGPT Work e Codex, 10 mensagens/5h, acesso à GPT Store). ChatGPT Go: US$ 8/mês (lançado globalmente em 15 de janeiro de 2026, com anúncios nos EUA, mais mensagens que o gratuito, upload de arquivos, criação de imagens (Images 2.0 Instant Mode), memória aprimorada, Custom GPTs, Projects, Tasks, Library, acesso à GPT-5.6 Terra em ChatGPT Work e Codex). ChatGPT Plus: US$ 20/mês (acesso a GPT-5.6 Sol no chat padrão e a todos os modelos GPT-5.6 em Work/Codex, 160 mensagens/3h; inclui GPT Image 2.0, navegação na web, análise de dados avançada, Custom GPTs e recursos de memória, modo Thinking com raciocínio, pesquisa na web e consistência de personagem, Deep Research (10 runs/mês)). ChatGPT Pro US$ 100: US$ 100/mês (lançado em 9 de abril de 2026, 50 sessões de Deep Research/mês, 5x uso Plus em GPT-5.6 Sol/Sol Pro, acesso prioritário a modelos mais recentes, 5x uso Codex, ultra mode para Codex). ChatGPT Pro US$ 200: US$ 200/mês (lançado no I/O 2026, 20x uso Plus, janela de contexto de 1M tokens com GPT-5.6 Sol, acesso a Operator - agente web autônomo, ultra mode para Work/Codex). ChatGPT Business: US$ 20/usuário/mês (anual, mínimo de 2 usuários) ou US$ 25/usuário/mês (mensal, mínimo de 2 usuários) (acesso a GPT-5.6 Sol e Sol Pro, e todos os modelos GPT-5.6 em Work/Codex). ChatGPT Enterprise: Preço personalizado (contato com vendas, mínimo de 150 usuários, média de US$ 60/usuário/mês, acesso a GPT-5.6 Sol Pro, e todos os modelos GPT-5.6 em Work/Codex). ChatGPT para Educação: Standard tier é gratuito para professores, estudantes e funcionários elegíveis (acesso a modelos GPT-5.x class e recursos equivalentes ao plano Enterprise de US$ 20/mês). O plano Pro pago oferece limites de uso mais altos (comparável ao plano Enterprise de US$ 200/mês). API para GPT-5.6 Sol: US$ 5.00/milhão de tokens de entrada e US$ 30.00/milhão de tokens de saída (context window 1.05M tokens). API para GPT-5.6 Terra: US$ 2.00/milhão de tokens de entrada e US$ 12.00/milhão de tokens de saída (redução de 20% em 30 de julho de 2026, context window 1.05M tokens). API para GPT-5.6 Luna: US$ 0.20/milhão de tokens de entrada e US$ 1.20/milhão de tokens de saída (redução de 80% em 30 de julho de 2026, context window 1.05M tokens). API para GPT-5.5: US$ 5.00/milhão de tokens de entrada e US$ 30.00/milhão de tokens de saída (context window 1.05M tokens). Preço para contexto longo: US$ 10.00/milhão de tokens de entrada e US$ 45.00/milhão de tokens de saída. Cached input para GPT-5.5: US$ 0.50/milhão de tokens. API para GPT-5.5 Pro: US$ 30.00/milhão de tokens de entrada e US$ 180.00/milhão de tokens de saída. Preço para contexto longo: US$ 60.00/milhão de tokens de entrada e US$ 270.00/milhão de tokens de saída. API para GPT-5.4: US$ 2.50/milhão de tokens de entrada e US$ 15.00/milhão de tokens de saída. Preço para contexto longo: US$ 5.00/milhão de tokens de entrada e US$ 22.50/milhão de tokens de saída. Cached input para GPT-5.4: US$ 0.25/milhão de tokens. API para GPT-5.4 mini: US$ 0.75/milhão de tokens de entrada e US$ 4.50/milhão de tokens de saída. Cached input para GPT-5.4 mini: US$ 0.075/milhão de tokens. API para GPT-5.4 Nano: US$ 0.20/milhão de tokens de entrada e US$ 1.25/milhão de tokens de saída. Cached input para GPT-5.4 Nano: US$ 0.02/milhão de tokens. Cached input para GPT-5.6 (writes): 1.25x taxa de input não armazenado em cache. Cached input para GPT-5.6 (reads): 90% de desconto. Batch API para GPT-5.x: (50% de desconto em todos os custos de token), aplicado a todos os modelos.',
    pros: [
      ...
      'GPT-5.5 Instant é o modelo padrão para usuários dos planos Free e Go no chat padrão, com estilo de resposta aprimorado e qualidade melhorada (atualizado em 28 de maio de 2026), sendo mais natural, fácil de ler e com menos respostas longas ou com muitas listas.',
