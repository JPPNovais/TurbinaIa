...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'O programa ChatGPT para pequenas empresas (lançado em 21 de julho de 2026) visa ajudar empreendedores a serem mais produtivos e escalar seus negócios com o ChatGPT.',
      'Lançamento do Health in ChatGPT (23 de julho de 2026) para apoiar o uso de IA na saúde.'
    ],
    cons: [
  ...
  },
  {
    ...
    pros: [
      ...
      'Gemini 3.6 Flash (lançado em 21 de julho de 2026) oferece um custo por token de saída reduzido (US$ 7.50/milhão de tokens) e maior eficiência de tokens (até 65% menos tokens de saída em cargas de trabalho de codificação agenticas) em comparação com o Gemini 3.5 Flash.',
