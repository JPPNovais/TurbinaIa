...
export const aiModels: AIModel[] = [
  {
    ...
    pricing: 'Plano gratuito disponível (com anúncios para usuários nos EUA desde 9 de fevereiro de 2026, acesso limitado a GPT-5.5 Instant no chat padrão, acesso à GPT-5.6 Terra em ChatGPT Work e Codex, 10 mensagens/5h, acesso à GPT Store). ChatGPT Go: US$ 8/mês (lançado globalmente em 15 de janeiro de 2026, com anúncios nos EUA, mais mensagens que o gratuito, upload de arquivos, criação de imagens (Images 2.0 Instant Mode), memória aprimorada, Custom GPTs, Projects, Tasks, Library, acesso à GPT-5.6 Terra em ChatGPT Work e Codex). ChatGPT Plus: US$ 20/mês (acesso a GPT-5.6 Sol no chat padrão e a todos os modelos GPT-5.6 em Work/Codex, 160 mensagens/3h; inclui GPT Image 2.0, navegação na web, análise de dados avançada, Custom GPTs e recursos de memória, modo Thinking com raciocínio, pesquisa na web e consistência de personagem, Deep Research (10 runs/mês)). ChatGPT Pro US$ 100: US$ 100/mês (lançado em 9 de abril de 2026, 50 sessões de Deep Research/mês, 5x quota Plus em GPT-5.6 Sol/Sol Pro, acesso prioritário a modelos mais recentes, 5x Codex usage após 31 de maio de 2026, ultra mode para Codex). ChatGPT Pro US$ 200: US$ 200/mês (lançado no I/O 2026, 20x mais limites que o Pro US$100, janela de contexto de 1M tokens com GPT-5.6 Sol e GPT-5.4, acesso a Operator - agente web autônomo, ultra mode para Work/Codex). ChatGPT Business: US$ 20/usuário/mês (anual, mínimo de 2 usuários) ou US$ 25/usuário/mês (mensal, mínimo de 2 usuários) (acesso a GPT-5.6 Sol e Sol Pro, e todos os modelos GPT-5.6 em Work/Codex). ChatGPT Enterprise: Preço personalizado (contato com vendas, mínimo de 150 usuários, média de US$ 60/usuário/mês, acesso a GPT-5.6 Sol Pro, e todos os modelos GPT-5.6 em Work/Codex). ChatGPT para Educação: Standard tier é gratuito para professores, estudantes e funcionários elegíveis (acesso a modelos GPT-5.x class e recursos equivalentes ao plano Enterprise de US$ 20/mês). O plano Pro pago oferece limites de uso mais altos (comparável ao plano Enterprise de US$ 200/mês). API para GPT-5.6 Sol: US$ 5.00/milhão de tokens de entrada e US$ 30.00/milhão de tokens de saída (context window 1.05M tokens). Preço para contexto longo: US$ 10.00/milhão de tokens de entrada e US$ 45.00/milhão de tokens de saída. API para GPT-5.6 Terra: US$ 2.00/milhão de tokens de entrada e US$ 12.00/milhão de tokens de saída (redução de 20% em 30 de julho de 2026, context window 1.05M tokens). Preço para contexto longo: US$ 4.00/milhão de tokens de entrada e US$ 18.00/milhão de tokens de saída. API para GPT-5.6 Luna: US$ 0.20/milhão de tokens de entrada e US$ 1.20/milhão de tokens de saída (redução de 80% em 30 de julho de 2026, context window 1.05M tokens). Preço para contexto longo: US$ 0.40/milhão de tokens de entrada e US$ 1.80/milhão de tokens de saída. API para GPT-5.5: US$ 5.00/milhão de tokens de entrada e US$ 30.00/milhão de tokens de saída (context window 1.05M tokens). Preço para contexto longo: US$ 10.00/milhão de tokens de entrada e US$ 45.00/milhão de tokens de saída. Cached input para GPT-5.5: US$ 0.50/milhão de tokens. Long-context pricing para GPT-5.5 (prompts acima de 272K tokens de entrada): 2x entrada. API para GPT-5.5 Pro: US$ 30.00/milhão de tokens de entrada e US$ 180.00/milhão de tokens de saída. Preço para contexto longo: US$ 60.00/milhão de tokens de entrada e US$ 270.00/milhão de tokens de saída. API para GPT-5.4: US$ 2.50/milhão de tokens de entrada e US$ 15.00/milhão de tokens de saída. Preço para contexto longo: US$ 5.00/milhão de tokens de entrada e US$ 22.50/milhão de tokens de saída. Cached input para GPT-5.4: US$ 0.25/milhão de tokens. API para GPT-5.4 mini: US$ 0.75/milhão de tokens de entrada e US$ 4.50/milhão de tokens de saída. Cached input para GPT-5.4 mini: US$ 0.075/milhão de tokens. API para GPT-5.4 Nano: US$ 0.20/milhão de tokens de entrada e US$ 1.25/milhão de tokens de saída. Cached input para GPT-5.4 Nano: US$ 0.02/milhão de tokens. Cached input para GPT-5.6 (writes): 1.25x taxa de input não armazenado em cache. Cached input para GPT-5.6 (reads): 90% de desconto. Batch API para GPT-5.x: (50% de desconto em todos os custos de token), aplicado a todos os modelos.',
    pros: [
      ...
      'Lançamento do Health in ChatGPT (23 de julho de 2026) para apoiar o uso de IA na saúde, permitindo conectar registros de saúde e dados do Apple Health.',
    ...
    cons: [
      ...
      'A geração de vídeo Sora e sua integração com ChatGPT foram descontinuadas (aplicativo desligado em 26 de abril de 2026, API programada para ser desativada em 24 de setembro de 2026).',
      ...
      'GPT-4.5 foi retirado do ChatGPT em 26 de junho de 2026. Isso marca o fim dos modelos GPT-4 na interface do ChatGPT.',
  ...
  },
  {
    ...
    pros: [
      'Claude Opus 5 (lançado em 24 de julho de 2026) é um modelo atencioso e proativo que se aproxima da inteligência de ponta do Claude Fable 5 pela metade do preço. É o novo modelo padrão no Claude Max e o mais forte no Claude Pro, destacando-se em codificação e trabalho profissional.',
  ...
  },
  {
    ...
    pros: [
      ...
      'Gemini 3.6 Flash (lançado em 21 de julho de 2026) oferece um custo por token de saída reduzido (US$ 7.50/milhão de tokens) e maior eficiência de tokens (até 65% menos tokens de saída em cargas de trabalho de codificação agenticas) em comparação com o Gemini 3.5 Flash. É o modelo que o aplicativo Gemini gratuito agora utiliza.',
  ...
  },
  {
    ...
    pros: [
      ...
      'Meta AI, impulsionado por Muse Spark 1.1 (lançado em 24 de julho de 2026), agora pode fazer planos, integrar-se com aplicativos de e-mail e calendário e realizar tarefas em nome do usuário.',
    ...
    description: 'A família de IA da Meta agora é liderada pelo Meta Muse Spark 1.1 (lançado em 9 de julho de 2026), seu modelo mais poderoso, nativamente multimodal, com 128K tokens de contexto e otimizado para tarefas de agente e codificação. Em 24 de julho de 2026, o Meta AI, impulsionado por Muse Spark 1.1, ganhou a capacidade de planejar e integrar-se com aplicativos para realizar tarefas em nome do usuário. Muse Spark 1.1 é um modelo de peso fechado e exclusivo para API, uma mudança na estratégia da Meta em relação aos modelos Llama anteriores. Em 7 de julho de 2026, a Meta lançou o Muse Image, seu primeiro modelo de geração de imagens de laboratórios de superinteligência, e anunciou o Muse Video em desenvolvimento. A Meta AI para consumidores (meta.ai, WhatsApp, Messenger, Instagram Direct) agora é impulsionada pelo Muse Spark 1.1. A série Llama 3.x, incluindo Llama 3.3 70B, Llama 3.2 (multimodal) e Llama 3.1 (405B), continua a oferecer modelos "open-weight" de ponta para texto e visão, proporcionando flexibilidade para uso local e fine-tuning. O ecossistema de APIs de terceiros oferece opções competitivas, com OpenRouter e Deepinfra sendo os mais baratos e Groq o mais rápido. Embora os modelos "open-weight" permitam controle e privacidade, sua licença de uso comercial tem restrições. No entanto, o uso eficiente dos modelos Llama maiores requer hardware potente, e a disponibilidade de modelos multimodais pode ser restrita na UE.'
  },
  {
