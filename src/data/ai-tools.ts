...
export const AI_TOOLS: AITool[] = [
  // Texto & Redação
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (acesso limitado a modelos básicos como GPT-5.3 Instant). ChatGPT Plus a US$ 20/mês (acesso a GPT-4o, ChatGPT Images 2.0, navegação web, análise de dados). ChatGPT Team a US$ 20/usuário/mês (mínimo de 2 usuários, faturamento anual) ou US$ 25/usuário/mês (faturamento mensal), inclui GPT-4o, privacidade, workspace compartilhado, controles administrativos. ChatGPT Enterprise sob consulta (segurança empresarial, residência de dados, suporte 24/7). API GPT-4.1 a US$ 5.00/M tokens entrada e US$ 15.00/M tokens saída.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (com Claude 3.5 Sonnet, uso limitado). Claude Pro a US$ 20/mês (acesso a Claude 3 Opus e Sonnet, maior uso, 200.000 tokens de contexto). Planos de API (pay-per-token): Claude 3 Haiku a US$ 1.00/M tokens entrada e US$ 5.00/M tokens saída; Claude 3.5 Sonnet a US$ 3.00/M tokens entrada e US$ 15.00/M tokens saída; Claude 3 Opus a US$ 5.00/M tokens entrada e US$ 25.00/M tokens saída. Team Standard a US$ 25/usuário/mês (mínimo de 5 usuários), Team Premium a US$ 125/usuário/mês (inclui Opus), Enterprise sob consulta (janela de contexto maior, HIPAA).',
    url: 'https://claude.ai',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (acesso a Gemini 3.5 Flash, uso limitado). Google One AI Premium a US$ 19,99/mês (acesso a Gemini 3.1 Pro, 2 TB de armazenamento, recursos de IA no Gmail, Docs, etc.). Outros planos Google One AI Plus (a partir de US$ 7.99/mês para 200GB), Google AI Pro (US$ 49.99/mês para 10TB). Google Gemini for Workspace – Enterprise a US$ 30/usuário/mês. Planos de API (pay-per-token): Gemini 3.5 Flash a US$ 1.50/M tokens entrada e US$ 9.00/M tokens saída; Gemini 3.1 Pro a US$ 2.00/M tokens entrada e US$ 12.00/M tokens saída (até 200k tokens).',
  ...
  // Código & Dev
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (2.000 code completions/mês, 50 premium requests/mês, acesso a Claude Sonnet 4.6 e GPT-4.1). Copilot Pro a US$ 10/mês (inclui US$ 10 em créditos AI mensais, autocompletar ilimitado, 300 premium requests/mês). Copilot Pro+ a US$ 39/mês (inclui US$ 39 em créditos AI mensais, 1.500 premium requests/mês, acesso a todos os modelos avançados, incluindo Opus 4.7). Copilot Business a US$ 19/usuário/mês (inclui US$ 19 por usuário em créditos AI mensais, uso de créditos unificado para equipes, controles de política, logs de auditoria). Copilot Enterprise a US$ 39/usuário/mês (inclui US$ 39 por usuário em créditos AI mensais, requer GitHub Enterprise Cloud, bases de conhecimento, Chat no GitHub.com, modelos personalizados). Requisições premium adicionais podem ser compradas a US$ 0.04/requisição. Preços e sistema de créditos efetivos a partir de 1º de junho de 2026.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (Basic); Pro a US$ 12/mês (US$ 10/mês anual); Enterprise com preço customizado.',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Não possui plano gratuito. Pro a US$ 20/mês (uso padrão); Max 5x a US$ 100/mês (5x o uso do Pro); Max 20x a US$ 200/mês (20x o uso do Pro); Team Standard a US$ 25/usuário/mês (US$ 20/usuário/mês anual, mínimo de 5 usuários, inclui Claude Code, Cowork, SSO, mas sem Opus); Team Premium a US$ 125/usuário/mês (US$ 100/usuário/mês anual, inclui Opus); Enterprise sob consulta (inclui janela de contexto de 500K, HIPAA, etc.).',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Codex foi descontinuado como modelo autônomo. Suas capacidades foram integradas em modelos mais recentes da OpenAI, como o GPT-4.1 e GPT-5.5, que são acessíveis via API (preços variam por modelo e uso) ou através de planos como o ChatGPT Plus (US$ 20/mês).',
  ...
  },
  {
    ...
    pricing: 'Grátis',
    pricingDetails: 'Grátis (public preview), com acesso a modelos de IA avançados como Gemini 3.1 Pro, Flash, Claude Sonnet e Opus 4.5.',
  ...
  // Imagens
  {
    ...
    category: 'Imagens',
    emoji: '🎨',
    tagline: 'Geração de imagens fotorrealistas a partir de texto (substituído por ChatGPT Images 2.0)',
    description:
    ...
    useCases: [
      'Anteriormente usado para criar ilustrações para artigos e posts',
    ...
    pricing: 'Pago',
    pricingDetails: 'Incluso no ChatGPT Plus (US$ 20/mês, acesso a ChatGPT Images 2.0 com limites de uso); API (pay-per-image para versões legadas): a partir de US$ 0,040/imagem (1024x1024, qualidade padrão), embora descontinuado como produto autônomo em favor do ChatGPT Images 2.0.',
    url: 'https://openai.com/dall-e-3',
    tags: ['imagem', 'geração', 'arte', 'ilustração', 'fotorrealismo', 'openai', 'descontinuado'],
    popularityRank: 12,
    updatedAt: '2026-05',
  },
  {
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (25 créditos generativos/mês). Firefly Standard a US$ 9.99/mês (2.000 créditos). Firefly Pro a US$ 19.99/mês (7.000 créditos). Firefly Premium a US$ 199.99/mês (50.000 créditos). Planos Creative Cloud Pro (a partir de US$ 69.99/mês) incluem créditos e uso ilimitado de geração padrão. API Firefly sob consulta, a partir de ~$1.000/mês com custo por imagem de US$ 0.02-0.10.',
  ...
  },
  {
    ...
    description:
      'Nano Banana Pro é o modelo de geração de imagens avançado do Google, reconhecido por sua capacidade de gerar texto preciso dentro das imagens e manter a consistência de personagens. É uma capacidade integrada ao ecossistema Gemini e outros produtos Google.',
    useCases: [
    ...
    pricing: 'Pago',
    pricingDetails: 'Acesso às capacidades do Nano Banana Pro estão incluídas nos planos Google One AI Premium (US$ 19,99/mês) e através da API do Google AI Studio/Vertex AI (preços variam por modelo e uso).',
  ...
  // Vídeo
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Sora foi descontinuado em 26 de abril de 2026, com a API programada para ser desativada em 24 de setembro de 2026. Anteriormente, o acesso era limitado e os preços futuros estimados eram: Incluso no ChatGPT Plus (US$ 20/mês, acesso a recursos básicos de geração de vídeo); ChatGPT Pro (US$ 200/mês, com mais créditos e recursos). API (preços futuros estimados: Sora (Standard) a US$ 0.10/segundo (720p); Sora Pro a US$ 0.30/segundo (720p) ou US$ 0.50/segundo (1024p)).',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (3 vídeos/mês, 720p, marca d\'água). Creator a US$ 29/mês (US$ 24/mês anual, 15 vídeos/5 min cada, 1080p, sem marca d\'água, 1 custom avatar, 1 voice clone). Business a US$ 89/mês (US$ 72/mês anual, vídeos ilimitados, 4K, 5 custom avatars, 5 voice clones, 40+ idiomas para lip-sync, API, 3 team seats). Enterprise sob consulta.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (10 min de vídeo/mês, 9 avatares AI, marca d\'água). Starter a US$ 29/mês (US$ 18/mês anual, 10 min de vídeo/mês, 125+ avatares, 3 personal avatars). Creator a US$ 89/mês (US$ 64/mês anual, 30 min de vídeo/mês, 180+ avatares, 5 personal avatars, API access). Enterprise sob consulta (minutos ilimitados, 240+ avatares, SAML/SSO, SCORM export).',
  ...
  },
  {
    ...
    description:
      'Google Veo é o modelo de geração de vídeo do Google, disponível através do Gemini. Ele cria vídeos realistas e cinematográficos a partir de prompts de texto ou imagens, com controle sobre elementos como estilo, iluminação e movimentos de câmera. É reconhecido por sua alta qualidade e capacidade de gerar vídeos com áudio nativo. Atualmente em acesso limitado (private preview).',
    useCases: [
