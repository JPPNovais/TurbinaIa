...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'GPT-5.5 Instant (lançado em 5 de maio de 2026) é o modelo padrão do ChatGPT para todos os usuários, oferecendo respostas mais rápidas, precisas e com menos alucinações em domínios críticos, além de ser mais conciso e com estilo de resposta aprimorado.',
      ...
      'ChatGPT Images 2.0 (lançado em 21 de abril de 2026) oferece geração de imagens com renderização de texto aprimorada, suporte multilíngue e raciocínio visual avançado. O modo instantâneo é gratuito para todos os usuários.',
  ...
  },
  {
    ...
    pros: [
      ...
      'Claude Sonnet 4.6 (lançado em 17 de fevereiro de 2026) oferece desempenho de nível Opus 4.5 a um custo de Sonnet, com melhorias em codificação, uso de computador, raciocínio de longo contexto e planejamento de agente; suporta janela de contexto de 1 milhão de tokens (beta).',
      ...
      'Recursos como "computer use" (beta público) permitem ao Claude interagir com computadores de forma mais autônoma, e o "Effort Control" permite ajustar a profundidade do raciocínio (novo com Opus 4.8).'
    ],
    cons: [
      'A janela de contexto dos modelos Claude Opus (1 milhão de tokens) é menor que algumas ofertas concorrentes (ex: Gemini 3.1 Pro com 2 milhões, Llama 4 Scout com 10 milhões).',
      ...
      'Em tarefas de codificação complexas, o Claude Opus 4.7/4.8 é, em média, 20-35% mais lento para retornar uma resposta em comparação com o GPT-5.5, embora o modo rápido possa compensar.'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
  ...
  },
  {
    ...
    developer: 'Google',
    category: 'Texto & Código',
    pricing: 'Plano gratuito disponível (com acesso ao aplicativo Gemini, Gemini 3.5 Flash e recursos básicos, com limites de uso). Google AI Plus: US$ 7.99/mês (lançado em 27 de janeiro de 2026; 2x limites de uso do plano gratuito; inclui Omni em Gemini, Daily Brief, AI Inbox no Gmail, 200GB de armazenamento na nuvem). Google AI Pro (anteriormente Google AI Premium/Gemini Advanced): US$ 19.99/mês (acesso a Gemini 3.1 Pro, Gemini 3.5 Flash, Gemini 3.1 Flash-Lite, Gemini 3.5 Thinking; 4x limites de uso do plano gratuito; 5TB de armazenamento Google One, Deep Research, Gems - personas de IA personalizadas, integração com Workspace, YouTube Premium Lite). Google AI Ultra ($99.99): US$ 99.99/mês (5x limites de uso do Google AI Pro; inclui Gemini Ultra, 20TB de armazenamento, acesso superior a modelos Pro e Veo, YouTube Premium completo). Google AI Ultra ($199.99): US$ 199.99/mês (20x limites de uso do Google AI Pro; inclui Gemini Ultra, 30TB de armazenamento, acesso máximo a modelos Pro e Veo, Deep Think, acesso prioritário a novos recursos, Gemini Spark, YouTube Premium completo). API para Gemini 3.5 Flash: US$ 1.50/milhão de tokens de entrada e US$ 9.00/milhão de tokens de saída. API para Gemini 3.1 Flash: US$ 0.50/milhão de tokens de entrada e US$ 3.00/milhão de tokens de saída. API para Gemini 3.1 Pro: US$ 2.00/milhão de tokens de entrada e US$ 12.00/milhão de tokens de saída para prompts com até 200K tokens (dobra para US$ 4.00/milhão de entrada e US$ 18.00/milhão de saída para mais de 200K tokens). API para Gemini 3.1 Ultra: US$ 15.00/milhão de tokens de entrada e US$ 45.00/milhão de tokens de saída para prompts com menos de 128K tokens, com janela de contexto de 2 milhões de tokens. [cite: 9 na pesquisa de ChatGPT] API para Gemini 3.1 Flash-Lite: US$ 0.25/milhão de tokens de entrada e US$ 1.50/milhão de tokens de saída. API para Gemini 3.1 Flash Image: Preços por token de imagem (ex: US$ 0.045 por imagem 0.5K), com suporte a vídeo-para-imagem.',
    pros: [
      ...
      'Gemini Omni (anunciado em 19 de maio de 2026), com o primeiro modelo Gemini Omni Flash, é um novo "modelo de mundo" capaz de simular e raciocinar sobre a realidade física, com capacidades multimodais nativas de entrada e saída, incluindo geração de vídeo.',
      'Gemini 3.1 Ultra e Pro são modelos poderosos e versáteis com uma vasta janela de contexto de 2 milhões de tokens, destacando-se em raciocínio complexo (94.3% no GPQA Diamond para 3.1 Pro) e compreensão multimodal.',
      ...
      'Recursos avançados do Gemini Advanced (agora Google AI Pro) como "Deep Research" (agente de pesquisa autônomo), "Gems" (personas de IA personalizadas) e "Reference past chats" para contextualização.',
    ...
    cons: [
      ...
      'A janela de contexto para Gemini Advanced (Google AI Pro) é de 1 milhão de tokens, enquanto a API do Gemini 3.1 Pro oferece 2 milhões de tokens.',
      'Modelos mais recentes como Gemini 3.1 Flash-Lite preview foram descontinuados (em 25 de maio de 2026).'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
  ...
  },
  {
    ...
    pros: [
      'ChatGPT Images 2.0 (modelo gpt-image-2, lançado em 21 de abril de 2026) é o modelo de geração de imagens de última geração da OpenAI, totalmente integrado ao ChatGPT Plus.',
