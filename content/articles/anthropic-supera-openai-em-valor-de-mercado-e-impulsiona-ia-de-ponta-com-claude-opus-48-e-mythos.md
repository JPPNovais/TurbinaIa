...
O rápido crescimento da Anthropic é notável. Fundada em 2021 por ex-funcionários da OpenAI, incluindo o CEO Dario Amodei, a empresa alcançou sua valuation atual em metade do tempo que levou para a OpenAI. A estratégia da Anthropic tem sido focar na entrega de IA generativa para clientes empresariais, um caminho distinto da abordagem inicial da OpenAI, que priorizou usuários gerais com o lançamento do ChatGPT em 2022. Essa tática tem se mostrado frutífera, com a taxa de receita anual da Anthropic superando US$ 47 bilhões em maio de 2026, um salto significativo em relação aos US$ 30 bilhões no início do ano e US$ 10 bilhões no ano anterior, conforme relatado pela [Reuters](https://www.infobae.com/america/tecno/2026/05/28/anthropic-supera-a-openai-se-consolida-como-la-startup-de-ia-mas-valorada-por-el-mercado-y-roza-el-billon-de-dolares/).

A alta demanda pelo chatbot Claude levou a Anthropic a enfrentar desafios para atender ao consumo, impondo limites de uso durante horários de pico e oferecendo incentivos para clientes consumirem capacidade fora desses períodos. Essa pressão por capacidade de computação é um dos motivos por trás do recente financiamento, que visa expandir a infraestrutura para atender à crescente demanda, especialmente de usuários corporativos e cargas de trabalho "agentic" (tarefas mais longas e complexas). O compromisso da Anthropic em gastar mais de US$ 100 bilhões em dez anos em tecnologias de nuvem da Amazon reforça essa estratégia de expansão. Ambas as empresas, Anthropic e OpenAI, estão avaliando a possibilidade de abrir capital já em 2026.

## Claude Opus 4.8: Colaborador Mais Eficaz e Honesto

No dia 28 de maio de 2026, a Anthropic lançou uma versão atualizada do seu modelo carro-chefe, o Claude Opus 4.8. Disponível pelo mesmo preço de seu predecessor, o Opus 4.8 se baseia no Opus 4.7, apresentando melhorias significativas em benchmarks e se consolidando como um colaborador ainda mais eficaz.

Entre as principais novidades do Opus 4.8 estão:
*   **Controle de Esforço:** Usuários no [claude.ai](https://www.anthropic.com/news/introducing-claude-opus-4-8) agora têm controle sobre a quantidade de esforço que o Claude dedica a uma tarefa.
*   **Fluxos de Trabalho Dinâmicos para Claude Code:** Um novo recurso que permite ao Claude Code lidar com problemas de grande escala, planejando o trabalho e executando centenas de subagentes paralelos em uma única sessão, inclusive para migrações de bases de código com centenas de milhares de linhas.
*   **Modo Rápido Mais Acessível:** O modo rápido para Opus 4.8, que permite ao modelo trabalhar 2,5 vezes mais rápido, agora é três vezes mais barato do que nos modelos anteriores.
...
Paralelamente ao lançamento do Opus 4.8, a Anthropic continua a desenvolver e refinar seu modelo de IA de nível "Mythos", focado em segurança cibernética. Em maio de 2026, a empresa divulgou uma atualização sobre o [Project Glasswing](https://www.anthropic.com/research/glasswing-initial-update), uma iniciativa colaborativa lançada no mês anterior para proteger softwares críticos em todo o mundo antes que modelos de IA cada vez mais capazes possam ser usados contra eles.

O [Project Glasswing](https://www.anthropic.com/news/project-glasswing-securing-critical-software-for-the-ai-era) reúne uma coalizão de parceiros notáveis, incluindo Amazon Web Services, Apple, Broadcom, Cisco, CrowdStrike, Google, JPMorganChase, Linux Foundation, Microsoft, NVIDIA e Palo Alto Networks. Esses parceiros e outras 40 organizações adicionais estão utilizando o Claude Mythos Preview para escanear e proteger sistemas, tanto proprietários quanto de código aberto.
...
O impacto do Mythos na cibersegurança já é visível, com empresas como Palo Alto Networks, Microsoft e Oracle relatando um aumento significativo na velocidade de aplicação de patches e correção de vulnerabilidades. A Anthropic, no entanto, tem agido com cautela na liberação ampla do Mythos-class, reconhecendo o poder e os riscos potenciais do modelo. A empresa planeja disponibilizar modelos Mythos-class a todos os clientes nas próximas semanas, uma vez que salvaguardas robustas estejam implementadas. Essa abordagem reflete o foco da Anthropic na segurança da IA, mesmo em meio à corrida para lançar novos produtos. A empresa, inclusive, enfrenta uma disputa legal de alto perfil com o Pentágono, tendo processado o Departamento de Defesa após ser designada como risco na cadeia de suprimentos, uma medida que a Anthropic considera retaliação inconstitucional por sua recusa em conceder acesso irrestrito aos seus modelos de IA para fins militares.

## O Cenário Competitivo da IA e o Futuro de Anthropic
...
### A Anthropic realmente superou a OpenAI em valor de mercado?
Sim, em 28 de maio de 2026, a Anthropic alcançou uma avaliação de US$ 965 bilhões após uma rodada de financiamento da Série H de US$ 65 bilhões, ultrapassando a OpenAI, que foi avaliada em US$ 852 bilhões em março.

### Quais são as principais melhorias do Claude Opus 4.8?
O Claude Opus 4.8 oferece melhorias em benchmarks de codificação, habilidades agenticas, raciocínio e tarefas de conhecimento prático. Ele se destaca pela maior "honestidade", recursos como controle de esforço, fluxos de trabalho dinâmicos para código e um modo rápido mais acessível.

### O que é o Claude Mythos e qual seu objetivo?
O Claude Mythos é um modelo de IA de ponta da Anthropic com capacidades avançadas em cibersegurança. Ele é utilizado no Project Glasswing para identificar e explorar vulnerabilidades em softwares críticos, visando fortalecer as defesas cibernéticas globais.

## Fontes e Referências

- [Introducing Claude Opus 4.8](https://www.anthropic.com/news/introducing-claude-opus-4-8)
- [Project Glasswing: An initial update](https://www.anthropic.com/research/glasswing-initial-update)
- [Claude maker Anthropic tops OpenAI as world's most valuable AI start-up](https://www.straitstimes.com/tech/claude-maker-anthropic-tops-openai-as-world-s-most-valuable-ai-start-up)
- [Anthropic supera a OpenAI, se consolida como la startup de IA más valorada por el mercado y roza el billón de dólares](https://www.infobae.com/america/tecno/2026/05/28/anthropic-supera-a-openai-se-consolida-como-la-startup-de-ia-mas-valorada-por-el-mercado-y-roza-el-billon-de-dolares/)
- [Project Glasswing: Securing critical software for the AI era](https://www.anthropic.com/news/project-glasswing-securing-critical-software-for-the-ai-era)
- [Anthropic Launches Claude Opus 4.8 With Gains in Coding and Honesty](https://www.macrumors.com/2026/05/28/anthropic-claude-opus-4-8-launch/)
...
- [Claude Opus 4.8 is now available on AWS](https://aws.amazon.com/blogs/aws/claude-opus-4-8-is-now-available-on-aws/)
- [How to try Claude Opus 4.8, the 'honest' Anthropic AI](https://mashable.com/article/anthropic-claude-opus-4-8-release-mythos-ai)
- [Anthropic tops OpenAI to become the world's most valuable AI startup](https://www.businesstimes.com.sg/asean-intelligence/anthropic-tops-openai-worlds-most-valuable-ai-startup)
- [Anthropic roza el billón de dólares tras su última ronda de financiación y supera en valor a OpenAI](https://www.infobae.com/america/tecno/2026/05/29/anthropic-roza-el-billon-de-dolares-tras-su-ultima-ronda-de-financiacion-y-supera-en-valor-a-openai/)
- [Anthropic Mythos Finds 10000+ Critical Bugs in a Month — Maintainers Ask for Slowdown](https://penligent.com/blog/anthropic-mythos-10000-critical-bugs)
- [The Glasswing numbers should change what you do this week, not how well you sleep.](https://www.sans.org/blog/glasswing-numbers-change-what-you-do-this-week/)
- [Anthropic unveils new flagship AI model](https://www.straitstimes.com/tech/anthropic-unveils-new-flagship-ai-model)