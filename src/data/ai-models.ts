...
export const aiModels: AIModel[] = [
  {
    ...
    cons: [
      'Modelos mais antigos como GPT-4o foram aposentados do ChatGPT em fevereiro de 2026, embora o acesso via API permaneça. DALL-E 2 e DALL-E 3 foram aposentados em 12 de maio de 2026. OpenAI o3 e GPT-4.5 serão descontinuados em agosto e junho de 2026, respectivamente.',
  ...
  },
  {
    ...
    pros: [
      ...
      'Gemini 3.1 Ultra e Pro são modelos poderosos e versáteis com uma vasta janela de contexto de 1 milhão de tokens via API para Gemini 3.1 Pro, destacando-se em raciocínio complexo e compreensão multimodal.',
    ...
    cons: [
      ...
      'A janela de contexto para Gemini Advanced (Google AI Pro) na interface do usuário é de 1 milhão de tokens, enquanto a API do Gemini 3.1 Pro oferece 1 milhão de tokens.',
  ...
  },
  {
    ...
    cons: [
      ...
      'As janelas de contexto para modelos Llama 3.1 (16K ou 131K) são menores que a do Llama 4 Scout (10M) e alguns concorrentes (Gemini 3.1 Pro com 1M).',
  ...
  },
  {
    ...
    cons: [
      'O consumo de créditos pode ser imprevisível e rápido em cenários complexos com muitos módulos e Agentes de IA, especialmente porque "créditos" são contados de forma diferente de "tarefas" em outras plataformas; a Make.com mudou de "operações" para "créditos" em agosto de 2025.',
