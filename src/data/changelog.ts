...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    developer: 'Anthropic',
    category: 'Pesquisa',
    description: 'Em 24 de setembro de 2026, a Anthropic anunciou que o Claude identificou de forma autônoma, em seu laboratório de biologia em São Francisco, um sistema de enzimas até então desconhecido em DNA de bacteriófagos — batizado de ART (array-associated reverse transcriptases) —, com características que lembram o CRISPR.',
    highlights: [
      'A campanha autônoma de busca durou cerca de 21,5 horas, percorrendo 949 sessões de agente e cerca de 1,9 bilhão de clusters de proteínas até encontrar o sistema, formado por uma transcriptase reversa, um gene parceiro e um array de repetições de DNA.',
      'A Anthropic e pesquisadores externos, como o cocriador do CRISPR Feng Zhang, ressaltam que a função biológica do ART ainda não foi comprovada e que o artigo não passou por revisão por pares.',
      'O caso reacende o debate sobre o uso de IA como ferramenta de pesquisa científica autônoma, dias depois da polêmica pública entre Microsoft AI e Anthropic sobre a suposta consciência do Claude.',
    ],
    impact: 'Médio',
  },
  {
    id: 'openai-sora-api-descontinuada-2026-09',
    date: '2026-09',
    title: 'OpenAI descontinua a API do Sora, encerrando o acesso de desenvolvedores à geração de vídeo',
    developer: 'OpenAI',
    category: 'Descontinuado',
    description: 'Em 24 de setembro de 2026, a OpenAI encerrou definitivamente a API do Sora (modelos sora-2 e sora-2-pro, incluindo todas as versões de snapshot), alguns meses depois de já ter descontinuado o aplicativo e a experiência web do Sora, em abril de 2026.',
    highlights: [
      'Vídeos já baixados continuam propriedade do usuário, mas qualquer conteúdo mantido apenas nos servidores da OpenAI foi apagado permanentemente após o desligamento.',
      'A OpenAI orientou desenvolvedores a exportar dados e migrar integrações antes da data de corte, encerrando de vez o acesso programático à geração de vídeo do Sora.',
      'O desligamento ocorre no mesmo mês em que a empresa lançou o GPT-6 Astra, Sol e Luna, concentrando o portfólio de mídia e linguagem em menos produtos.',
    ],
    impact: 'Médio',
  },
  {
    id: 'anthropic-claude-opus-5-5-lancamento-2026-09',
    date: '2026-09',
    title: 'Anthropic lança o Claude Opus 5.5, com desempenho equivalente ao Fable 5.1 e custo 40% menor',
    developer: 'Anthropic',
    category: 'Lançamento',
    description: 'Em 22 de setembro de 2026, a Anthropic lançou o Claude Opus 5.5, primeiro modelo da nova família 5.5 e seu Opus mais capaz até aqui, igualando o Claude Fable 5.1 na maior parte das tarefas com janela de contexto de 1 milhão de tokens e custo cerca de 40% menor que o Opus 5 em cargas de trabalho típicas.',
    highlights: [
      'Preços de API: US$ 4 por milhão de tokens de entrada, US$ 20 por milhão de saída e US$ 0,20 por milhão em leitura de cache.',
      'A velocidade de geração aumentou mais de 30% em relação ao Opus 5, segundo a Anthropic.',
      'A empresa sinalizou o lançamento de Sonnet 5.5 e Haiku 5.5 para as semanas seguintes, completando a atualização da família 5.5.',
    ],
    impact: 'Alto',
  },
  {
    id: 'openai-gpt-6-sol-luna-lancamento-2026-09',
    date: '2026-09',
    title: 'OpenAI lança GPT-6 Sol e GPT-6 Luna, trazendo os avanços do Astra a preços menores',
    developer: 'OpenAI',
    category: 'Lançamento',
    description: 'Em 22 de setembro de 2026, a OpenAI lançou o GPT-6 Sol e o GPT-6 Luna na API, no Codex e no ChatGPT Work, levando parte dos avanços do GPT-6 Astra para modelos mais rápidos e baratos: o Sol mira tarefas cotidianas exigentes e o Luna, tarefas de alto volume.',
    highlights: [
      'Preços de API: US$ 2/US$ 10 por milhão de tokens (entrada/saída) no Sol e US$ 0,10/US$ 0,50 no Luna — cerca de 50% mais barato que os preços promocionais do GPT-5.6.',
      'Os dois modelos ficaram disponíveis no seletor de modelo do Codex e do ChatGPT Work para usuários Plus, Pro, Business, Enterprise e Edu; usuários Free e Go passaram a ter acesso ao Luna no app desktop.',
      'O lançamento chega na mesma semana do Claude Opus 5.5, da Anthropic, intensificando a disputa por modelos "de fronteira" mais baratos.',
    ],
    impact: 'Médio',
  },
  {
    id: 'xai-grok-4-7-lancamento-2026-09',
    date: '2026-09',
    title: 'xAI lança o Grok 4.7, modelo de 2,1 trilhões de parâmetros para código e trabalho de conhecimento',
    developer: 'xAI',
    category: 'Lançamento',
    description: 'Em 21 de setembro de 2026, a xAI lançou o Grok 4.7, novo modelo de fronteira com base de 2,1 trilhões de parâmetros, janela de contexto de 500 mil tokens e entradas de texto e imagem, já disponível sem lista de espera no app Grok, no Cursor, no Grok Build e via API.',
    highlights: [
      'No benchmark CursorBench 4.0, voltado a tarefas longas de engenharia de software, o Grok 4.7 marcou 46,3%, ante 40,4% do Grok 4.6; no DeepSWE v1.1 chegou a 71,0% em esforço alto, ante 65,2%.',
      'Preço de API mantido em US$ 2/US$ 6 por milhão de tokens de entrada/saída (US$ 0,50 para entrada em cache) abaixo de 200 mil tokens de prompt, subindo para US$ 4/US$ 12 acima desse limite — igual ao Grok 4.6.',
      'A xAI diz que o modelo mantém tarefas complexas por mais tempo, revisa o próprio resultado com mais cuidado e traz salvaguardas de segurança mais rígidas que as versões anteriores.',
    ],
    impact: 'Médio',
  },
  {
    id: 'google-gemini-3-8-live-ga-2026-09',
    date: '2026-09',
    title: 'Google leva o Gemini 3.8 Live à disponibilidade geral e amplia o Live Avatar no Enterprise',
    developer: 'Google DeepMind',
    category: 'Lançamento',
    description: 'Em 15 de setembro de 2026, o Google levou o Gemini 3.8 Live e o Gemini 3.8 Live Extended Thinking à disponibilidade geral na API Gemini e no Google AI Studio, como novos modelos de áudio para voz em tempo real capazes de "raciocinar" durante a conversa; em 24 de setembro, o recurso Live Avatar do mesmo modelo virou GA no Gemini Enterprise, nos EUA e na União Europeia.',
    highlights: [
      'O Gemini 3.8 Live aceita áudio, imagem, vídeo e texto, com janela de contexto de até 128 mil tokens, mantendo o mesmo preço do antecessor Gemini 3.1 Flash Live: US$ 0,005/minuto de áudio de entrada e US$ 0,018/minuto de saída.',
      'O Live Avatar adiciona presença visual (um avatar animado) às conversas de voz em tempo real, mas por enquanto fica restrito a clientes corporativos do Gemini Enterprise.',
      'O lançamento acontece na mesma janela em que o Google anunciou a descontinuação do endpoint gemini-omni-flash-preview, prevista para 30 de setembro de 2026.',
    ],
    impact: 'Baixo',
  },
  {
    id: 'elevenlabs-scribe-v2-medical-ga-2026-09',
    date: '2026-09',
    title: 'ElevenLabs lança o Scribe v2 Medical, modelo de transcrição especializado em áudio clínico',
    developer: 'ElevenLabs',
    category: 'Lançamento',
    description: 'Em 11 de setembro de 2026, a ElevenLabs anunciou a disponibilidade geral do Scribe v2 Medical, versão do Scribe v2 ajustada especificamente para áudio médico e clínico — nomes de medicamentos, anatomia, patologia e abreviações de ditado —, cobrando o mesmo preço do Scribe v2 padrão.',
    highlights: [
      'No MedDictate, benchmark público de ditado clínico em inglês, francês e alemão, o Scribe v2 Medical registrou a menor taxa de erro de palavras (WER) entre os modelos testados pela empresa.',
      'Mantém suporte a mais de 90 idiomas e é elegível à HIPAA para clientes Enterprise que assinem um BAA e ativem o modo de retenção zero.',
      'O lançamento acompanha uma fase de expansão da ElevenLabs, que também fechou parceria de licenciamento musical com a Universal Music Group em setembro e foi avaliada perto de US$ 22 bilhões, segundo o TechCrunch.',
    ],
    impact: 'Baixo',
  },
  {
