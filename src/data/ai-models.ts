...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'GPT-5.6 Terra e Luna (lançados em 9 de julho de 2026) oferecem capacidades balanceadas e eficientes, respectivamente, e estão acessíveis em ChatGPT Work e Codex para todos os planos, incluindo gratuito e Go. Os preços de API de Terra e Luna foram reduzidos em 30 de julho de 2026. Luna superou o Fable 5 no Agents\' Last Exam com custo por tarefa estimado 99% menor.',
      ...
      'Pastas grandes agora são tratadas como anexos para usuários Enterprise e Education, mantendo o editor mais limpo e protegendo o contexto (a partir de 4 de agosto de 2026).'
    ],
    cons: [
      ...
      'O DALL·E GPT oficial será retirado do ChatGPT em 30 de agosto de 2026.',
