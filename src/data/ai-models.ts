...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'GPT-5.6 Luna (versão de agosto de 2026, lançado em 6 de agosto de 2026) é o novo modelo padrão para usuários dos planos Free e Go no chat padrão, com acesso a chats de texto ilimitados (sujeito a limites de uso indevido) e um novo "Think button" para raciocínio mais profundo em perguntas difíceis.',
      'GPT-5.6 Sol (lançado em 9 de julho de 2026) e GPT-5.6 Luna (lançado em 9 de julho de 2026) continuam acessíveis em ChatGPT Work e Codex para todos os planos, incluindo gratuito e Go.',
  ...
  },
  {
    ...
    cons: [
      'Claude Sonnet 5 terá seu preço padrão (US$ 3/milhão de tokens de entrada e US$ 15/milhão de tokens de saída) a partir de 1º de setembro de 2026, encerrando o preço promocional.',
  ...
  },
  {
    ...
    cons: [
      'Meta Muse Spark 1.2 é um modelo de peso fechado e exclusivo para API da Meta, assim como o 1.1, marcando uma mudança em relação à filosofia de "open-weight" da família Llama.',
