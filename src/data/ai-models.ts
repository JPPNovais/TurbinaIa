...
export const aiModels: AIModel[] = [
  {
    ...
    pros: [
      ...
      'GPT-5.6 Sol ganhou um modo "Ultrafast" em preview (lançado em 13-14 de agosto de 2026), que roda até 14x mais rápido que o modo padrão (até 750 tokens de saída/segundo), com inferência acelerada via parceria com a Cerebras. Por enquanto disponível apenas via API, em acesso limitado a clientes selecionados.',
      ...
      'GPT-6 Astra (lançado em 3 de setembro de 2026) é o modelo mais avançado já lançado pela OpenAI, com ganhos expressivos em uso de computador, navegação web e engenharia de software, além de satisfazer o nível "Crítico" de capacidade cibernética no Preparedness Framework da empresa — o primeiro modelo da OpenAI a cruzar esse limiar.'
    ],
    cons: [
      ...
      'Atlas, o navegador standalone de IA da OpenAI, parou de funcionar em 9 de agosto de 2026; seus recursos de agente baseados em navegador foram migrados para uma extensão do Chrome, o app de desktop do ChatGPT e um navegador remoto na nuvem.',
      ...
      'O rollout do GPT-6 Astra começou por organizações do programa Daybreak antes de assinantes Plus/Pro, e o cartão de sistema do modelo revelou queda "substancial" na monitorabilidade da cadeia de raciocínio (capacidade do modelo de controlar deliberadamente a forma do próprio raciocínio, dificultando a detecção de comportamento enganoso).',
      'Assinantes Plus (US$ 20/mês) só têm acesso ao GPT-6 Astra dentro do ChatGPT Work e do Codex, não na interface padrão de Chat — gerando confusão, já que o anúncio inicial da OpenAI mencionava "todos os usuários Plus". Apenas os planos Pro (US$ 100/US$ 200), Business e Enterprise recebem o Astra também no Chat padrão, via o novo GPT-6 Pro.'
    ],
    score: {
      reasoning: 5.0,
      writing: 5.0,
  ...
  },
  {
    ...
    pros: [
      ...
      'Claude Fable 5.1 (lançado em 1º de setembro de 2026, junto com a variante de acesso restrito Claude Mythos 5.1) sucede o Fable 5 e supera Fable 5, Opus 5 e GPT-5.6 Sol em múltiplos benchmarks, incluindo codificação e resolução de problemas de longa duração. O corte de 75% no preço de cache reads (de US$ 1.00 para US$ 0.25/milhão de tokens) reduz o custo de workloads típicos em cerca de 25% e de tarefas altamente agenticas em até 45%.',
      'Claude Fable 5.1 traz salvaguardas de cibersegurança aprimoradas, com cerca de 60% menos falsos positivos no Claude Code, e agora pode ser usado para descobrir vulnerabilidades de software (mas não para desenvolver exploits).',
      'Claude Fable 5 (lançado em 9 de junho de 2026, hoje sucedido pelo Fable 5.1) teve suas salvaguardas de biologia aprimoradas em 7 de agosto de 2026, reduzindo substancialmente os fallbacks (falsos positivos) em cerca de 85% para consultas relacionadas à biologia, permitindo auxiliar em uma gama mais ampla de tarefas de saúde e educação.',
      'Claude Fable 5.1 e Opus 4.8/4.7/Sonnet 5/Sonnet 4.6 oferecem uma vasta janela de contexto de 1 milhão de tokens.',
    ...
    cons: [
      ...
      'Claude Fable 5.1, apesar das melhorias, ainda retorna ao Opus 5 para solicitações de uso duplo (virologia, toxicologia e design molecular), não sendo ainda utilizável para pesquisa biológica profissional e desenvolvimento de medicamentos.',
      'Claude Fable (na geração 5) teve seu acesso suspenso por uma diretiva do governo dos EUA em 12 de junho de 2026 e, após ser restaurado em 1º de julho de 2026, seu acesso foi reestruturado a partir de 20 de julho de 2026. Agora é um complemento pago via créditos de uso para assinantes Pro e Team Standard, e incluído com limites nos planos Max e Team Premium — regra que segue valendo para o Fable 5.1.',
  ...
  },
  {
    ...
    pros: [
      ...
      'Gemini 3.6 Flash (lançado em 21 de julho de 2026) oferece maior eficiência de tokens (até 17% menos tokens de saída em cargas de trabalho de codificação agenticas) em comparação com o Gemini 3.5 Flash, e desde 13 de agosto de 2026 custa US$ 0.75/US$ 3.75 por milhão de tokens (preço introdutório até 31 de dezembro de 2026). É o modelo que o aplicativo Gemini gratuito agora utiliza.',
