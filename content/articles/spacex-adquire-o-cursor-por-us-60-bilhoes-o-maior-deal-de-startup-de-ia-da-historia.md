---
title: "SpaceX Adquire o Cursor por US$ 60 Bilhões: O Maior Deal de Startup de IA da História"
description: "SpaceX compra a Anysphere, criadora do Cursor, por US$ 60 bi em ações dias após seu IPO histórico. Entenda o que muda para desenvolvedores."
category: noticias
tags:
  - SpaceX
  - Cursor
...
isFeatured: false
date: "2026-06-18"
coverImage: "https://images.unsplash.com/photo-1711919600878-b5d9e77d3357?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=&ixlib=rb-4.1.0&q=80&w=1080"
---

Na terça-feira, 16 de junho de 2026, o mercado de tecnologia acordou diante de um número que poucos acreditavam ser possível: US$ 60 bilhões por uma startup fundada há apenas quatro anos. A SpaceX anunciou a aquisição da Anysphere — empresa por trás do assistente de programação [Cursor](https://www.cursor.com) — em um acordo inteiramente em ações, concluído menos de uma semana após o maior IPO da história dos mercados financeiros. O negócio redefine o que significa ser uma empresa de inteligência artificial em 2026 e coloca Elon Musk em posição de liderança em um segmento onde ele, até recentemente, estava em desvantagem.
...
Poucos acordos na história da tecnologia combinam timing e escala de maneira tão dramática. Apenas quatro dias depois de a SpaceX abrir capital na Nasdaq — em uma oferta que levantou [US$ 86,2 bilhões, a maior da história global](https://techcrunch.com/2026/06/16/spacex-to-acquire-cursor-for-60b-in-stock-days-after-blockbuster-ipo/) —, Musk usou o novo status público da empresa para assinar o maior cheque já dado a uma startup de capital de risco fora de uma fusão interna.

Segundo o [TechCrunch](https://techcrunch.com/2026/06/16/spacex-to-acquire-cursor-for-60b-in-stock-days-after-blockbuster-ipo/), a operação foi estruturada como uma fusão: uma subsidiária da SpaceX chamada X67 Inc. irá se incorporar à Anysphere, deixando o Cursor como subsidiária integral da empresa de Musk. O fechamento está previsto para o terceiro trimestre de 2026, sujeito a aprovações regulatórias. Mas os bastidores do negócio revelam uma urgência estratégica que vai muito além dos números.

A história começa, na prática, em abril de 2026, quando a SpaceX anunciou uma estrutura incomum: ou compraria o Cursor por US$ 60 bilhões após o IPO, ou pagaria uma multa de US$ 10 bilhões pelo cancelamento do negócio — além de US$ 8,5 bilhões em recursos de computação. Como apurou o [Olhar Digital](https://olhardigital.com.br/2026/06/16/inteligencia-artificial/cursor-o-que-e-a-ferramenta-de-ia-que-a-spacex-comprou-por-us-60-bilhoes/), essa penalidade colossal dá a medida exata de quanto o acordo importa para Musk. Quando a multa por desistência equivale a quase 30% do valor total do negócio, a "opção" é, na prática, uma obrigação.


![Imagem ilustrativa sobre SpaceX Adquire o Cursor por US$ 60 Bilhões: O Maior Deal de Startup de IA da História](https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=80)
...
![Imagem ilustrativa sobre SpaceX Adquire o Cursor por US$ 60 Bilhões: O Maior Deal de Startup de IA da História](https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?auto=format&fit=crop&w=1200&q=80)
...
| Codex / [ChatGPT](/blog/chatgpt-vs-gemini-vs-claude-qual-a-melhor-ia-em-2026) | OpenAI | GPT-4o / o3 | N/D |
| [Gemini](/blog/prompts-para-gemini) Code Assist | Google | Gemini 2.x | N/D |
...
Para desenvolvedores que dependem do Cursor no dia a dia e querem acompanhar as mudanças de funcionalidades e modelos, o [Monitor de Modelos](/changelog) do Turbina IA é uma boa referência. E para calcular como eventuais mudanças de preços impactam o orçamento de times de desenvolvimento, a [Calculadora de Custos de IA](/calculadora) pode ser útil na hora de comparar alternativas.

## Disputa pela Supremacia na Codificação com IA

O negócio acontece num momento em que a batalha pelo desenvolvedor corporativo está mais acirrada do que nunca. A [Euronews](https://www.euronews.com/business/2026/06/16/spacex-buys-ai-coding-startup-cursor-for-60bn-as-ai-race-with-openai-and-anthropic-intensi) coloca o deal diretamente dentro da corrida entre SpaceX, OpenAI e Anthropic — três dos atores mais bem capitalizados do planeta — para dominar o mercado de IA corporativa.
...
- [SpaceX's surging stock paid for the $60 billion Cursor acquisition in just a few hours of trading — Fortune](https://fortune.com/2026/06/16/elon-musk-spacex-ipo-ai-coding-startup-cursor-acquisition/)
- [SpaceX buys AI coding startup Cursor for $60bn as AI race with OpenAI and Anthropic intensifies — Euronews](https://www.euronews.com/business/2026/06/16/spacex-buys-ai-coding-startup-cursor-for-60bn-as-ai-race-with-openai-and-anthropic-intensi)
- [Cursor: o que é a ferramenta de IA que a SpaceX comprou por US$ 60 bilhões — Olhar Digital](https://olhardigital.com.br/2026/06/16/inteligencia-artificial/cursor-o-que-e-a-ferramenta-de-ia-que-a-spacex-comprou-por-us-60-bilhoes/)