...
export const AI_TOOLS: AITool[] = [
  // Texto & Redação
  {
    ...
    description:
      'ChatGPT Plus é a versão premium da OpenAI, impulsionada pelo modelo GPT-5.6 Sol (que desde 6 de agosto de 2026 unificou os antigos modos Instant e Thinking em um único modelo com seletor de esforço de raciocínio), com acesso a plugins, navegação web e geração de imagens através do ChatGPT Images 2.0. É o assistente conversacional mais versátil disponível, excelente para redação, análise e brainstorming.',
    useCases: [
