...
export const AI_TOOLS: AITool[] = [
  // Texto & Redação
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (uso limitado de GPT-3.5); ChatGPT Plus a US$ 20/mês (acesso a GPT-4o, navegação web, análise de dados e DALL-E 3); ChatGPT Team a US$ 25/usuário/mês (mínimo de 2 usuários, faturamento anual); ChatGPT Enterprise sob consulta. API GPT-4o a US$ 5.00/M tokens entrada e US$ 15.00/M tokens saída.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (com Claude 3 Haiku, uso limitado); Claude Pro a US$ 20/mês (acesso a Claude 3 Opus, maior uso); Planos de API (pay-per-token): Claude 3 Haiku a US$ 0.25/M tokens entrada e US$ 1.25/M tokens saída; Claude 3 Sonnet a US$ 3.00/M tokens entrada e US$ 15.00/M tokens saída; Claude 3 Opus a US$ 15.00/M tokens entrada e US$ 75.00/M tokens saída.',
    url: 'https://claude.ai',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Sem plano gratuito, apenas trial de 7 dias. Creator a US$ 49/mês (US$ 39/mês no plano anual) para 1 usuário; Pro a US$ 69/mês (US$ 59/mês no plano anual) para até 5 usuários; Business com preço customizado.',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (Starter, com créditos diários limitados); Hacker a US$ 7/mês (recursos avançados, mais créditos); Teams Pro a US$ 20/usuário/mês; Enterprise sob consulta.',
  ...
  },
  {
    ...
    pricing: 'Pago',
    pricingDetails: 'Acesso via planos Claude Pro (US$ 20/mês) ou diretamente via API Anthropic (Claude 3 Haiku, Sonnet, Opus - consulte preços por token).',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (25 créditos generativos/mês); Firefly Premium a US$ 4,99/mês (100 créditos); Incluso em planos Creative Cloud, como Photoshop Single App (a partir de US$ 22,99/mês com 1.000 créditos).',
  ...
  },
  {
    ...
    pricing: 'Freemium',
    pricingDetails: 'Grátis (10 min de vídeo/mês, 9 avatares AI, marca d\'água); Starter a US$ 29/mês (US$ 22/mês anual, 10 min de vídeo/mês); Creator a US$ 89/mês (US$ 67/mês anual, 30 min de vídeo/mês, mais avatares e recursos); Enterprise sob consulta.',
